 ...
 *
 */
package it.govpay.web.exception;
...
public class GovPayException extends Exception {
	...
	private CtFaultBean faultBean;
	private Object param;
		
	
	public GovPayException(CtFaultBean faultBean) {
		super();
	...
	public CtFaultBean getFaultBean() {
		return this.faultBean;
	}

	public void setFaultBean(CtFaultBean faultBean) {
		this.faultBean = faultBean;
	}
