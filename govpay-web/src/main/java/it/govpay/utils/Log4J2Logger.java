...
import org.openspcoop2.utils.logger.basic.AbstractBasicLogger;
import org.openspcoop2.utils.logger.basic.Diagnostic;
 ...
 * @author $Author: apoli $
 * @version $Rev: 11239 $, $Date: 2015-10-19 12:00:37 +0200 (Mon, 19 Oct 2015) $
 */
public class Log4J2Logger extends AbstractBasicLogger  {

	
	public Log4J2Logger(Properties diagnosticProperties, Boolean throwExceptionPlaceholderFailedResolution, String resourceLogProperties) throws UtilsException {
		super(diagnosticProperties,throwExceptionPlaceholderFailedResolution);
		this.init(resourceLogProperties);
	}

	public Log4J2Logger(String diagnosticPropertiesResourceURI, Boolean throwExceptionPlaceholderFailedResolution, String resourceLogProperties) throws UtilsException {
		super(diagnosticPropertiesResourceURI,throwExceptionPlaceholderFailedResolution);
		this.init(resourceLogProperties);
	}

	public Log4J2Logger(File diagnosticPropertiesResource, Boolean throwExceptionPlaceholderFailedResolution, String resourceLogProperties) throws UtilsException {
		super(diagnosticPropertiesResource,throwExceptionPlaceholderFailedResolution);
		this.init(resourceLogProperties);
	}
	
	public Log4J2Logger(Properties diagnosticProperties, Boolean throwExceptionPlaceholderFailedResolution, Properties resourceLogProperties) throws UtilsException {
		super(diagnosticProperties,throwExceptionPlaceholderFailedResolution);
		this.init(resourceLogProperties);
	}

	public Log4J2Logger(String diagnosticPropertiesResourceURI, Boolean throwExceptionPlaceholderFailedResolution, Properties resourceLogProperties) throws UtilsException {
		super(diagnosticPropertiesResourceURI,throwExceptionPlaceholderFailedResolution);
		this.init(resourceLogProperties);
	}

	public Log4J2Logger(File diagnosticPropertiesResource, Boolean throwExceptionPlaceholderFailedResolution, Properties resourceLogProperties) throws UtilsException {
		super(diagnosticPropertiesResource,throwExceptionPlaceholderFailedResolution);
		this.init(resourceLogProperties);
	}
	...
	private void init(String resourceLogProperties) throws UtilsException{
		InputStream is = null;
		try{
			is = Log4J2Logger.class.getResourceAsStream(resourceLogProperties);
			if(is==null){
	...
	protected Level convertToPriority(Severity severity){
		switch(severity) {
		case DEBUG_HIGH: return Level.TRACE;
		case DEBUG_LOW:  return Level.DEBUG;
		case DEBUG_MEDIUM:  return Level.DEBUG;
