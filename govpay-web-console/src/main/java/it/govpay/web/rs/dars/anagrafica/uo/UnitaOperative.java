...
@Path("/dars/uo")
public class UnitaOperative extends DarsService {

	public UnitaOperative() {
		super();
	}
	
	Logger log = LoggerWrapperFactory.getLogger(UnitaOperative.class);
	...
	public IDarsHandler<?> getDarsHandler() {
		return new UnitaOperativeHandler(this.log, this);
	}
