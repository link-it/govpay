...
public class DominiFunzionalita_A_CON extends MultiSelectList<Long, List<Long>>{
	...
	public DominiFunzionalita_A_CON(String nomeServizio,String id, String label, URI refreshUri, List<RawParamValue> paramValues,
			 Object... objects) {
