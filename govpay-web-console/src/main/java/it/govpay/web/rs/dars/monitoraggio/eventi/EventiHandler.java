...
public class EventiHandler extends BaseDarsHandler<Evento> implements IDarsHandler<Evento>{
	...
	private List<String> getCsvHeader(){
		...
		header.add(Utils.getInstance(this.getLanguage()).getMessageFromResourceBundle(this.nomeServizio + ".dataRichiesta.label"));
		header.add(Utils.getInstance(this.getLanguage()).getMessageFromResourceBundle(this.nomeServizio + ".dataRisposta.label"));
		header.add(Utils.getInstance(this.getLanguage()).getMessageFromResourceBundle(this.nomeServizio + ".altriParametriRichiesta.label"));
		header.add(Utils.getInstance(this.getLanguage()).getMessageFromResourceBundle(this.nomeServizio + ".altriParametriRisposta.label"));
