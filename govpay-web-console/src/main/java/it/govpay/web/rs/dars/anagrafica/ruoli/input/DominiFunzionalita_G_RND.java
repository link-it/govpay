...
public class DominiFunzionalita_G_RND extends MultiSelectList<Long, List<Long>>{
	...
	public DominiFunzionalita_G_RND(String nomeServizio,String id, String label, URI refreshUri, List<RawParamValue> paramValues,
			 Object... objects) {
