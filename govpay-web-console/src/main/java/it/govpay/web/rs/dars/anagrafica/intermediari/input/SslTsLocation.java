...
public class SslTsLocation extends InputText{
	...
	public SslTsLocation(String nomeConnettore,String nomeServizio,String id, String label, int minLength, int maxLength, URI refreshUri,	List<RawParamValue> values, Object... objects) {
