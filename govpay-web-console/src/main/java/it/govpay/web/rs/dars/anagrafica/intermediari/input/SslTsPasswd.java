...
public class SslTsPasswd extends InputSecret {
	...
	public SslTsPasswd(String nomeConnettore,String nomeServizio,String id, String label, int minLength, int maxLength, URI refreshUri,List<RawParamValue> values, Object... objects) {
