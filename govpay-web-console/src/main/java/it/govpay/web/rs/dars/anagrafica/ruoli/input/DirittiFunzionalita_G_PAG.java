...
public class DirittiFunzionalita_G_PAG extends SelectList<Long>{
	...
	public DirittiFunzionalita_G_PAG(String nomeServizio,String id, String label, URI refreshUri, List<RawParamValue> paramValues,
			 Object... objects) {
