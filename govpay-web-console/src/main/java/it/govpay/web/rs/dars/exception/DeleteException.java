...
public class DeleteException extends Exception {
	...
	public DeleteException(String msg,EsitoOperazione esito) {
		super(msg);
		this.esito = esito;
		this.messaggi = new ArrayList<String>();
		this.messaggi.add(msg);
	...
	public DeleteException(List<String> msg,EsitoOperazione esito) {
		super();
		this.esito = esito;
		this.messaggi = new ArrayList<String>();
	...
	public DeleteException(Throwable t,EsitoOperazione esito){
		super(t);
		this.esito = esito;
		this.messaggi = new ArrayList<String>();
	}
