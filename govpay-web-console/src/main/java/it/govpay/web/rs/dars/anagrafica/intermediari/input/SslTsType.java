...
public class SslTsType  extends InputText{
	...
	public SslTsType(String nomeConnettore,String nomeServizio,String id, String label, int minLength, int maxLength, URI refreshUri,	List<RawParamValue> values, Object... objects) {
