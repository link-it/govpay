package it.govpay.web.rs.dars.caricamenti;
...
import it.govpay.web.rs.dars.caricamenti.tracciati.Operazioni;
...
public abstract class BaseTracciatiHandler extends DarsHandler<Tracciato> implements IDarsHandler<Tracciato>{

	protected SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm");  
	protected TipoTracciatoType tipoTracciato;

	public BaseTracciatiHandler(Logger log, DarsService darsService, TipoTracciatoType tipoTracciato) { 
	...
	protected void initInfoCreazione(UriInfo uriInfo, BasicBD bd) throws ConsoleException{
		if(this.infoCreazioneMap == null){
	...
	public Dettaglio insert(InputStream is, UriInfo uriInfo, BasicBD bd)
		...
		try{
			...
			inserisciTracciatoDTO.setTipo(this.tipoTracciato);
