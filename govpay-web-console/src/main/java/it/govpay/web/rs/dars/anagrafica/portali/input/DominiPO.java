...
public class DominiPO extends MultiSelectList<Long, List<Long>>{

	private String pagamentiOnlineId= null;
	private String portaleId = null;
	private String nomeServizio = null;
	private Servizio servizio = Servizio.PAGAMENTI_ONLINE;
	private Tipo tipo = Tipo.DOMINIO;

	public DominiPO(String nomeServizio,String id, String label, URI refreshUri, List<RawParamValue> paramValues,
			 Object... objects) {
