...
public class DirittiFunzionalita_A_APP extends SelectList<Long>{
	...
	public DirittiFunzionalita_A_APP(String nomeServizio,String id, String label, URI refreshUri, List<RawParamValue> paramValues,
			Object... objects) {
