...
public class DominiVersamenti extends MultiSelectList<Long, List<Long>>{
	...
	protected List<Voce<Long>> getValues(List<RawParamValue> paramValues, Object... objects) throws ServiceException {
		String pagamentiAttesaValue = Utils.getValue(paramValues, this.versamentiId);
	...
	protected List<Long> getDefaultValue(List<RawParamValue> values, Object... objects) {
		String pagamentiAttesaValue = Utils.getValue(values, this.versamentiId);
