...
@Path("/dars/caricamenti/incassi")
public class TracciatiIncasso extends DarsService {

	public TracciatiIncasso() {
		super();
	}
	
	@Override
	public String getNomeServizio() {
		return "caricamentoIncassi";
	}

	@Override
	public IDarsHandler<?> getDarsHandler() {
		return new TracciatiIncassoHandler(this.log, this);
	}
	
	@Override
	public String getPathServizio() {
		return "/dars/caricamenti/incassi";// + this.getNomeServizio();
	}
	...
	public DarsResponse refresh(
		...
		try {
			...
			Elemento elemento = ((TracciatiIncassoHandler) this.getDarsHandler()).getElemento(id,uriInfo,bd);
