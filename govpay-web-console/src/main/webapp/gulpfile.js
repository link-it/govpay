...
gulp.task('remove-unused-bower-components', function (cb) {
  return del(['dist/bower_components/**/*', '!dist/bower_components/page','!dist/bower_components/page/**/*',
      '!dist/bower_components/webcomponentsjs', '!dist/bower_components/webcomponentsjs/**/*'],cb);
});

gulp.task('remove-unused-elements-components', function (cb) {
  return del(['dist/elements/**/*', '!dist/elements/bootstrap','!dist/elements/bootstrap/**/*',
      '!dist/elements/elements.vulcanized.html'],cb);
});
gulp.task('remove-unused-dist-files', function (cb) {
  return del(['dist/bower.json','dist/gulpfile.js','dist/package.json','dist/manifest.json','dist/robots.txt'],cb);
});
