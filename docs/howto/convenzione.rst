...
o più PSP (`SANP cap 5<https://docs.italia.it/italia/pagopa/pagopa-specifichepagamenti-docs/it/3.8.x/_docs/sezione3-specifiche-tecniche/3_01_06_convenzioni.html>`)al fine di poter offrire strumenti di pagamento ad un costo di commissioni agevolato.
