...
L'integrazione è l'attività necessaria per consentire l'interazione tra i sistemi gestionali e
GovPay al fine di realizzare i principali scenari d'uso previsti dalla
piattaforma di pagamento pagoPA.

Gli argomenti trattati sono quindi rivolti agli sviluppatori software che devono realizzare l'integrazione
a GovPay delle proprie applicazioni software interne al dominio applicativo
