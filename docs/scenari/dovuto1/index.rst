...
Lo scenario estende quando indicato nella sezione :ref:`integrazione_pagamentiente` fornendo un esempio di integrazione con il progetto `GovPay API Portal <https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/link-it/govpay-portal-api/refs/heads/main/src/main/resources/openapi.yaml&nocors>`_.
...
1. La :ref:`govpay_scenari_dovuto1_realizzazione`, che prevede:
   ...
   - L'uso delle *API Portale* di GovPay per l'integrazione con il portale al cittadino e
     realizzare il workflow di pagamento ad iniziativa Ente previsto da pagoPA.
