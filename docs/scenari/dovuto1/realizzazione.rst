...
invocando l’operazione `PUT /pendenze/{idA2A}/{idPendenza}` dell’API `Pendenze <https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/link-it/govpay/3.6.x/wars/api-pendenze/src/main/webapp/v2/govpay-api-pendenze-v2.yaml>`_.
...
`Pagamento <https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/link-it/govpay/3.6.x/wars/api-pagamento/src/main/webapp/v2/govpay-api-pagamento-v2.yaml>`_
