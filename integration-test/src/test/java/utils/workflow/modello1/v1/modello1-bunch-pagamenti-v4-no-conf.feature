...
* def idDominioPagamento = idDominio
* def codEntrataPagamento = codEntrataSegreteria
* call read('classpath:utils/workflow/modello1/v1/modello1-pagamento-spontaneo-basic.feature')
...
* def idDominioPagamento = idDominio
* def codEntrataPagamento = codEntrataSegreteria
* call read('classpath:utils/workflow/modello1/v1/modello1-pagamento-spontaneo-basic-idA2A2.feature')
* def idPagamentoVerdi_ESEGUITO_DOM1_SEGRETERIA_A2A2 = iuv
...
* def codEntrataPagamento = codEntrataSegreteria
* call read('classpath:utils/workflow/modello1/v1/modello1-pagamento-spontaneo-basic-idA2A2.feature')
* def idPagamentoVerdi_NONESEGUITO_DOM1_SEGRETERIA_A2A2 = iuv
...
* def codEntrataPagamento = codEntrataSiope
* call read('classpath:utils/workflow/modello1/v1/modello1-pagamento-spontaneo-basic-idA2A2.feature')
* def idPagamentoVerdi_ESEGUITO_DOM2_ENTRATASIOPE_A2A2 = iuv
...
* def codEntrataPagamento = codEntrataSiope
* call read('classpath:utils/workflow/modello1/v1/modello1-pagamento-spontaneo-basic-idA2A2.feature')
* def idPagamentoRossi_ESEGUITO_DOM2_ENTRATASIOPE_A2A2 = iuv
...
* def codEntrataPagamento = codEntrataSiope
* call read('classpath:utils/workflow/modello1/v1/modello1-pagamento-spontaneo-basic-idA2A2.feature')
* def idPagamentoRossi_NONESEGUITO_DOM2_ENTRATASIOPE_A2A2 = iuv
