	...
	"voci": [
		{
			...
			<#else>
			"idDominio": ${csvUtils.getCodDominioFromIbanAccredito(csvRecord, 30)},
		...
		,{
			...
			<#else>
			"idDominio": ${csvUtils.getCodDominioFromIbanAccredito(csvRecord, 41)},
		...
		,{
			...
			<#else>
			"idDominio": ${csvUtils.getCodDominioFromIbanAccredito(csvRecord, 52)},
		...
		,{
			...
			<#else>
			"idDominio": ${csvUtils.getCodDominioFromIbanAccredito(csvRecord, 63)},
		...
		,{
			...
			<#else>
			"idDominio": ${csvUtils.getCodDominioFromIbanAccredito(csvRecord, 74)},
