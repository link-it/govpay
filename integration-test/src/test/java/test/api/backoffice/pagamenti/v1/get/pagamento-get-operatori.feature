...
| operatore_none_none.json | idPagamentoAnonimo_INCORSO_DOM1_SEGRETERIA | 200 | pagamento-get-singolo_incorso_ente.json |
| operatore_none_none.json | idPagamentoVerdi_ESEGUITO_DOM1_SEGRETERIA | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_none_none.json | idPagamentoVerdi_ESEGUITO_DOM1_SEGRETERIA_A2A | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_none_none.json | idPagamentoVerdi_NONESEGUITO_DOM1_SEGRETERIA | 200 | pagamento-get-singolo_noneseguito_ente.json |
| operatore_none_none.json | idPagamentoVerdi_NONESEGUITO_DOM1_SEGRETERIA_A2A | 200 | pagamento-get-singolo_noneseguito_ente.json |
| operatore_none_none.json | idPagamentoVerdi_ESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_none_none.json | idPagamentoVerdi_ESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_none_none.json | idPagamentoVerdi_NONESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_noneseguito_ente.json |
| operatore_none_none.json | idPagamentoVerdi_RIFIUTATO_DOM1_LIBERO | 200 | pagamento-get-singolo_rifiutato_ente.json |
| operatore_none_none.json | idPagamentoVerdi_INCORSO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_incorso_ente.json |
| operatore_none_none.json | idPagamentoRossi_ESEGUITO_DOM1_SEGRETERIA | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_none_none.json | idPagamentoRossi_NONESEGUITO_DOM1_SEGRETERIA | 200 | pagamento-get-singolo_noneseguito_ente.json |
| operatore_none_none.json | idPagamentoRossi_ESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_none_none.json | idPagamentoRossi_NONESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_noneseguito_ente.json |
| operatore_none_none.json | idPagamentoRossi_ESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_none_none.json | idPagamentoRossi_NONESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_noneseguito_ente.json |
...
| operatore_domini1_segreteria.json | idPagamentoVerdi_ESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1_segreteria.json | idPagamentoVerdi_ESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1_segreteria.json | idPagamentoVerdi_NONESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_noneseguito_ente.json |
| operatore_domini1_segreteria.json | idPagamentoVerdi_RIFIUTATO_DOM1_LIBERO | 200 | pagamento-get-singolo_rifiutato_ente.json |
| operatore_domini1_segreteria.json | idPagamentoVerdi_INCORSO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_incorso_ente.json |
...
| operatore_domini1_segreteria.json | idPagamentoRossi_ESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1_segreteria.json | idPagamentoRossi_NONESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_noneseguito_ente.json |
| operatore_domini1_segreteria.json | idPagamentoRossi_ESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1_segreteria.json | idPagamentoRossi_NONESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_noneseguito_ente.json |
...
| operatore_domini1_star.json | idPagamentoVerdi_ESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1_star.json | idPagamentoVerdi_ESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1_star.json | idPagamentoVerdi_NONESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_noneseguito_ente.json |
| operatore_domini1_star.json | idPagamentoVerdi_RIFIUTATO_DOM1_LIBERO | 200 | pagamento-get-singolo_rifiutato_ente.json |
| operatore_domini1_star.json | idPagamentoVerdi_INCORSO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_incorso_ente.json |
...
| operatore_domini1_star.json | idPagamentoRossi_ESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1_star.json | idPagamentoRossi_NONESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_noneseguito_ente.json |
| operatore_domini1_star.json | idPagamentoRossi_ESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1_star.json | idPagamentoRossi_NONESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_noneseguito_ente.json |
...
| operatore_domini1e2_segreteria.json | idPagamentoVerdi_ESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1e2_segreteria.json | idPagamentoVerdi_ESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1e2_segreteria.json | idPagamentoVerdi_NONESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_noneseguito_ente.json |
| operatore_domini1e2_segreteria.json | idPagamentoVerdi_RIFIUTATO_DOM1_LIBERO | 200 | pagamento-get-singolo_rifiutato_ente.json |
| operatore_domini1e2_segreteria.json | idPagamentoVerdi_INCORSO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_incorso_ente.json |
...
| operatore_domini1e2_segreteria.json | idPagamentoRossi_ESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1e2_segreteria.json | idPagamentoRossi_NONESEGUITO_DOM2_ENTRATASIOPE | 200 | pagamento-get-singolo_noneseguito_ente.json |
| operatore_domini1e2_segreteria.json | idPagamentoRossi_ESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_eseguito_ente.json |
| operatore_domini1e2_segreteria.json | idPagamentoRossi_NONESEGUITO_DOM2_ENTRATASIOPE_A2A | 200 | pagamento-get-singolo_noneseguito_ente.json |
