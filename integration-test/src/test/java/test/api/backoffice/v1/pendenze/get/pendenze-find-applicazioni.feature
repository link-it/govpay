...
Scenario: Ricerca pagamenti applicazione dominio1 e dominio2 filtrati per data

* def backofficeBaseurl = getGovPayApiBaseUrl({api: 'backoffice', versione: 'v1', autenticazione: 'basic'})


* def applicazione_dominio1_2 = read('msg/applicazione_domini1e2_segreteria.json')

Given url backofficeBaseurl
And path 'applicazioni', idA2A
And headers gpAdminBasicAutenticationHeader
And request applicazione_dominio1_2
When method put
Then assert responseStatus == 200 || responseStatus == 201
...
Scenario: Ricerca pagamenti applicazione dominio1 e dominio2 senza UO filtrati per data

* def backofficeBaseurl = getGovPayApiBaseUrl({api: 'backoffice', versione: 'v1', autenticazione: 'basic'})


* def applicazione_dominio1_2 = read('msg/applicazione_dominio1_uo1_e_dominio2_uo_nessuna.json')
