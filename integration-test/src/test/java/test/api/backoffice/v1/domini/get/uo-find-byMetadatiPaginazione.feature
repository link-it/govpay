...
* def pathServizio = '/unitaOperative'

Scenario: Ricerca uo senza filtri sui metadati di paginazione
...
Scenario: Ricerca uo con metadatiPaginazione true
...
Scenario: Ricerca uo con metadatiPaginazione false
...
Scenario: Ricerca uo con metadatiPaginazione true e risultatiPerPagina = 0
...
Scenario: Ricerca uo con maxRisultati true
...
Scenario: Ricerca uo con maxRisultati false
