...
* def pathServizio = '/operatori'

Scenario: Ricerca operatori senza filtri sui metadati di paginazione
...
Scenario: Ricerca operatori con metadatiPaginazione true
...
Scenario: Ricerca operatori con metadatiPaginazione false
...
Scenario: Ricerca operatori con metadatiPaginazione true e risultatiPerPagina = 0
...
Scenario: Ricerca operatori con maxRisultati true
...
Scenario: Ricerca operatori con maxRisultati false
