...
Scenario: Update RT non pagata con RT pagata con variazione della causale versamento 
...
# controllo che l'operazione risulti eseguita
...
* match response.dettaglio contains 'RT non valida: CausaleVersamento non corrisponde [Atteso:"/RFB/' + iuvRTFormattata + '/109.99" Ricevuto:"/RFB/' + iuvRTFormattata + '/109.98"]'
...
And match response.dettaglioStato contains 'CausaleVersamento non corrisponde [Atteso:"/RFB/' + iuvRTFormattata + '/109.99" Ricevuto:"/RFB/' + iuvRTFormattata + '/109.98"]'
