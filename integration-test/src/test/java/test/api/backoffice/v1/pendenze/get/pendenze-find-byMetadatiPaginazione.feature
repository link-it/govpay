...
* def pathServizio = '/pendenze'

Scenario: Ricerca pendenze senza filtri sui metadati di paginazione
...
Scenario: Ricerca pendenze con metadatiPaginazione true
...
Scenario: Ricerca pendenze con metadatiPaginazione false
...
Scenario: Ricerca pendenze con metadatiPaginazione true e risultatiPerPagina = 0
...
Scenario: Ricerca pendenze con maxRisultati true
...
Scenario: Ricerca pendenze con maxRisultati false
