...
# # And match response.risultati[4].rpt.creditorReferenceId == idMessaggioRichiesta_Rossi_NONESEGUITO_DOM2_ENTRATASIOPE
# # And match response.risultati[5].rpt.creditorReferenceId == idMessaggioRichiesta_Rossi_ESEGUITO_DOM2_ENTRATASIOPE
# # And match response.risultati[0].rpt.creditorReferenceId == idMessaggioRichiesta_Rossi_NONESEGUITO_DOM1_SEGRETERIA
# And match response.risultati[1].rpt.creditorReferenceId == idMessaggioRichiesta_Rossi_ESEGUITO_DOM1_SEGRETERIA
# # And match response.risultati[8].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_NONESEGUITO_DOM2_ENTRATASIOPE
# # And match response.risultati[9].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_ESEGUITO_DOM2_ENTRATASIOPE_A2A2
# # And match response.risultati[10].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_ESEGUITO_DOM2_ENTRATASIOPE_A2A
# # And match response.risultati[11].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_ESEGUITO_DOM2_ENTRATASIOPE
# And match response.risultati[2].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_NONESEGUITO_DOM1_SEGRETERIA_A2A2
# And match response.risultati[3].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_NONESEGUITO_DOM1_SEGRETERIA_A2A
# And match response.risultati[4].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_NONESEGUITO_DOM1_SEGRETERIA
...
# # # And match response.risultati[0].rpt.creditorReferenceId == idMessaggioRichiesta_Rossi_NONESEGUITO_DOM1_SEGRETERIA
# # And match response.risultati[1].rpt.creditorReferenceId == idMessaggioRichiesta_Rossi_ESEGUITO_DOM1_SEGRETERIA
## And match response.risultati[6].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_NONESEGUITO_DOM2_ENTRATASIOPE
## And match response.risultati[7].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_ESEGUITO_DOM2_ENTRATASIOPE_A2A2
## And match response.risultati[8].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_ESEGUITO_DOM2_ENTRATASIOPE_A2A
## And match response.risultati[9].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_ESEGUITO_DOM2_ENTRATASIOPE
# # And match response.risultati[2].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_NONESEGUITO_DOM1_SEGRETERIA_A2A2
# # And match response.risultati[3].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_NONESEGUITO_DOM1_SEGRETERIA_A2A
# # And match response.risultati[4].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_NONESEGUITO_DOM1_SEGRETERIA
# # And match response.risultati[5].rpt.creditorReferenceId == idMessaggioRichiesta_Verdi_ESEGUITO_DOM1_SEGRETERIA_A2A2
