...
Scenario: Caricamento idA2A inesistente

Given url pendenzeBaseurl
And path '/pendenze', 'XXX', idPendenza
...
{ 
	...
	dettaglio: 'Applicazione (XXX) inesistente'
}
"""

Scenario: Caricamento idA2A disabilitato

* set applicazione_2.abilitato = false
...
{ 
	...
	codice: 'APP_001',
	descrizione: 'Richiesta non valida',
	dettaglio: '#("Applicazione (" + idA2A2 +") disabilitata")'
}
"""
