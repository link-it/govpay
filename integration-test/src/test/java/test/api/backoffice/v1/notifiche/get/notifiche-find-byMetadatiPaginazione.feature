...
* def pathServizio = '/notifiche'

Scenario: Ricerca notifiche senza filtri sui metadati di paginazione
...
Scenario: Ricerca notifiche con metadatiPaginazione true
...
Scenario: Ricerca notifiche con metadatiPaginazione false
...
Scenario: Ricerca notifiche con metadatiPaginazione true e risultatiPerPagina = 0
...
Scenario: Ricerca notifiche con maxRisultati true
...
Scenario: Ricerca notifiche con maxRisultati false
