...
* def pathServizio = '/domini'

Scenario: Ricerca domini senza filtri sui metadati di paginazione
...
Scenario: Ricerca domini con metadatiPaginazione true
...
Scenario: Ricerca domini con metadatiPaginazione false
...
Scenario: Ricerca domini con metadatiPaginazione true e risultatiPerPagina = 0
...
Scenario: Ricerca domini con maxRisultati true
...
Scenario: Ricerca domini con maxRisultati false
