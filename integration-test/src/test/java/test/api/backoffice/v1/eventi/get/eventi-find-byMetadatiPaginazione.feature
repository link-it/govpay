...
* def pathServizio = '/eventi'

Scenario: Ricerca eventi senza filtri sui metadati di paginazione
...
Scenario: Ricerca eventi con metadatiPaginazione true
...
Scenario: Ricerca eventi con metadatiPaginazione false
...
Scenario: Ricerca eventi con metadatiPaginazione true e risultatiPerPagina = 0
...
Scenario: Ricerca eventi con maxRisultati true
...
Scenario: Ricerca eventi con maxRisultati false
