...
* def pathServizio = '/promemoria'

Scenario: Ricerca promemoria senza filtri sui metadati di paginazione
...
Scenario: Ricerca promemoria con metadatiPaginazione true
...
Scenario: Ricerca promemoria con metadatiPaginazione false
...
Scenario: Ricerca promemoria con metadatiPaginazione true e risultatiPerPagina = 0
...
Scenario: Ricerca promemoria con maxRisultati true
...
Scenario: Ricerca promemoria con maxRisultati false
