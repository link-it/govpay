...
Scenario: Ricerca riscossioni senza filtri sui metadati di paginazione
...
Scenario: Ricerca riscossioni con metadatiPaginazione true
...
Scenario: Ricerca riscossioni con metadatiPaginazione false
...
Scenario: Ricerca riscossioni con metadatiPaginazione true e risultatiPerPagina = 0
...
Scenario: Ricerca riscossioni con maxRisultati true
...
Scenario: Ricerca riscossioni con maxRisultati false
