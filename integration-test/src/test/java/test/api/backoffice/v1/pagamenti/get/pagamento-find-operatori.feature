...
Scenario: Lettura dettaglio operatore operatore_star_star filtrati per data

* def operatore = read('msg/operatore_star_star.json')
...
Scenario: Lettura dettaglio operatore operatore_domini1e2_segreteria filtrati per data

* def operatore = read('msg/operatore_domini1e2_segreteria.json')
* def backofficeBaseurl = getGovPayApiBaseUrl({api: 'backoffice', versione: 'v1', autenticazione: 'basic'})
* def basicAutenticationHeader = getBasicAuthenticationHeader( { username: govpay_backoffice_user, password: govpay_backoffice_password } )
...
Scenario: Lettura dettaglio operatore operatore_domini1_segreteria filtrati per data

* def operatore = read('msg/operatore_domini1_segreteria.json')
* def backofficeBaseurl = getGovPayApiBaseUrl({api: 'backoffice', versione: 'v1', autenticazione: 'basic'})
* def basicAutenticationHeader = getBasicAuthenticationHeader( { username: govpay_backoffice_user, password: govpay_backoffice_password } )
...
Scenario: Lettura dettaglio operatore operatore_domini1_star filtrati per data

* def operatore = read('msg/operatore_domini1_star.json')
* def backofficeBaseurl = getGovPayApiBaseUrl({api: 'backoffice', versione: 'v1', autenticazione: 'basic'})
* def basicAutenticationHeader = getBasicAuthenticationHeader( { username: govpay_backoffice_user, password: govpay_backoffice_password } )
