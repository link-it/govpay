...
* set response /paSendRTV2Request/receipt/receiptId = idPendenza
...
Scenario: Ricevuta per una transazione SANP 2.4.0 V2, ricevuta malformata
...
* set response /paSendRTV2Request/receipt/receiptId = <pippo>bar</pippo>
* xmlstring rt = response
...
And match response.dettaglio contains 'paSendRTV2Request'
