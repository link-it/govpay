...
And param idA2A = idA2A
And param idPendenza = idPendenza
And param tipoEvento = 'submitMessageforUserWithFiscalCodeInBodyRicevutaPagamentoSenzaRPT'
And param messaggi = true
And headers gpAdminBasicAutenticationHeader
When method get
Then status 200
...
{  
	...
	"categoriaEvento": "INTERFACCIA",
	"ruolo": "CLIENT",
	"tipoEvento": "submitMessageforUserWithFiscalCodeInBodyRicevutaPagamentoSenzaRPT",
	"sottotipoEvento": "##null",
	"esito": "OK",
	"sottotipoEsito": "201",
	"dettaglioEsito": "##null",
