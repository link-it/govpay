...
| applicazione_domini1_star.json | rpt_Verdi_NONESEGUITO_DOM1_SEGRETERIA | 404 | errore_notFound.json |
| applicazione_domini1_star.json | rpt_Verdi_NONESEGUITO_DOM1_SEGRETERIA_A2A | 404 | errore_notFound.json |
| applicazione_domini1_star.json | rpt_Verdi_NONESEGUITO_DOM1_SEGRETERIA_A2A2 | 404 | errore_notFound.json |
...
| applicazione_domini1_star.json | rpt_Rossi_NONESEGUITO_DOM1_SEGRETERIA | 404 | errore_notFound.json |
...
And match response.risultati[0].iuv == rpt_Rossi_ESEGUITO_DOM1_SEGRETERIA.creditorReferenceId
...
And match response.risultati[1].iuv == rpt_Verdi_ESEGUITO_DOM1_SEGRETERIA_A2A2.creditorReferenceId
And match response.risultati[2].iuv == rpt_Verdi_ESEGUITO_DOM1_SEGRETERIA_A2A.creditorReferenceId
And match response.risultati[3].iuv == rpt_Verdi_ESEGUITO_DOM1_SEGRETERIA.creditorReferenceId
And match response == 
"""
{
	numRisultati: 4,
