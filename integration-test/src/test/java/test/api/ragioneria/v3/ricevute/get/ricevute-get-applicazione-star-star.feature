...
And match response.risultati[7].iuv == rpt_Rossi_ESEGUITO_DOM1_SEGRETERIA.creditorReferenceId
...
And match response.risultati[15].iuv == rpt_Verdi_ESEGUITO_DOM1_SEGRETERIA_A2A2.creditorReferenceId
And match response.risultati[16].iuv == rpt_Verdi_ESEGUITO_DOM1_SEGRETERIA_A2A.creditorReferenceId
And match response.risultati[17].iuv == rpt_Verdi_ESEGUITO_DOM1_SEGRETERIA.creditorReferenceId
And match response == 
"""
{
	numRisultati: 18,
