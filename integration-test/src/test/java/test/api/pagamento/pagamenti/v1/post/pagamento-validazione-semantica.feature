...
* def pagamentoPost = read('classpath:test/api/pagamento/pagamenti/v1/post/msg/pagamento-post_spontaneo.json')
* def pagamentiBaseurl = getGovPayApiBaseUrl({api: 'pagamento', versione: 'v1', autenticazione: 'basic'})
* def basicAutenticationHeader = getBasicAuthenticationHeader( { username: idA2A, password: 'password' } )
* def pagamentoPostEntrataRiferita = read('classpath:test/api/pagamento/pagamenti/v1/post/msg/pagamento-post_spontaneo_entratariferita.json')
