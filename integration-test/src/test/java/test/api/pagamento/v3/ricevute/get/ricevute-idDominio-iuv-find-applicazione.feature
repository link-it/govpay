...
| applicazione_star_star.json | rpt_Anonimo_INCORSO_DOM1_SEGRETERIA | 200 | lista_vuota.json |
...
| applicazione_star_star.json | rpt_Verdi_RIFIUTATO_DOM1_LIBERO | 200 | lista_vuota.json |
| applicazione_star_star.json | rpt_Verdi_INCORSO_DOM2_ENTRATASIOPE | 200 | lista_vuota.json |
...
| applicazione_domini1_star.json | rpt_Anonimo_INCORSO_DOM1_SEGRETERIA | 200 | lista_vuota.json |
...
| applicazione_domini1_star.json | rpt_Verdi_ESEGUITO_DOM2_ENTRATASIOPE | 404 | notFound.json |
| applicazione_domini1_star.json | rpt_Verdi_ESEGUITO_DOM2_ENTRATASIOPE_A2A | 404 | notFound.json |
| applicazione_domini1_star.json | rpt_Verdi_ESEGUITO_DOM2_ENTRATASIOPE_A2A2 | 404 | notFound.json |
| applicazione_domini1_star.json | rpt_Verdi_NONESEGUITO_DOM2_ENTRATASIOPE | 404 | notFound.json |
| applicazione_domini1_star.json | rpt_Verdi_RIFIUTATO_DOM1_LIBERO | 200 | lista_vuota.json |
...
| applicazione_domini1_star.json | rpt_Rossi_ESEGUITO_DOM2_ENTRATASIOPE | 404 | notFound.json |
| applicazione_domini1_star.json | rpt_Rossi_NONESEGUITO_DOM2_ENTRATASIOPE | 404 | notFound.json |
| applicazione_domini1_star.json | rpt_Rossi_ESEGUITO_DOM2_ENTRATASIOPE_A2A | 404 | notFound.json |
| applicazione_domini1_star.json | rpt_Rossi_ESEGUITO_DOM2_ENTRATASIOPE_A2A2 | 404 | notFound.json |
| applicazione_domini1_star.json | rpt_Rossi_NONESEGUITO_DOM2_ENTRATASIOPE_A2A | 404 | notFound.json |
| applicazione_domini1_star.json | rpt_Rossi_NONESEGUITO_DOM2_ENTRATASIOPE_A2A2 | 404 | notFound.json |
...
| applicazione_domini1e2_segreteria.json | rpt_Anonimo_INCORSO_DOM1_SEGRETERIA | 200 | lista_vuota.json |
...
| applicazione_domini1e2_segreteria.json | rpt_Verdi_RIFIUTATO_DOM1_LIBERO | 200 | lista_vuota.json |
| applicazione_domini1e2_segreteria.json | rpt_Verdi_INCORSO_DOM2_ENTRATASIOPE | 200 | lista_vuota.json |
