...
@test1
Scenario Outline: Lettura dettaglio applicazione [<applicazione>] della transazione [<rpt>] in formato json
...
@test2
Scenario Outline: Lettura ricevute pagamento utenza applicazione [<applicazione>] in formato pdf
