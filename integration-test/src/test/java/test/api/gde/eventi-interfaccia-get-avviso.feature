...
"""
And match response._embedded.eventi[0].dettaglioEsito == descrizioneStato
...
And match response._embedded.eventi[0].dettaglioEsito contains "UnknownHostException"
...
* def payloadRisposta = decodeBase64(response.parametriRisposta.payload)
...
"""
And match response._embedded.eventi[0].dettaglioEsito contains 'soggettoPagatore'
