Feature: GpPrt ChiediStatoVersamento
...
* def gpChiediStatoVersamentoRequest = read('classpath:test/api/legacy/v1/prt/post/msg/gpChiediStatoVersamentoRequest.xml')
* def gpChiediStatoVersamentoResponse = read('classpath:test/api/legacy/v1/prt/post/msg/gpChiediStatoVersamentoResponse-nonEseguito.xml')
...
* def gpChiediStatoVersamentoRequest = read('classpath:test/api/legacy/v1/prt/post/msg/gpChiediStatoVersamentoRequest.xml')
* def gpChiediStatoVersamentoResponse = read('classpath:test/api/legacy/v1/prt/post/msg/gpChiediStatoVersamentoResponse-inCorso.xml')
...
* def gpChiediStatoVersamentoRequest = read('classpath:test/api/legacy/v1/prt/post/msg/gpChiediStatoVersamentoRequest.xml')
* def gpChiediStatoVersamentoResponse = read('classpath:test/api/legacy/v1/prt/post/msg/gpChiediStatoVersamentoResponse-eseguito.xml')
