 ...
 */
    ...
    public Response pspIdPspCanaliGET(@Context UriInfo uriInfo, @Context HttpHeaders httpHeaders, 
        ...
        this.controller.setRequestResponse(this.request, this.response);
	return this.controller.pspIdPspCanaliGET(this.getPrincipal(), this.getListaRuoli(), uriInfo, httpHeaders, idPsp, pagina, risultatiPerPagina, ordinamento, campi, abilitato, modello, abilitato2);
    }
