...
public class Psp extends BaseRsServiceV1{
    ...
    @Produces({ "application/json" })
    public Response pspGET_1(@Context UriInfo uriInfo, @Context HttpHeaders httpHeaders, @QueryParam(value=Costanti.PARAMETRO_PAGINA) @DefaultValue(value="1") int pagina,
			@QueryParam(value=Costanti.PARAMETRO_RISULTATI_PER_PAGINA) @DefaultValue(value="25") int risultatiPerPagina, @QueryParam("ordinamento") String ordinamento, @QueryParam("campi") String campi, @QueryParam("abilitato") Boolean abilitato, @QueryParam("bollo") Boolean bollo, @QueryParam("storno") Boolean storno){
        this.controller.setRequestResponse(this.request, this.response);
	return this.controller.pspGET_1(this.getUser(), uriInfo, httpHeaders, pagina, risultatiPerPagina, ordinamento, campi, abilitato, bollo, storno);
    }
 ...
 */
    ...
    public Response pspIdPspCanaliGET(@Context UriInfo uriInfo, @Context HttpHeaders httpHeaders, 
			...
			@QueryParam("ordinamento") String ordinamento, @QueryParam("campi") String campi, @QueryParam("abilitato") Boolean abilitato, @QueryParam("modello") String modello, @QueryParam("abilitato2") String abilitato2){
        this.controller.setRequestResponse(this.request, this.response);
//	return this.controller.pspIdPspCanaliGET(this.getUser(), uriInfo, httpHeaders, idPsp, pagina, risultatiPerPagina, ordinamento, campi, abilitato, modello, abilitato2);
        return null;
    }
    ...
    @Produces({ "application/json" })
    public Response pspIdPspCanaliGET_2(@Context UriInfo uriInfo, @Context HttpHeaders httpHeaders, @QueryParam(value=Costanti.PARAMETRO_PAGINA) @DefaultValue(value="1") int pagina,
        ...
        this.controller.setRequestResponse(this.request, this.response);
	return this.controller.pspIdPspCanaliGET_2(this.getUser(), uriInfo, httpHeaders, pagina, risultatiPerPagina, ordinamento, campi, abilitato, modello, abilitato2);
    }
...
/*
    ...
    public Response pspIdPspCanaliIdCanaleTipoVersamentoGET_3(@Context UriInfo uriInfo, @Context HttpHeaders httpHeaders, @PathParam("idPsp") String idPsp, @PathParam("idCanale") String idCanale, @PathParam("tipoVersamento") TipoVersamento tipoVersamento){
        this.controller.setRequestResponse(this.request, this.response);
	return this.controller.pspIdPspCanaliIdCanaleTipoVersamentoGET_3(this.getUser(), uriInfo, httpHeaders,  idPsp,  idCanale,  tipoVersamento);
    }
...
/*
    ...
    public Response pspIdPspGET_4(@Context UriInfo uriInfo, @Context HttpHeaders httpHeaders, @PathParam("idPsp") String idPsp){
        this.controller.setRequestResponse(this.request, this.response);
	return this.controller.pspIdPspGET_4(this.getUser(), uriInfo, httpHeaders,  idPsp);
    }
*/
