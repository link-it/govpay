...
//					LoggerWrapperFactory.setLogConfiguration("/log4j2.xml");
			...
			try {
				...
				throw new RuntimeException("Inizializzazione Govpay-API-Backoffice ${project.version} (build " + commit + ") fallita.", e);
			}
		...
		log.info("Inizializzazione Govpay-API-Backoffice ${project.version} (build " + commit + ") completata con successo.");
		initialized = true;
	}
	...
	public void contextDestroyed(ServletContextEvent sce) {
		...
		log.info("Shutdown Govpay-API-Backoffice in corso...");
...
//		}
		...
		log.info("Shutdown di Govpay-API-Backoffice completato.");
	}
}
