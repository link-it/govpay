 ...
 *
 */
package it.govpay.core.utils.pagamento;
...
//		versamento.setAnomalie(pendenza.getAnomalie()); 
	...
	public static void fillSingoliVersamentiFromVociPendenzaBase(it.govpay.core.dao.commons.Versamento versamento, List<it.govpay.core.rs.v1.beans.base.VocePendenza> voci) {

		if(voci != null && voci.size() > 0) {
			for (it.govpay.core.rs.v1.beans.base.VocePendenza vocePendenza : voci) {
				it.govpay.core.dao.commons.Versamento.SingoloVersamento sv = new it.govpay.core.dao.commons.Versamento.SingoloVersamento();
	...
	public static it.govpay.core.dao.commons.Anagrafica toAnagraficaCommons(it.govpay.core.rs.v1.beans.base.Soggetto anagraficaRest) {
		it.govpay.core.dao.commons.Anagrafica anagraficaCommons = null;
		if(anagraficaRest != null) {
			anagraficaCommons = new it.govpay.core.dao.commons.Anagrafica();
			anagraficaCommons.setCap(anagraficaRest.getCap());
