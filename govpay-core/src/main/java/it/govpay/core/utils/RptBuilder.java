...
public class RptBuilder {
	...
	public Rpt buildRpt(
		...
		return buildRpt(
				...
				ccp,
				null,
				canale != null ? canale.getCodIntermediario() : null,
				canale != null ? canale.getPsp(bd).getCodPsp() : null,
				canale != null ? canale.getCodCanale() : null,
				canale != null ? canale.getTipoVersamento() : null,
				canale != null ? canale.getModelloPagamento() : null,
				versante,
				autenticazione,
				ibanAddebito,
				null,
