...
import it.govpay.core.rs.v1.beans.base.ConnettorePagopa;
...
public class ConnettorePagopaConverter {
	...
	public static Connettore getConnettore(it.govpay.core.rs.v1.beans.base.ConnettorePagopa connector) throws ServiceException {
