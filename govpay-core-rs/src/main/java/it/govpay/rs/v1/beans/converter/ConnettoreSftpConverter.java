...
import it.govpay.core.rs.v1.beans.base.ConnettoreFtp;
import it.govpay.core.rs.v1.beans.base.ServizioFtp;
import it.govpay.model.ConnettoreSftp;

public class ConnettoreSftpConverter {
	
	public static ConnettoreSftp getConnettore(it.govpay.core.rs.v1.beans.base.ServizioFtp connector, String idIntermediario) throws ServiceException {
