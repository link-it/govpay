...
public class FlussiRendicontazioneConverter {
	...
	public static FlussoRendicontazione toRsModel(it.govpay.bd.model.Fr fr) throws ServiceException, NotFoundException {
		...
		List<it.govpay.core.rs.v1.beans.ragioneria.Rendicontazione> rendicontazioniLst = new ArrayList<>();
	...
	public static it.govpay.core.rs.v1.beans.ragioneria.Rendicontazione toRendicontazioneRsModel(Rendicontazione rendicontazione) throws ServiceException, NotFoundException {
		it.govpay.core.rs.v1.beans.ragioneria.Rendicontazione rsModel = new it.govpay.core.rs.v1.beans.ragioneria.Rendicontazione();
