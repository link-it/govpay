...
/** <p>Java class for TabellaControparti complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TabellaControparti">
 * 		&lt;sequence>
...
@XmlType(name = "TabellaControparti", 
  propOrder = {
  	"idDominio",
  	"idFlusso",
...
@XmlRootElement(name = "TabellaControparti")

public class TabellaControparti extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  ...
  private static it.govpay.orm.model.TabellaContropartiModel modelStaticInstance = null;
  private static synchronized void initModelStaticInstance(){
	  if(it.govpay.orm.TabellaControparti.modelStaticInstance==null){
  			it.govpay.orm.TabellaControparti.modelStaticInstance = new it.govpay.orm.model.TabellaContropartiModel();
	  }
  }
  public static it.govpay.orm.model.TabellaContropartiModel model(){
	  if(it.govpay.orm.TabellaControparti.modelStaticInstance==null){
	  		initModelStaticInstance();
	  }
	  return it.govpay.orm.TabellaControparti.modelStaticInstance;
  }
