...
/**     
 * Enumeration dell'elemento StatoTracciatoType xsd (tipo:string) 
 *
...
public enum StatoTracciatoType implements IEnumeration , Serializable , Cloneable {
	...
	StatoTracciatoType(String value)
	{
		this.value = value;
	}
	...
	public boolean equals(Object object,List<String> fieldsNotCheck){
		if( !(object instanceof StatoTracciatoType) ){
	...
	public static String[] toArray(){
		...
		int i=0;
		for (StatoTracciatoType tmp : values()) {
			res[i]=tmp.getValue();
			i++;
		}
		return res;
	...
	public static StatoTracciatoType toEnumConstant(String value){
		try{
	...
	public static StatoTracciatoType toEnumConstant(String value, boolean throwNotFoundException) throws NotFoundException{
		StatoTracciatoType res = null;
		for (StatoTracciatoType tmp : values()) {
