...
public class JDBCSingoloVersamentoServiceImpl extends JDBCSingoloVersamentoServiceSearchImpl
	...
	public void create(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, SingoloVersamento singoloVersamento, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotImplementedException,ServiceException,Exception {
		...
		sqlQueryObjectInsert.addInsertField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().INDICE,false),"?");
		...
		sqlQueryObjectInsert.addInsertField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().IBAN_ACCREDITO,false),"?");
		...
		sqlQueryObjectInsert.addInsertField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().IMPORTO_COMMISSIONI_PA,false),"?");
		sqlQueryObjectInsert.addInsertField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().SINGOLO_IMPORTO_PAGATO,false),"?");
		sqlQueryObjectInsert.addInsertField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().CAUSALE_VERSAMENTO,false),"?");
		sqlQueryObjectInsert.addInsertField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().DATI_SPECIFICI_RISCOSSIONE,false),"?");
		...
		sqlQueryObjectInsert.addInsertField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().ESITO_SINGOLO_PAGAMENTO,false),"?");
		sqlQueryObjectInsert.addInsertField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().DATA_ESITO_SINGOLO_PAGAMENTO,false),"?");
		sqlQueryObjectInsert.addInsertField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().IUR,false),"?");
		...
		long id = jdbcUtilities.insertAndReturnGeneratedKey(sqlQueryObjectInsert, keyGenerator, jdbcProperties.isShowSql(),
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(singoloVersamento.getIndice(),SingoloVersamento.model().INDICE.getFieldType()),
			...
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(singoloVersamento.getIbanAccredito(),SingoloVersamento.model().IBAN_ACCREDITO.getFieldType()),
			...
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(singoloVersamento.getImportoCommissioniPA(),SingoloVersamento.model().IMPORTO_COMMISSIONI_PA.getFieldType()),
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(singoloVersamento.getSingoloImportoPagato(),SingoloVersamento.model().SINGOLO_IMPORTO_PAGATO.getFieldType()),
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(singoloVersamento.getCausaleVersamento(),SingoloVersamento.model().CAUSALE_VERSAMENTO.getFieldType()),
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(singoloVersamento.getDatiSpecificiRiscossione(),SingoloVersamento.model().DATI_SPECIFICI_RISCOSSIONE.getFieldType()),
			...
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(singoloVersamento.getEsitoSingoloPagamento(),SingoloVersamento.model().ESITO_SINGOLO_PAGAMENTO.getFieldType()),
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(singoloVersamento.getDataEsitoSingoloPagamento(),SingoloVersamento.model().DATA_ESITO_SINGOLO_PAGAMENTO.getFieldType()),
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(singoloVersamento.getIur(),SingoloVersamento.model().IUR.getFieldType()),
	...
	public void update(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, long tableId, SingoloVersamento singoloVersamento, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotFoundException, NotImplementedException, ServiceException, Exception {
		...
		sqlQueryObjectUpdate.addUpdateField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().INDICE,false), "?");
		lstObjects_singoloVersamento.add(new JDBCObject(singoloVersamento.getIndice(), SingoloVersamento.model().INDICE.getFieldType()));
		...
		sqlQueryObjectUpdate.addUpdateField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().IBAN_ACCREDITO,false), "?");
		lstObjects_singoloVersamento.add(new JDBCObject(singoloVersamento.getIbanAccredito(), SingoloVersamento.model().IBAN_ACCREDITO.getFieldType()));
		...
		sqlQueryObjectUpdate.addUpdateField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().IMPORTO_COMMISSIONI_PA,false), "?");
		lstObjects_singoloVersamento.add(new JDBCObject(singoloVersamento.getImportoCommissioniPA(), SingoloVersamento.model().IMPORTO_COMMISSIONI_PA.getFieldType()));
		sqlQueryObjectUpdate.addUpdateField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().SINGOLO_IMPORTO_PAGATO,false), "?");
		lstObjects_singoloVersamento.add(new JDBCObject(singoloVersamento.getSingoloImportoPagato(), SingoloVersamento.model().SINGOLO_IMPORTO_PAGATO.getFieldType()));
		sqlQueryObjectUpdate.addUpdateField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().CAUSALE_VERSAMENTO,false), "?");
		lstObjects_singoloVersamento.add(new JDBCObject(singoloVersamento.getCausaleVersamento(), SingoloVersamento.model().CAUSALE_VERSAMENTO.getFieldType()));
		sqlQueryObjectUpdate.addUpdateField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().DATI_SPECIFICI_RISCOSSIONE,false), "?");
		lstObjects_singoloVersamento.add(new JDBCObject(singoloVersamento.getDatiSpecificiRiscossione(), SingoloVersamento.model().DATI_SPECIFICI_RISCOSSIONE.getFieldType()));
		...
		sqlQueryObjectUpdate.addUpdateField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().ESITO_SINGOLO_PAGAMENTO,false), "?");
		lstObjects_singoloVersamento.add(new JDBCObject(singoloVersamento.getEsitoSingoloPagamento(), SingoloVersamento.model().ESITO_SINGOLO_PAGAMENTO.getFieldType()));
		sqlQueryObjectUpdate.addUpdateField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().DATA_ESITO_SINGOLO_PAGAMENTO,false), "?");
		lstObjects_singoloVersamento.add(new JDBCObject(singoloVersamento.getDataEsitoSingoloPagamento(), SingoloVersamento.model().DATA_ESITO_SINGOLO_PAGAMENTO.getFieldType()));
		sqlQueryObjectUpdate.addUpdateField(this.getSingoloVersamentoFieldConverter().toColumn(SingoloVersamento.model().IUR,false), "?");
		lstObjects_singoloVersamento.add(new JDBCObject(singoloVersamento.getIur(), SingoloVersamento.model().IUR.getFieldType()));
