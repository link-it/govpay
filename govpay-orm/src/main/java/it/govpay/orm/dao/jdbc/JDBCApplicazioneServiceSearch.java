...
public class JDBCApplicazioneServiceSearch implements IDBApplicazioneServiceSearch, IDBServiceUtilities<Applicazione> {
	...
	public JDBCApplicazioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCApplicazioneServiceSearch.class.getName()+ " initialized");
	...
	public IdApplicazione convertToId(Applicazione obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+Applicazione.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, Applicazione obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdApplicazione.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+Applicazione.class.getName()+") 'obj' is null");
			}
