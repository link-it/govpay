...
public class JDBCPagamentoPortaleVersamentoServiceSearchImpl implements IJDBCServiceSearchWithoutId<PagamentoPortaleVersamento, JDBCServiceManager> {
	...
	public IJDBCFetch getFetch() {
		return getPagamentoPortaleVersamentoFetch();
	}
	...
	public List<PagamentoPortaleVersamento> findAll(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotImplementedException, ServiceException,Exception {
        ...
        List<PagamentoPortaleVersamento> list = new ArrayList<PagamentoPortaleVersamento>();
        
        // TODO: implementazione non efficente. 
		// Per ottenere una implementazione efficente:
		// 1. Usare metodo select di questa classe indirizzando esattamente i field necessari
		// 2. Usare metodo getPagamentoPortaleVersamentoFetch() sul risultato della select per ottenere un oggetto PagamentoPortaleVersamento
	...
	private PagamentoPortaleVersamento _get(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, Long tableId, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotFoundException, MultipleResultException, NotImplementedException, ServiceException, Exception {
		...
		ISQLQueryObject sqlQueryObjectGet_pagamentoPortaleVersamento = sqlQueryObjectGet.newSQLQueryObject();
		sqlQueryObjectGet_pagamentoPortaleVersamento.setANDLogicOperator(true);
		sqlQueryObjectGet_pagamentoPortaleVersamento.addFromTable(this.getPagamentoPortaleVersamentoFieldConverter().toTable(PagamentoPortaleVersamento.model()));
		sqlQueryObjectGet_pagamentoPortaleVersamento.addSelectField("id");
		sqlQueryObjectGet_pagamentoPortaleVersamento.addWhereCondition("id=?");

		// Get pagamentoPortaleVersamento
		pagamentoPortaleVersamento = (PagamentoPortaleVersamento) jdbcUtilities.executeQuerySingleResult(sqlQueryObjectGet_pagamentoPortaleVersamento.createSQLQuery(), jdbcProperties.isShowSql(), PagamentoPortaleVersamento.model(), this.getPagamentoPortaleVersamentoFetch(),
		...
		if(idMappingResolutionBehaviour==null ||
			...
			// Object _pagamentoPortaleVersamento_pagamentoPortale (recupero id)
			ISQLQueryObject sqlQueryObjectGet_pagamentoPortaleVersamento_pagamentoPortale_readFkId = sqlQueryObjectGet.newSQLQueryObject();
			sqlQueryObjectGet_pagamentoPortaleVersamento_pagamentoPortale_readFkId.addFromTable(this.getPagamentoPortaleVersamentoFieldConverter().toTable(it.govpay.orm.PagamentoPortaleVersamento.model()));
			sqlQueryObjectGet_pagamentoPortaleVersamento_pagamentoPortale_readFkId.addSelectField("id_pagamento_portale");
			sqlQueryObjectGet_pagamentoPortaleVersamento_pagamentoPortale_readFkId.addWhereCondition("id=?");
			sqlQueryObjectGet_pagamentoPortaleVersamento_pagamentoPortale_readFkId.setANDLogicOperator(true);
			Long idFK_pagamentoPortaleVersamento_pagamentoPortale = (Long) jdbcUtilities.executeQuerySingleResult(sqlQueryObjectGet_pagamentoPortaleVersamento_pagamentoPortale_readFkId.createSQLQuery(), jdbcProperties.isShowSql(),Long.class,
					new JDBCObject(pagamentoPortaleVersamento.getId(),Long.class));
		...
		if(idMappingResolutionBehaviour==null ||
			...
			// Object _pagamentoPortaleVersamento_versamento (recupero id)
			ISQLQueryObject sqlQueryObjectGet_pagamentoPortaleVersamento_versamento_readFkId = sqlQueryObjectGet.newSQLQueryObject();
			sqlQueryObjectGet_pagamentoPortaleVersamento_versamento_readFkId.addFromTable(this.getPagamentoPortaleVersamentoFieldConverter().toTable(it.govpay.orm.PagamentoPortaleVersamento.model()));
			sqlQueryObjectGet_pagamentoPortaleVersamento_versamento_readFkId.addSelectField("id_versamento");
			sqlQueryObjectGet_pagamentoPortaleVersamento_versamento_readFkId.addWhereCondition("id=?");
			sqlQueryObjectGet_pagamentoPortaleVersamento_versamento_readFkId.setANDLogicOperator(true);
			Long idFK_pagamentoPortaleVersamento_versamento = (Long) jdbcUtilities.executeQuerySingleResult(sqlQueryObjectGet_pagamentoPortaleVersamento_versamento_readFkId.createSQLQuery(), jdbcProperties.isShowSql(),Long.class,
					new JDBCObject(pagamentoPortaleVersamento.getId(),Long.class));
        ...
        return pagamentoPortaleVersamento;  
