...
public class JDBCBatchServiceSearch implements IDBBatchServiceSearch, IDBServiceUtilities<Batch> {
	...
	public JDBCBatchServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCBatchServiceSearch.class.getName()+ " initialized");
	...
	public IdBatch convertToId(Batch obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+Batch.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, Batch obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdBatch.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+Batch.class.getName()+") 'obj' is null");
			}
