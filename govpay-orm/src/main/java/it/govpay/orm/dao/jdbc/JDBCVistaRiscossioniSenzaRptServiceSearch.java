...
import it.govpay.orm.dao.IDBVistaRiscossioniSenzaRptServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link it.govpay.orm.VistaRiscossioniSenzaRpt} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCVistaRiscossioniSenzaRptServiceSearch implements IDBVistaRiscossioniSenzaRptServiceSearch, IDBServiceUtilities<VistaRiscossioniSenzaRpt> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<VistaRiscossioniSenzaRpt, IdVistaRiscossione, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCVistaRiscossioniSenzaRptServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCVistaRiscossioniSenzaRptServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("vistaRiscossioniSenzaRpt");
	...
	@Override
	public void validate(VistaRiscossioniSenzaRpt vistaRiscossioniSenzaRpt) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(vistaRiscossioniSenzaRpt, this.log, 
	...
	@Override
	public IdVistaRiscossione convertToId(VistaRiscossioniSenzaRpt obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+VistaRiscossioniSenzaRpt.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public VistaRiscossioniSenzaRpt get(IdVistaRiscossione id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdVistaRiscossione.class.getName()+") 'id' is null");
			}
	...
	@Override
	public VistaRiscossioniSenzaRpt get(IdVistaRiscossione id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdVistaRiscossione id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdVistaRiscossione> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdVistaRiscossione> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<VistaRiscossioniSenzaRpt> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<VistaRiscossioniSenzaRpt> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public VistaRiscossioniSenzaRpt find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public VistaRiscossioniSenzaRpt find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdVistaRiscossione id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdVistaRiscossione id, VistaRiscossioniSenzaRpt obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, VistaRiscossioniSenzaRpt obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdVistaRiscossione.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+VistaRiscossioniSenzaRpt.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public VistaRiscossioniSenzaRpt get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public VistaRiscossioniSenzaRpt get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdVistaRiscossione findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdVistaRiscossione id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {
