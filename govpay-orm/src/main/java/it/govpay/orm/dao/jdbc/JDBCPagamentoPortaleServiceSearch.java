...
public class JDBCPagamentoPortaleServiceSearch implements IDBPagamentoPortaleServiceSearch, IDBServiceUtilities<PagamentoPortale> {
	...
	public JDBCPagamentoPortaleServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCPagamentoPortaleServiceSearch.class.getName()+ " initialized");
	...
	public IdPagamentoPortale convertToId(PagamentoPortale obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+PagamentoPortale.class.getName()+") 'obj' is null");
			}
