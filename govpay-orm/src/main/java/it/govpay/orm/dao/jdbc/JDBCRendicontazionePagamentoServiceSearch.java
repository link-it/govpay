...
/**     
 * Service can be used to search for the backend objects of type {@link it.govpay.orm.RendicontazionePagamento} 
 *
...
public class JDBCRendicontazionePagamentoServiceSearch implements IDBRendicontazionePagamentoServiceSearch, IDBServiceUtilities<RendicontazionePagamento> {
	...
	protected IJDBCServiceSearchWithoutId<RendicontazionePagamento, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCRendicontazionePagamentoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCRendicontazionePagamentoServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("rendicontazionePagamento");
	...
	@Override
	public void validate(RendicontazionePagamento rendicontazionePagamento) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(rendicontazionePagamento, this.log, 
	...
	@Override
	public List<RendicontazionePagamento> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<RendicontazionePagamento> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public RendicontazionePagamento find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public RendicontazionePagamento find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
