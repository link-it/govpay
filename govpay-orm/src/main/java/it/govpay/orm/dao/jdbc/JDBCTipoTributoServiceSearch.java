...
public class JDBCTipoTributoServiceSearch implements IDBTipoTributoServiceSearch, IDBServiceUtilities<TipoTributo> {
	...
	public JDBCTipoTributoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCTipoTributoServiceSearch.class.getName()+ " initialized");
	...
	public IdTipoTributo convertToId(TipoTributo obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+TipoTributo.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, TipoTributo obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdTipoTributo.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+TipoTributo.class.getName()+") 'obj' is null");
			}
