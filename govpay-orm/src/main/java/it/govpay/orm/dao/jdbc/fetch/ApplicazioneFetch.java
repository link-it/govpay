	...
	public Object fetch(TipiDatabase tipoDatabase, IModel<?> model , ResultSet rs) throws ServiceException {
		...
		try{
			...
			if(model.equals(Applicazione.model())){
				...
				setParameter(object, "setPolicyRispedizione", Applicazione.model().POLICY_RISPEDIZIONE.getFieldType(),
					jdbcParameterUtilities.readParameter(rs, "policy_rispedizione", Applicazione.model().POLICY_RISPEDIZIONE.getFieldType()));
	...
	public Object fetch(TipiDatabase tipoDatabase, IModel<?> model , Map<String,Object> map ) throws ServiceException {
		...
		try{
			...
			if(model.equals(Applicazione.model())){
				...
				setParameter(object, "setPolicyRispedizione", Applicazione.model().POLICY_RISPEDIZIONE.getFieldType(),
					this.getObjectFromMap(map,"policyRispedizione"));
				setParameter(object, "setCodConnettoreEsito", Applicazione.model().COD_CONNETTORE_ESITO.getFieldType(),
