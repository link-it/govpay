...
import it.govpay.orm.dao.IDBTabellaContropartiServiceSearch;
...
/**     
 * Service can be used to search for the backend objects of type {@link it.govpay.orm.TabellaControparti} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCTabellaContropartiServiceSearch implements IDBTabellaContropartiServiceSearch, IDBServiceUtilities<TabellaControparti> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<TabellaControparti, IdTabellaControparti, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCTabellaContropartiServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCTabellaContropartiServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("tabellaControparti");
	...
	@Override
	public void validate(TabellaControparti tabellaControparti) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(tabellaControparti, this.log, 
	...
	@Override
	public IdTabellaControparti convertToId(TabellaControparti obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+TabellaControparti.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public TabellaControparti get(IdTabellaControparti id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public TabellaControparti get(IdTabellaControparti id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdTabellaControparti id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdTabellaControparti> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdTabellaControparti> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<TabellaControparti> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<TabellaControparti> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public TabellaControparti find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public TabellaControparti find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdTabellaControparti id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdTabellaControparti id, TabellaControparti obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, TabellaControparti obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
			
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdTabellaControparti.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+TabellaControparti.class.getName()+") 'obj' is null");
			}
	...
	@Override
	public TabellaControparti get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public TabellaControparti get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdTabellaControparti findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdTabellaControparti id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {
