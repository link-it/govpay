...
public class JDBCTributoServiceSearch implements IDBTributoServiceSearch, IDBServiceUtilities<Tributo> {
	...
	public JDBCTributoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCTributoServiceSearch.class.getName()+ " initialized");
	...
	public IdTributo convertToId(Tributo obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+Tributo.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, Tributo obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdTributo.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+Tributo.class.getName()+") 'obj' is null");
			}
