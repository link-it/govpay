...
public class JDBCDominioServiceSearch implements IDBDominioServiceSearch, IDBServiceUtilities<Dominio> {
	...
	public JDBCDominioServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCDominioServiceSearch.class.getName()+ " initialized");
	...
	public IdDominio convertToId(Dominio obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+Dominio.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, Dominio obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdDominio.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+Dominio.class.getName()+") 'obj' is null");
			}
