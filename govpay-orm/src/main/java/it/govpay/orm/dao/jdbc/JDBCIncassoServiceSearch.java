...
public class JDBCIncassoServiceSearch implements IDBIncassoServiceSearch, IDBServiceUtilities<Incasso> {
	...
	public JDBCIncassoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCIncassoServiceSearch.class.getName()+ " initialized");
	...
	public IdIncasso convertToId(Incasso obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+Incasso.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, Incasso obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdIncasso.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+Incasso.class.getName()+") 'obj' is null");
			}
