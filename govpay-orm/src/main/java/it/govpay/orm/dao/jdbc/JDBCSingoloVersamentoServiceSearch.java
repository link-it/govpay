...
public class JDBCSingoloVersamentoServiceSearch implements IDBSingoloVersamentoServiceSearch, IDBServiceUtilities<SingoloVersamento> {
	...
	public JDBCSingoloVersamentoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCSingoloVersamentoServiceSearch.class.getName()+ " initialized");
	...
	public IdSingoloVersamento convertToId(SingoloVersamento obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+SingoloVersamento.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, SingoloVersamento obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdSingoloVersamento.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+SingoloVersamento.class.getName()+") 'obj' is null");
			}
