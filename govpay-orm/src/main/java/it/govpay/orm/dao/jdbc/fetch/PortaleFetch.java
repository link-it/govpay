 ...
 * @version $Rev$, $Date$
 */
public class PortaleFetch extends AbstractJDBCFetch {
	...
	public Object fetch(TipiDatabase tipoDatabase, IModel<?> model , ResultSet rs) throws ServiceException {
		...
		try{
			...
			if(model.equals(Portale.model())){
				Portale object = new Portale();
				setParameter(object, "setId", Long.class,
					jdbcParameterUtilities.readParameter(rs, "id", Long.class));
				setParameter(object, "setCodPortale", Portale.model().COD_PORTALE.getFieldType(),
					jdbcParameterUtilities.readParameter(rs, "cod_portale", Portale.model().COD_PORTALE.getFieldType()));
				setParameter(object, "setDefaultCallbackURL", Portale.model().DEFAULT_CALLBACK_URL.getFieldType(),
