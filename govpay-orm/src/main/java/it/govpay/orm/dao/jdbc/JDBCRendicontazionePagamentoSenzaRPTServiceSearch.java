...
/**     
 * Service can be used to search for the backend objects of type {@link it.govpay.orm.RendicontazionePagamentoSenzaRPT} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCRendicontazionePagamentoSenzaRPTServiceSearch implements IRendicontazionePagamentoSenzaRPTServiceSearch, IDBServiceUtilities<RendicontazionePagamentoSenzaRPT> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithoutId<RendicontazionePagamentoSenzaRPT, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCRendicontazionePagamentoSenzaRPTServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCRendicontazionePagamentoSenzaRPTServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("rendicontazionePagamentoSenzaRPT");
	...
	@Override
	public void validate(RendicontazionePagamentoSenzaRPT rendicontazionePagamentoSenzaRPT) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(rendicontazionePagamentoSenzaRPT, this.log, 
	...
	@Override
	public List<RendicontazionePagamentoSenzaRPT> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<RendicontazionePagamentoSenzaRPT> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public RendicontazionePagamentoSenzaRPT find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public RendicontazionePagamentoSenzaRPT find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
