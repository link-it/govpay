...
/** <p>Java class for VistaRiscossioniSenzaRpt complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="VistaRiscossioniSenzaRpt">
 * 		&lt;sequence>
...
@XmlType(name = "VistaRiscossioniSenzaRpt", 
  propOrder = {
  	"codDominio",
  	"iuv",
  	"iur",
...
@XmlRootElement(name = "VistaRiscossioniSenzaRpt")

public class VistaRiscossioniSenzaRpt extends org.openspcoop2.utils.beans.BaseBean implements Serializable , Cloneable {
  public VistaRiscossioniSenzaRpt() {
  }
  ...
  private static it.govpay.orm.model.VistaRiscossioniSenzaRptModel modelStaticInstance = null;
  private static synchronized void initModelStaticInstance(){
	  if(it.govpay.orm.VistaRiscossioniSenzaRpt.modelStaticInstance==null){
  			it.govpay.orm.VistaRiscossioniSenzaRpt.modelStaticInstance = new it.govpay.orm.model.VistaRiscossioniSenzaRptModel();
	  }
  }
  public static it.govpay.orm.model.VistaRiscossioniSenzaRptModel model(){
	  if(it.govpay.orm.VistaRiscossioniSenzaRpt.modelStaticInstance==null){
	  		initModelStaticInstance();
	  }
	  return it.govpay.orm.VistaRiscossioniSenzaRpt.modelStaticInstance;
  }
