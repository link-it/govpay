...
public class IdTributoModel extends AbstractModel<IdTributo> {
	...
	public IdTributoModel(){
		...
		this.ID_ENTE = new it.govpay.orm.model.IdEnteModel(new Field("idEnte",it.govpay.orm.IdEnte.class,"id-tributo",IdTributo.class));
	...
	public IdTributoModel(IField father){
		...
		this.ID_ENTE = new it.govpay.orm.model.IdEnteModel(new ComplexField(father,"idEnte",it.govpay.orm.IdEnte.class,"id-tributo",IdTributo.class));
