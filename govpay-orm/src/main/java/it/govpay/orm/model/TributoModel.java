...
public class TributoModel extends AbstractModel<Tributo> {
	...
	public TributoModel(){
		...
		this.ID_IBAN_APPOGGIO = new it.govpay.orm.model.IdIbanAccreditoModel(new Field("idIbanAppoggio",it.govpay.orm.IdIbanAccredito.class,"Tributo",Tributo.class));
		...
		this.ONLINE = new Field("online",java.lang.String.class,"Tributo",Tributo.class);
		this.PAGA_TERZI = new Field("pagaTerzi",java.lang.String.class,"Tributo",Tributo.class);
	...
	public TributoModel(IField father){
		...
		this.ID_IBAN_APPOGGIO = new it.govpay.orm.model.IdIbanAccreditoModel(new ComplexField(father,"idIbanAppoggio",it.govpay.orm.IdIbanAccredito.class,"Tributo",Tributo.class));
		...
		this.ONLINE = new ComplexField(father,"online",java.lang.String.class,"Tributo",Tributo.class);
		this.PAGA_TERZI = new ComplexField(father,"pagaTerzi",java.lang.String.class,"Tributo",Tributo.class);
