...
public class CfgTipoCommissione extends BaseEntity {
	...
	public String toString() {
		...
		builder.append("CfgTipoCommissione [getBundleKey()=");
		builder.append(getBundleKey());
		builder.append(", getDescrizione()=");
		builder.append(getDescrizione());
		builder.append(", getFlStato()=");
		builder.append(getFlStato());
	...
	// }
	//
	// public void setCfgCommissionePagamenti(Set<CfgCommissionePagamento>
	// cfgCommissionePagamenti) {
