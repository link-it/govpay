...
@NamedQueries({ 
//	@NamedQuery(name = "getcfcnByBundleKey", query = "select cf from CfgCanalePagamento cf "
//		+ "where cf.bundleKey =:inBundleKey") 
})
public class CfgCanalePagamento extends BaseEntity {
	...
	public String toString() {
		...
		builder.append("CfgCanalePagamento [getBundleKey()=");
