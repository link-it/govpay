...
public class OracleNativeQueries extends NativeQueries {
	...
	public String getRendicontazionePagamentoQuery() {
		return "SELECT " +
				...
				" p_importo_pagato,p_data_acquisizione,p_iur,p_data_pagamento,p_commissioni_psp,p_tipo_allegato,p_allegato,p_data_acquisizione_revoca,p_causale_revoca,p_dati_revoca,p_importo_revocato,p_esito_revoca,p_dati_esito_revoca,p_id,p_id_rpt,p_id_singolo_versamento,p_id_rr,p_id_incasso,p_iban_accredito,p_cod_dominio,p_iuv, " +
