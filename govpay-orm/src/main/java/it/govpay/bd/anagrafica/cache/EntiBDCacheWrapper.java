...
public class EntiBDCacheWrapper extends AbstractCacheWrapper {

	public EntiBDCacheWrapper(boolean initializeCache, Logger log) throws UtilsException {
		super("enti", initializeCache, log);
	}

	@Override
	public Object getDriver(Object basicBD) throws UtilsException {
		return new EntiBD((BasicBD) basicBD);
	}
