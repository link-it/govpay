...
public class PspBDCacheWrapper extends AbstractCacheWrapper {

	public PspBDCacheWrapper(boolean initializeCache, Logger log) throws UtilsException {
		super("psp", initializeCache, log);
	}
