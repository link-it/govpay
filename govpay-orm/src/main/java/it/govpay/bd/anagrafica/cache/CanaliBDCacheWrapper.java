...
public class CanaliBDCacheWrapper extends AbstractCacheWrapper {

	public CanaliBDCacheWrapper(boolean initializeCache, Logger log) throws UtilsException {
		super("canali", initializeCache, log);
	}

	@Override
	public Object getDriver(Object basicBD) throws UtilsException {
		return new PspBD((BasicBD) basicBD);
	}
