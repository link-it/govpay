...
public class GovPayException extends Exception {
	...
	public enum GovPayExceptionEnum {
		...
		ERRORE_AUTENTICAZIONE("KOGP0015"),
		ERRORE_AUTORIZZAZIONE("KOGP0016"),
		APPLICAZIONE_DISABILITATA("KOGP0017"),
		APPLICAZIONE_NON_TROVATA("KOGP0018"),
		TRIBUTO_NON_TROVATO("KOGP0019"), 
		PSP_NON_ATTIVO("KOGP0020");
