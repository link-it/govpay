...
ALTER TABLE canali DROP FOREIGN KEY fk_canali_1;
ALTER TABLE stazioni DROP FOREIGN KEY fk_stazioni_1;
ALTER TABLE domini DROP FOREIGN KEY fk_domini_1;
ALTER TABLE domini DROP FOREIGN KEY fk_domini_2;
ALTER TABLE uo DROP FOREIGN KEY fk_uo_1;
ALTER TABLE iban_accredito DROP FOREIGN KEY fk_iban_accredito_1;
ALTER TABLE tributi DROP FOREIGN KEY fk_tributi_1;
ALTER TABLE tributi DROP FOREIGN KEY fk_tributi_2;
ALTER TABLE tributi DROP FOREIGN KEY fk_tributi_3;
ALTER TABLE acl DROP FOREIGN KEY fk_acl_1;
ALTER TABLE acl DROP FOREIGN KEY fk_acl_2;
ALTER TABLE acl DROP FOREIGN KEY fk_acl_3;
ALTER TABLE acl DROP FOREIGN KEY fk_acl_4;
ALTER TABLE acl DROP FOREIGN KEY fk_acl_5;
ALTER TABLE acl DROP FOREIGN KEY fk_acl_6;
ALTER TABLE rr DROP FOREIGN KEY fk_rr_1;
ALTER TABLE incassi DROP FOREIGN KEY fk_incassi_1;
ALTER TABLE pagamenti DROP FOREIGN KEY fk_pagamenti_1;
ALTER TABLE pagamenti DROP FOREIGN KEY fk_pagamenti_2;
ALTER TABLE pagamenti DROP FOREIGN KEY fk_pagamenti_3;
ALTER TABLE pagamenti DROP FOREIGN KEY fk_pagamenti_4;
ALTER TABLE rendicontazioni DROP FOREIGN KEY fk_rendicontazioni_1;
ALTER TABLE rendicontazioni DROP FOREIGN KEY fk_rendicontazioni_2;
ALTER TABLE tracciati DROP FOREIGN KEY fk_tracciati_1;
ALTER TABLE tracciati DROP FOREIGN KEY fk_tracciati_2;
ALTER TABLE operazioni DROP FOREIGN KEY fk_operazioni_1;
ALTER TABLE operazioni DROP FOREIGN KEY fk_operazioni_2;
ALTER TABLE gp_audit DROP FOREIGN KEY fk_gp_audit_1;
