...
ALTER TABLE versamenti ADD COLUMN data_notifica_avviso TIMESTAMP(3);
ALTER TABLE versamenti ADD COLUMN avviso_notificato BOOLEAN;
ALTER TABLE versamenti ADD COLUMN avv_mail_data_prom_scadenza TIMESTAMP(3);
ALTER TABLE versamenti ADD COLUMN avv_mail_prom_scad_notificato BOOLEAN;
ALTER TABLE versamenti ADD COLUMN avv_app_io_data_prom_scadenza TIMESTAMP(3);
ALTER TABLE versamenti ADD COLUMN avv_app_io_prom_scad_notificat BOOLEAN;
...
ALTER TABLE versamenti MODIFY COLUMN cod_rata VARCHAR(35); 
...
ALTER TABLE tracciati ADD COLUMN zip_stampe MEDIUMBLOB;
