...
(
	...
	data_caricamento DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di caricamento del tracciato',
...
(
	...
	data_creazione DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di inserimento della pendenza',
	...
	data_ora_ultimo_aggiornamento DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data dell\'ultima variazione dei dati della pendenza',
...
(
	...
	data_creazione DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'data creazione della notifica',
...
(
	...
	data_msg_richiesta DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di creazione della RPT',
	...
	data_aggiornamento_stato DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data dell\'ultimo aggiornamento di stato della RPT',
...
(
	...
	data_creazione DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di creazione della notifica',
	...
	data_aggiornamento_stato DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data dell\'ultimo aggiornamento',
...
(
	...
	data_creazione DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di creazione del promemoria',
	...
	data_aggiornamento_stato DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data dell\'ultimo aggiornamento',
	data_prossima_spedizione DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di prossima spedizione del promemoria',
...
(
	...
	data_ora_incasso DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data della riconciliazione',
...
(
	...
	data_acquisizione DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di acquisizione del flusso',
...
(
	...
	data_acquisizione DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data acquisizione del pagamento',
	iur VARCHAR(35) NOT NULL COMMENT 'Identificativo di riscossione',
	data_pagamento DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data del pagamento',
...
(
	...
	data DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di rendicontazione',
...
CREATE TABLE stampe
(
	data_creazione DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di creazione della stampa',
...
(
	data DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di emissione dell\'audit',
...
(
	...
	ora_registrazione DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Ora di registrazione',
	-- fk/pk columns
	-- fk/pk keys constraints
...
(
	...
	data_creazione DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'data creazione allegato',
...
(
	...
	data_ok DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di ultima esecuzione del check con esito ok',
	data_warn DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di ultima esecuzione del check con esito warning',
	data_error DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di ultima esecuzione del check con esito errore',
	data_ultimo_check DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3) COMMENT 'Data di ultima esecuzione del check',
