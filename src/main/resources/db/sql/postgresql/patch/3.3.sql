...
ALTER TABLE promemoria ALTER COLUMN id_versamento DROP NOT NULL;
...
ALTER TABLE stampe ALTER COLUMN id_versamento DROP NOT NULL;
...
ALTER TABLE versamenti ALTER COLUMN tipo SET NOT NULL;
...
ALTER TABLE versamenti ALTER COLUMN cod_rata TYPE VARCHAR(35); 
