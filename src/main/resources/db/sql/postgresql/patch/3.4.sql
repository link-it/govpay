...
ALTER TABLE fr ALTER COLUMN obsoleto SET NOT NULL;
UPDATE fr SET data_ora_flusso = data_acquisizione WHERE data_ora_flusso IS NULL;
ALTER TABLE fr ALTER COLUMN data_ora_flusso SET NOT NULL;
...
ALTER TABLE versamenti ADD COLUMN proprieta TEXT;
