...
UPDATE versamenti SET data_ultima_modifica_aca = '1900-01-01 00:00:00' WHERE data_ultima_modifica_aca IS NULL;
...
UPDATE versamenti SET stato_pagamento = 'INCASSATO'
WHERE id NOT IN (
...
AND stato_pagamento != 'INCASSATO' AND stato_versamento = 'ESEGUITO';
