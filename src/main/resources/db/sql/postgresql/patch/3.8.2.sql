...
ALTER TABLE fr ALTER COLUMN xml DROP NOT NULL;
...
UPDATE fr SET id_dominio = domini.id FROM domini WHERE fr.cod_dominio = domini.cod_dominio;
ALTER TABLE fr ALTER COLUMN id_dominio SET NOT NULL;
...
ALTER TABLE fr ALTER COLUMN ragione_sociale_psp TYPE VARCHAR(255);
ALTER TABLE fr ALTER COLUMN ragione_sociale_dominio TYPE VARCHAR(255);
