...
(
	...
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_configurazione,
	-- unique constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_intermediari,
	-- unique constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_stazioni,
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_utenze,
	-- unique constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_iban_accredito,
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_tipi_tributo,
	-- unique constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_tributi,
	id_dominio BIGINT NOT NULL,
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_uo,
	id_dominio BIGINT NOT NULL,
	-- unique constraints
...
(
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_utenze_domini,
	id_utenza BIGINT NOT NULL,
	id_dominio BIGINT,
	id_uo BIGINT,
	-- fk/pk keys constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_operatori,
	id_utenza BIGINT NOT NULL,
	-- unique constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_connettori,
	-- unique constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_acl,
	id_utenza BIGINT,
	-- fk/pk keys constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_tracciati,
	id_operatore BIGINT,
	-- fk/pk keys constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_tipi_versamento,
	-- unique constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_tipi_vers_domini,
...
(
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_utenze_tipo_vers,
	id_utenza BIGINT NOT NULL,
	id_tipo_versamento BIGINT NOT NULL,
	-- fk/pk keys constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_documenti,
	id_dominio BIGINT NOT NULL,
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_singoli_versamenti,
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_pagamenti_portale,
...
(
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_pag_port_versamenti,
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_trac_notif_pag,
	id_dominio BIGINT NOT NULL,
	-- fk/pk keys constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_rpt,
	id_versamento BIGINT NOT NULL,
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_notifiche,
	id_applicazione BIGINT NOT NULL,
	id_rpt BIGINT,
	-- fk/pk keys constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_notifiche_app_io,
	id_versamento BIGINT NOT NULL,
	id_tipo_versamento_dominio BIGINT NOT NULL,
	id_rpt BIGINT,
	-- fk/pk keys constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_promemoria,
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_incassi,
	id_applicazione BIGINT,
	id_operatore BIGINT,
	-- unique constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_fr,
	id_incasso BIGINT,
	id_dominio BIGINT NOT NULL,
	-- unique constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_pagamenti,
	id_rpt BIGINT,
...
(
	...
	stato VARCHAR(35) NOT NULL,
	anomalie LONGVARCHAR,
	esegui_recupero_rt BOOLEAN NOT NULL,
	notifica_inviata BOOLEAN NOT NULL,
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_rendicontazioni,
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_eventi,
	id_fr BIGINT,
	id_incasso BIGINT,
	id_tracciato BIGINT,
	-- fk/pk keys constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_batch,
	-- unique constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_stampe,
	id_versamento BIGINT,
	id_documento BIGINT,
	-- unique constraints
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_operazioni,
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_gp_audit,
...
(
	...
	-- fk/pk columns
	-- id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1),
	id BIGINT GENERATED BY DEFAULT AS SEQUENCE seq_allegati,
	id_versamento BIGINT NOT NULL,
	-- fk/pk keys constraints
