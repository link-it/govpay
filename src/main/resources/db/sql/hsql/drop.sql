...
-- DROP INDEX index_jppa_config_1;
...
-- DROP INDEX idx_rnd_data;
-- DROP INDEX idx_rnd_fk_pagamenti;
-- DROP INDEX idx_rnd_fk_singoli_versamenti;
...
-- DROP INDEX idx_vrs_sped_aca;
-- DROP INDEX idx_vrs_iuv_dominio;
...
DROP TABLE jppa_config_init_seq;
