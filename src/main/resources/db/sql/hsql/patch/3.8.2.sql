...
ALTER TABLE fr ALTER COLUMN xml VARBINARY(16777215) NULL;
...
UPDATE fr SET id_dominio = (SELECT id FROM domini WHERE domini.cod_dominio = fr.cod_dominio);
...
ALTER TABLE fr ALTER COLUMN ragione_sociale_psp VARCHAR(255);
ALTER TABLE fr ALTER COLUMN ragione_sociale_dominio VARCHAR(255);
