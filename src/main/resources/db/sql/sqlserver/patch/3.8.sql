...
ALTER TABLE singoli_versamenti ADD metadata VARCHAR(max);
...
ALTER TABLE rpt ALTER COLUMN xml_rpt VARBINARY(MAX) NULL;
...
AND stato_pagamento != 'INCASSATO' 
AND stato_versamento = 'ESEGUITO';
