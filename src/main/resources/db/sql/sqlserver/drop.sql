...
-- DROP INDEX idx_evt_fk_trac ON eventi ;
-- DROP INDEX idx_evt_fk_inc ON eventi ;
-- DROP INDEX idx_evt_fk_fr ON eventi ;
...
-- DROP INDEX idx_rnd_fk_fr ON rendicontazioni ;
...
-- DROP INDEX idx_prt_data_richiesta ON pagamenti_portale ;
...
-- DROP INDEX idx_vrs_sped_aca ON versamenti ;
-- DROP INDEX idx_vrs_iuv_dominio ON versamenti ;
