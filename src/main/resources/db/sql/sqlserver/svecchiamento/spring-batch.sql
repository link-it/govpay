-- =============================================================================
-- Svecchiamento METADATI SPRING BATCH - SQL Server
--
...
--
-- Uso: sqlcmd -b -S <host> -U <utente> -d <database> -i spring-batch.sql
--
-- Il valore qui sotto e' il default. svecchiamento-db.sh lo sostituisce quando
-- gli si passa --retention-batch.
-- =============================================================================

DECLARE @retention_batch INT = 90;

DECLARE @end_batch DATETIME2 = DATEADD(DAY, -@retention_batch, GETDATE());

PRINT '--- Svecchiamento METADATI SPRING BATCH ---';
PRINT 'Retention: ' + CAST(@retention_batch AS VARCHAR) + ' giorni';

BEGIN TRANSACTION;

PRINT '1/6 contesti degli step...';
...
PRINT '3/6 contesti delle esecuzioni...';
...
PRINT '4/6 parametri delle esecuzioni...';
...
PRINT '5/6 esecuzioni...';
DELETE FROM BATCH_JOB_EXECUTION
WHERE COALESCE(END_TIME, START_TIME, CREATE_TIME) < @end_batch;

PRINT '6/6 istanze rimaste senza alcuna esecuzione...';
