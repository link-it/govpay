...
ALTER TABLE versamenti ADD data_ultima_modifica_aca TIMESTAMP;
ALTER TABLE versamenti ADD data_ultima_comunicazione_aca TIMESTAMP;

UPDATE versamenti SET data_ultima_modifica_aca = TO_TIMESTAMP('1900-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS') WHERE data_ultima_modifica_aca IS NULL;
...
ALTER TABLE singoli_versamenti ADD metadata CLOB;
...
ALTER TABLE intermediari ADD cod_connettore_recupero_rt VARCHAR2(35 CHAR);


-- 04/11/2024 Eliminata tabella RR
...
DELETE FROM sonde WHERE nome = 'update-pnd';

INSERT INTO sonde(nome, classe, soglia_warn, soglia_error) VALUES ('recupero-rt', 'org.openspcoop2.utils.sonde.impl.SondaBatch', 86400000, 172800000);
INSERT INTO sonde(nome, classe, soglia_warn, soglia_error) VALUES ('check-recupero-rt', 'org.openspcoop2.utils.sonde.impl.SondaCoda', 10, 100);
