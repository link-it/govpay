...
sudo systemctl stop wildfly@govpay wildfly-26.1.3.Final@standalone tomcat_govpay wildfly-26.1.3.Final@ndpsym wildfly-28.0.1.Final@ndpsym tomcat_govpay_jdk25
