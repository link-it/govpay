...
public class QuietanzaPagamentoProperties {
	...
	public static synchronized QuietanzaPagamentoProperties newInstance(String govpayResourceDir) throws Exception {
		if(instance == null)
	...
	public QuietanzaPagamentoProperties(String govpayResourceDir) {
		try {
