...
public class ProspettoRiscossioniProperties {
	...
	public static synchronized ProspettoRiscossioniProperties newInstance(String govpayResourceDir) throws Exception {
		if(instance == null)
	...
	public ProspettoRiscossioniProperties(String govpayResourceDir) {
		try {
