...
public class JaxbUtils {
	...
	private static JAXBContext jaxbBolloContext, jaxbRptRtContext, jaxbRrErContext, jaxbFrContext, jaxbWsRptContext, jaxbPaForNodeContext, jaxbPaContext, jaxbWsJPPAPdPInternalContext, jaxbWsJPPAPdPExternalContext;
	...
	public static void init() throws JAXBException, SAXException {
		if(!initialized) {
			...
			PAForNode_Schema = schemaFactory.newSchema(sources); 
