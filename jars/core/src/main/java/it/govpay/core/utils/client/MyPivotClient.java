...
public class MyPivotClient extends BasicClient {
	...
	private static Logger log = LoggerWrapperFactory.getLogger(MyPivotClient.class);
	private String faultCode;
	
	public MyPivotClient(Dominio dominio, ConnettoreNotificaPagamenti connettore, String operationID, Giornale giornale) throws ClientException, ServiceException {
		super(dominio, TipoConnettore.MYPIVOT, connettore); 
