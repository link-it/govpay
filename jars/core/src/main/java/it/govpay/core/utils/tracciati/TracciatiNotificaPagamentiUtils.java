...
//		return TracciatiNotificaPagamenti.FLUSSI_RENDICONTAZIONE_DIR_PREFIX+idFlusso+".xml";
	...
	@SuppressWarnings("unchecked")
	public static String [] creaLineaCsvMyPivotRpt_SANP321_V2(Rpt rpt, BDConfigWrapper configWrapper) throws ServiceException, JAXBException, SAXException, ValidationException { 
		List<String> linea = new ArrayList<String>();
...
//		FILLER	1602	2000	399	
	...
	@SuppressWarnings("unchecked")
	public static void creaLineaCsvSecimRpt_SANP321_V2(Logger log, Rpt rpt, BDConfigWrapper configWrapper, int numeroLinea, ConnettoreNotificaPagamenti connettore, OutputStream secimOS, OutputStream noSecimOS) throws ServiceException, JAXBException, SAXException, ValidationException, java.io.IOException { 
		StringBuilder sb = new StringBuilder();
...
//			identificativoAttestante: da RT
	...
	public static List<List<String>> creaLineaCsvGovPayRpt_SANP321_V2(Rpt rpt, BDConfigWrapper configWrapper) throws ServiceException, JAXBException, SAXException, ValidationException { 
		...
		for(int indiceDati = 0; indiceDati < ctReceipt.getTransferList().getTransfer().size(); indiceDati ++) {
			CtTransferPAReceiptV2 ctTransferPA = ctReceipt.getTransferList().getTransfer().get(indiceDati);
