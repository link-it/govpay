...
//		return TracciatiNotificaPagamenti.FLUSSI_RENDICONTAZIONE_DIR_PREFIX+idFlusso+".xml";
	...
	public static String completaValoreCampoConFiller(String valoreCampo, int dimensioneTotaleCampo, boolean numerico, boolean left) {
		String filler = " ";
		if(numerico) {
			filler = "0";
		} 
	...
	public static void creaLineaCsvSecim(Rpt rpt, BDConfigWrapper configWrapper, int numeroLinea, ConnettoreNotificaPagamenti connettore, OutputStream secimOS, OutputStream noSecimOS) throws ServiceException, JAXBException, SAXException, ValidationException, java.io.IOException {
	...
	@SuppressWarnings("unchecked")
	public static void creaLineaCsvSecimRpt_SANP23(Rpt rpt, BDConfigWrapper configWrapper, int numeroLinea, ConnettoreNotificaPagamenti connettore, OutputStream secimOS, OutputStream noSecimOS) throws ServiceException, JAXBException, SAXException, ValidationException, java.io.IOException { 
		StringBuilder sb = new StringBuilder();
...
//		FILLER	13	22	10	
		String filler = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller("", 10, false, true);
...
//		TIPO FLUSSO	23	30	8	Carattere			SI	Dato di configurazione assegnato da Poste alla PA datiallegati.tipoflusso
		...
		tipoflusso = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(tipoflusso, 8, false, false);
...
//		FILLER	39	77	39	
		filler = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller("", 39, false, true);
...
//		PROGRESSIVO RECORD	78	90	13	Numerico	13	0		Numero di record incrementale
		...
		progressivoRecord = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(progressivoRecord, 13, true, true);
...
//		FILLER	94	163	70	Carattere	
		filler = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller("", 70, false, true);
...
//		CODICE PRESENTAZIONE	170	187	18	Carattere				versamento.numero_avviso
		...
		codicePresentazione = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(codicePresentazione, 18, false, false);
...
//		FILLER	188	204	17	Carattere	
		filler = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller("", 17, false, true);
...
//		IUV	205	239	35	Carattere				versamento.iuv
		...
		iuvVersamento = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(iuvVersamento, 35, false, false);
...
//		RATA	240	274	35	Carattere				versamento.cod_rata
		...
		String rata = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(numeroRata+"", 8, true, true); // Aggiungo zeri a sx fino ad arrivare a 8 caratteri
		rata = prefixRata + rata; // aggiungo prefisso
		rata = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(rata, 35, false, false); // completo con spazi bianchi a dx fino a 35 caratteri
...
//		RIFERIMENTO CREDITORE	345	379	35	Carattere		SECIM +	$pendenza.{datiAllegati}.secim.riferimentoCreditore o, in sua assenza, il campo $pendenza.voce[0].idVoce
		...
		riferimentoCreditore = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(riferimentoCreditore, 35, false, false);
		TracciatiNotificaPagamentiUtils.validaCampo("RIFERIMENTO CREDITORE", riferimentoCreditore, 35);
		sb.append(riferimentoCreditore);
		
//		FILLER	380	457	78	
		filler = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller("", 78, false, true);
...
//		IMPORTO VERSAMENTO	458	472	15	Numerico	13	2	SI	singolo_versamento.importo_singolo_versamento o versamento.importo_totale
		...
		importoTotalePagato = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(importoTotalePagato, 15, true, true);
		TracciatiNotificaPagamentiUtils.validaCampo("IMPORTO VERSAMENTO", importoTotalePagato, 15);
		sb.append(importoTotalePagato);
		
//		FILLER	473	517	45	
		filler = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller("", 45, false, true);
...
//		CAUSALE VERSAMENTO	518	657	140	Carattere			SI	singolo_versamento.descrizione_causale_RPT o versamento.causale
		...
		causaleVersamento = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(causaleVersamento, 140, false, false);
		TracciatiNotificaPagamentiUtils.validaCampo("CAUSALE VERSAMENTO", causaleVersamento, 140);
		sb.append(causaleVersamento);
		
//		FILLER	658	713	56	
		filler = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller("", 56, false, true);
...
//		TIPO DEBITORE	714	716	3	Carattere				versamento.debitore_tipo
		...
		tipoDebitore = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(tipoDebitore, 3, false, false);
...
//		CODICE DEBITORE	719	753	35	Carattere			SI	versamento.debitore_identificativo
		...
		codiceDebitore = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(codiceDebitore, 35, false, false);
...
//		ANAGRAFICA DEBITORE	754	803	50	Carattere			SI	versamento.debitore_anagrafica
		...
		anagraficaDebitore = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(anagraficaDebitore, 50, false, false);
		TracciatiNotificaPagamentiUtils.validaCampo("ANAGRAFICA DEBITORE", anagraficaDebitore, 50);
		sb.append(anagraficaDebitore);
		
//		FILLER	804	838	35	
		filler = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller("", 35, false, true);
...
//		INDIRIZZO DEBITORE	839	888	50	Carattere				versamento.debitore_indirizzo
		...
		indirizzoDebitore = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(indirizzoDebitore, 50, false, false);
...
//		NUMERO CIVICO DEBITORE	889	893	5	Carattere				versamento.debitore_civico
		...
		numeroCivicoDebitore = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(numeroCivicoDebitore, 5, false, false);
...
//		CAP DEBITORE	894	898	5	Carattere				versamento.debitore_cap
		...
		capDebitore = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(capDebitore, 5, false, false);
...
//		LOCALITA DEBITORE	899	948	50	Carattere				versamento.debitore_localita
		...
		localitaDebitore = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(localitaDebitore, 50, false, false);
...
//		PROVINCIA DEBITORE	949	950	2	Carattere				versamento.debitore_provincia
		...
		provinciaDebitore = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(provinciaDebitore, 2, false, false);
...
//		STATO DEBITORE	951	985	35	Carattere				versamento.debitore_nazione
		...
		nazioneDebitore = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(nazioneDebitore, 35, false, false);
...
//		DATA INCASSO	1064	1071	8	Numerico	8	0		fr.data_ora_flusso se disponibile
		...
		dataIncasso = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(dataIncasso, 8, true, true);
...
//		ESERCIZIO DI RIFERIMENTO	1072	1075	4	Numerico	4	0		??? nel file di esempio vale sempre 0000
		...
		esercizioRiferimento = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(esercizioRiferimento, 4, true, true);
...
//		NUMERO PROVVISORIO	1076	1082	7	Numerico	7	0		??? nel file di esempio vale sempre 0000000
		...
		numeroProvvisorio = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(numeroProvvisorio, 7, true, true);
...
//		CODICE RETE INCASSO	1083	1085	3	Carattere				NDP nei casi normali, PST se non si ha la RT ma il pagamento e’ stato solamente rendicontato da un flusso con codice esito = 9
		...
		codiceReteIncasso = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(codiceReteIncasso, 3, false, true);
...
//		CODICE CANALE INCASSO	1086	1088	3	Carattere				Dal PSP che ha e’ stato utilizzato
		...
		codiceCanaleIncasso = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(codiceCanaleIncasso, 3, false, true);
...
//		CODICE STRUMENTO INCASSO	1089	1091	3	Carattere				NDP se il campo precedente e’ di tipo PSP, altrimenti bisogna chiedere il codice bollettino
		...
		codiceStrumentoIncasso = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(codiceStrumentoIncasso, 3, false, true);
...
//		NUMERO BOLLETTA	1092	1104	13	Numerico	13	0		fr.trn se disponibile
		...
		numeroBolletta = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(numeroBolletta, 13, true, true);
...
//		IMPORTO PAGATO	1105	1119	15	Numerico	13	2		versamento.importo_pagato o rendicontazione.importo_pagato
		...
		importoPagato = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(importoPagato, 15, true, true);
		TracciatiNotificaPagamentiUtils.validaCampo("IMPORTO PAGATO", importoPagato, 15);
		sb.append(importoPagato);
		
//		FILLER	1120	1172	53		
		filler = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller("", 53, false, true);
...
//		IMPORTO COMMISSIONE PA	1173	1187	15	Numerico	13	2		0
		...
		importoCommissionePA = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(importoCommissionePA, 15, true, true);
...
//		IMPORTO COMMISSIONE DEBITORE	1188	1202	15	Numerico	13	2		Da RT? rt.datiPagamento.datiSingoloPagamento[i].commissioniApplicatePSP
		...
		importoCommissioniDebitore = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(importoCommissioniDebitore, 15, true, true);
...
//		FILLER	1203	1589	387	
		filler = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller("", 387, false, true);
		TracciatiNotificaPagamentiUtils.validaCampo("FILLER 12", filler, 387);
		sb.append(filler);
		
//		CCP	1590	1601	12	Numerico				numero conto corrente postale?
		String ccp = "";
		ccp = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller(ccp, 12, true, true);
		TracciatiNotificaPagamentiUtils.validaCampo("CCP", ccp, 12);
		sb.append(ccp);
		
//		FILLER	1602	2000	399	
		filler = TracciatiNotificaPagamentiUtils.completaValoreCampoConFiller("", 399, false, true);
	...
	@SuppressWarnings("unchecked")
	public static void creaLineaCsvSecimRpt_SANP24(Rpt rpt, BDConfigWrapper configWrapper, int numeroLinea, ConnettoreNotificaPagamenti connettore, OutputStream secimOS, OutputStream noSecimOS) throws ServiceException, JAXBException, SAXException, ValidationException, java.io.IOException { 
		StringBuilder sb = new StringBuilder();
