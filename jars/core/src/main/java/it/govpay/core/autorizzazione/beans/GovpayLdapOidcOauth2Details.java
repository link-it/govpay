...
/***
 * Questa classe estende la {@link DefaultOidcUser} per includere le formazioni sull'utenza GovPay
 * 
 * @author pintori@link.it
 *
 */
public class GovpayLdapOidcOauth2Details extends DefaultOidcUser implements LdapUserDetails {
	 ...
	 */
	public GovpayLdapOidcOauth2Details(Collection<? extends GrantedAuthority> authorities, OidcIdToken idToken) {
	 ...
	 * {@link #getAttributes()}
	 */
	public GovpayLdapOidcOauth2Details(Collection<? extends GrantedAuthority> authorities, OidcIdToken idToken,	String nameAttributeKey) {
	 ...
	 * may be {@code null}
	 */
	public GovpayLdapOidcOauth2Details(Collection<? extends GrantedAuthority> authorities, OidcIdToken idToken, OidcUserInfo userInfo) {
	 ...
	 * {@link #getAttributes()}
	 */
	public GovpayLdapOidcOauth2Details(Collection<? extends GrantedAuthority> authorities, OidcIdToken idToken, OidcUserInfo userInfo, String nameAttributeKey) {
