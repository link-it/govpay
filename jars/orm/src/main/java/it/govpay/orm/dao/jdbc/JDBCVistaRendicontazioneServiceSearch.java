...
public class JDBCVistaRendicontazioneServiceSearch implements IDBVistaRendicontazioneServiceSearch, IDBServiceUtilities<VistaRendicontazione> {
	...
	public JDBCVistaRendicontazioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCVistaRendicontazioneServiceSearch.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+VistaRendicontazione.class.getName()+") 'obj' is null");
	}
	protected ServiceException newServiceExceptionParameterIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdRendicontazione.class.getName()+") 'id' is null");
	}
	...
	private ServiceException newServiceExceptionParameterWithTypeTableIdLessEqualsZero(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdRendicontazione.class.getName()+") 'tableId' is lessEquals 0");
	}
