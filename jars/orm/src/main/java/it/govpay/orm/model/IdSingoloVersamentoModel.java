...
public class IdSingoloVersamentoModel extends AbstractModel<IdSingoloVersamento> {
	...
	public IdSingoloVersamentoModel(){
		...
		this.INDICE_DATI = new Field("indiceDati",java.math.BigInteger.class,"id-singolo-versamento",IdSingoloVersamento.class);
	...
	public IdSingoloVersamentoModel(IField father){
		...
		this.INDICE_DATI = new ComplexField(father,"indiceDati",java.math.BigInteger.class,"id-singolo-versamento",IdSingoloVersamento.class);
