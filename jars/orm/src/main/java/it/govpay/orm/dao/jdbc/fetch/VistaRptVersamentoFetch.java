		...
		try{
			...
			if(model.equals(VistaRptVersamento.model())){
				...
				setParameter(object, "setCodCarrello", VistaRptVersamento.model().COD_CARRELLO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_carrello", VistaRptVersamento.model().COD_CARRELLO.getFieldType()));
				setParameter(object, "setIuv", VistaRptVersamento.model().IUV.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "iuv", VistaRptVersamento.model().IUV.getFieldType()));
				setParameter(object, "setCcp", VistaRptVersamento.model().CCP.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "ccp", VistaRptVersamento.model().CCP.getFieldType()));
				setParameter(object, "setCodDominio", VistaRptVersamento.model().COD_DOMINIO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_dominio", VistaRptVersamento.model().COD_DOMINIO.getFieldType()));
				setParameter(object, "setCodMsgRichiesta", VistaRptVersamento.model().COD_MSG_RICHIESTA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_msg_richiesta", VistaRptVersamento.model().COD_MSG_RICHIESTA.getFieldType()));
				setParameter(object, "setDataMsgRichiesta", VistaRptVersamento.model().DATA_MSG_RICHIESTA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_msg_richiesta", VistaRptVersamento.model().DATA_MSG_RICHIESTA.getFieldType()));
				setParameter(object, "setStato", VistaRptVersamento.model().STATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "stato", VistaRptVersamento.model().STATO.getFieldType()));
				setParameter(object, "setDescrizioneStato", VistaRptVersamento.model().DESCRIZIONE_STATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "descrizione_stato", VistaRptVersamento.model().DESCRIZIONE_STATO.getFieldType()));
				setParameter(object, "setCodSessione", VistaRptVersamento.model().COD_SESSIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_sessione", VistaRptVersamento.model().COD_SESSIONE.getFieldType()));
				setParameter(object, "setCodSessionePortale", VistaRptVersamento.model().COD_SESSIONE_PORTALE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_sessione_portale", VistaRptVersamento.model().COD_SESSIONE_PORTALE.getFieldType()));
				setParameter(object, "setPspRedirectURL", VistaRptVersamento.model().PSP_REDIRECT_URL.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "psp_redirect_url", VistaRptVersamento.model().PSP_REDIRECT_URL.getFieldType()));
				setParameter(object, "setXmlRPT", VistaRptVersamento.model().XML_RPT.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "xml_rpt", VistaRptVersamento.model().XML_RPT.getFieldType()));
				setParameter(object, "setDataAggiornamentoStato", VistaRptVersamento.model().DATA_AGGIORNAMENTO_STATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_aggiornamento_stato", VistaRptVersamento.model().DATA_AGGIORNAMENTO_STATO.getFieldType()));
				setParameter(object, "setCallbackURL", VistaRptVersamento.model().CALLBACK_URL.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "callback_url", VistaRptVersamento.model().CALLBACK_URL.getFieldType()));
				setParameter(object, "setModelloPagamento", VistaRptVersamento.model().MODELLO_PAGAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "modello_pagamento", VistaRptVersamento.model().MODELLO_PAGAMENTO.getFieldType()));
				setParameter(object, "setCodMsgRicevuta", VistaRptVersamento.model().COD_MSG_RICEVUTA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_msg_ricevuta", VistaRptVersamento.model().COD_MSG_RICEVUTA.getFieldType()));
				setParameter(object, "setDataMsgRicevuta", VistaRptVersamento.model().DATA_MSG_RICEVUTA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_msg_ricevuta", VistaRptVersamento.model().DATA_MSG_RICEVUTA.getFieldType()));
				setParameter(object, "setCodEsitoPagamento", VistaRptVersamento.model().COD_ESITO_PAGAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_esito_pagamento", VistaRptVersamento.model().COD_ESITO_PAGAMENTO.getFieldType()));
				setParameter(object, "setImportoTotalePagato", VistaRptVersamento.model().IMPORTO_TOTALE_PAGATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "importo_totale_pagato", VistaRptVersamento.model().IMPORTO_TOTALE_PAGATO.getFieldType()));
				setParameter(object, "setXmlRT", VistaRptVersamento.model().XML_RT.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "xml_rt", VistaRptVersamento.model().XML_RT.getFieldType()));
				setParameter(object, "setCodCanale", VistaRptVersamento.model().COD_CANALE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_canale", VistaRptVersamento.model().COD_CANALE.getFieldType()));
				setParameter(object, "setCodPsp", VistaRptVersamento.model().COD_PSP.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_psp", VistaRptVersamento.model().COD_PSP.getFieldType()));
				setParameter(object, "setCodIntermediarioPsp", VistaRptVersamento.model().COD_INTERMEDIARIO_PSP.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_intermediario_psp", VistaRptVersamento.model().COD_INTERMEDIARIO_PSP.getFieldType()));
				setParameter(object, "setTipoVersamento", VistaRptVersamento.model().TIPO_VERSAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "tipo_versamento", VistaRptVersamento.model().TIPO_VERSAMENTO.getFieldType()));
				setParameter(object, "setTipoIdentificativoAttestante", VistaRptVersamento.model().TIPO_IDENTIFICATIVO_ATTESTANTE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "tipo_identificativo_attestante", VistaRptVersamento.model().TIPO_IDENTIFICATIVO_ATTESTANTE.getFieldType()));
				setParameter(object, "setIdentificativoAttestante", VistaRptVersamento.model().IDENTIFICATIVO_ATTESTANTE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "identificativo_attestante", VistaRptVersamento.model().IDENTIFICATIVO_ATTESTANTE.getFieldType()));
				setParameter(object, "setDenominazioneAttestante", VistaRptVersamento.model().DENOMINAZIONE_ATTESTANTE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "denominazione_attestante", VistaRptVersamento.model().DENOMINAZIONE_ATTESTANTE.getFieldType()));
				setParameter(object, "setCodStazione", VistaRptVersamento.model().COD_STAZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_stazione", VistaRptVersamento.model().COD_STAZIONE.getFieldType()));
				setParameter(object, "setCodTransazioneRPT", VistaRptVersamento.model().COD_TRANSAZIONE_RPT.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_transazione_rpt", VistaRptVersamento.model().COD_TRANSAZIONE_RPT.getFieldType()));
				setParameter(object, "setCodTransazioneRT", VistaRptVersamento.model().COD_TRANSAZIONE_RT.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_transazione_rt", VistaRptVersamento.model().COD_TRANSAZIONE_RT.getFieldType()));
				setParameter(object, "setStatoConservazione", VistaRptVersamento.model().STATO_CONSERVAZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "stato_conservazione", VistaRptVersamento.model().STATO_CONSERVAZIONE.getFieldType()));
				setParameter(object, "setDescrizioneStatoCons", VistaRptVersamento.model().DESCRIZIONE_STATO_CONS.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "descrizione_stato_cons", VistaRptVersamento.model().DESCRIZIONE_STATO_CONS.getFieldType()));
				setParameter(object, "setDataConservazione", VistaRptVersamento.model().DATA_CONSERVAZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_conservazione", VistaRptVersamento.model().DATA_CONSERVAZIONE.getFieldType()));
				setParameter(object, "setBloccante", VistaRptVersamento.model().BLOCCANTE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "bloccante", VistaRptVersamento.model().BLOCCANTE.getFieldType()));
				setParameter(object, "setVersione", VistaRptVersamento.model().VERSIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "versione", VistaRptVersamento.model().VERSIONE.getFieldType()));
				setParameter(object, "setVrsId", VistaRptVersamento.model().VRS_ID.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_id", VistaRptVersamento.model().VRS_ID.getFieldType()));
				setParameter(object, "setVrsCodVersamentoEnte", VistaRptVersamento.model().VRS_COD_VERSAMENTO_ENTE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_cod_versamento_ente", VistaRptVersamento.model().VRS_COD_VERSAMENTO_ENTE.getFieldType()));
				setParameter(object, "setVrsNome", VistaRptVersamento.model().VRS_NOME.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_nome", VistaRptVersamento.model().VRS_NOME.getFieldType()));
				setParameter(object, "setVrsImportoTotale", VistaRptVersamento.model().VRS_IMPORTO_TOTALE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_importo_totale", VistaRptVersamento.model().VRS_IMPORTO_TOTALE.getFieldType()));
				setParameter(object, "setVrsStatoVersamento", VistaRptVersamento.model().VRS_STATO_VERSAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_stato_versamento", VistaRptVersamento.model().VRS_STATO_VERSAMENTO.getFieldType()));
				setParameter(object, "setVrsDescrizioneStato", VistaRptVersamento.model().VRS_DESCRIZIONE_STATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_descrizione_stato", VistaRptVersamento.model().VRS_DESCRIZIONE_STATO.getFieldType()));
				setParameter(object, "setVrsAggiornabile", VistaRptVersamento.model().VRS_AGGIORNABILE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_aggiornabile", VistaRptVersamento.model().VRS_AGGIORNABILE.getFieldType()));
				setParameter(object, "setVrsDataCreazione", VistaRptVersamento.model().VRS_DATA_CREAZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_data_creazione", VistaRptVersamento.model().VRS_DATA_CREAZIONE.getFieldType()));
				setParameter(object, "setVrsDataValidita", VistaRptVersamento.model().VRS_DATA_VALIDITA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_data_validita", VistaRptVersamento.model().VRS_DATA_VALIDITA.getFieldType()));
				setParameter(object, "setVrsDataScadenza", VistaRptVersamento.model().VRS_DATA_SCADENZA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_data_scadenza", VistaRptVersamento.model().VRS_DATA_SCADENZA.getFieldType()));
				setParameter(object, "setVrsDataOraUltimoAgg", VistaRptVersamento.model().VRS_DATA_ORA_ULTIMO_AGG.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_data_ora_ultimo_agg", VistaRptVersamento.model().VRS_DATA_ORA_ULTIMO_AGG.getFieldType()));
				setParameter(object, "setVrsCausaleVersamento", VistaRptVersamento.model().VRS_CAUSALE_VERSAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_causale_versamento", VistaRptVersamento.model().VRS_CAUSALE_VERSAMENTO.getFieldType()));
				setParameter(object, "setVrsDebitoreTipo", VistaRptVersamento.model().VRS_DEBITORE_TIPO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_tipo", VistaRptVersamento.model().VRS_DEBITORE_TIPO.getFieldType()));
				setParameter(object, "setVrsDebitoreIdentificativo", VistaRptVersamento.model().VRS_DEBITORE_IDENTIFICATIVO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_identificativo", VistaRptVersamento.model().VRS_DEBITORE_IDENTIFICATIVO.getFieldType()));
				setParameter(object, "setVrsDebitoreAnagrafica", VistaRptVersamento.model().VRS_DEBITORE_ANAGRAFICA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_anagrafica", VistaRptVersamento.model().VRS_DEBITORE_ANAGRAFICA.getFieldType()));
				setParameter(object, "setVrsDebitoreIndirizzo", VistaRptVersamento.model().VRS_DEBITORE_INDIRIZZO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_indirizzo", VistaRptVersamento.model().VRS_DEBITORE_INDIRIZZO.getFieldType()));
				setParameter(object, "setVrsDebitoreCivico", VistaRptVersamento.model().VRS_DEBITORE_CIVICO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_civico", VistaRptVersamento.model().VRS_DEBITORE_CIVICO.getFieldType()));
				setParameter(object, "setVrsDebitoreCap", VistaRptVersamento.model().VRS_DEBITORE_CAP.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_cap", VistaRptVersamento.model().VRS_DEBITORE_CAP.getFieldType()));
				setParameter(object, "setVrsDebitoreLocalita", VistaRptVersamento.model().VRS_DEBITORE_LOCALITA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_localita", VistaRptVersamento.model().VRS_DEBITORE_LOCALITA.getFieldType()));
				setParameter(object, "setVrsDebitoreProvincia", VistaRptVersamento.model().VRS_DEBITORE_PROVINCIA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_provincia", VistaRptVersamento.model().VRS_DEBITORE_PROVINCIA.getFieldType()));
				setParameter(object, "setVrsDebitoreNazione", VistaRptVersamento.model().VRS_DEBITORE_NAZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_nazione", VistaRptVersamento.model().VRS_DEBITORE_NAZIONE.getFieldType()));
				setParameter(object, "setVrsDebitoreEmail", VistaRptVersamento.model().VRS_DEBITORE_EMAIL.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_email", VistaRptVersamento.model().VRS_DEBITORE_EMAIL.getFieldType()));
				setParameter(object, "setVrsDebitoreTelefono", VistaRptVersamento.model().VRS_DEBITORE_TELEFONO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_telefono", VistaRptVersamento.model().VRS_DEBITORE_TELEFONO.getFieldType()));
				setParameter(object, "setVrsDebitoreCellulare", VistaRptVersamento.model().VRS_DEBITORE_CELLULARE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_cellulare", VistaRptVersamento.model().VRS_DEBITORE_CELLULARE.getFieldType()));
				setParameter(object, "setVrsDebitoreFax", VistaRptVersamento.model().VRS_DEBITORE_FAX.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_debitore_fax", VistaRptVersamento.model().VRS_DEBITORE_FAX.getFieldType()));
				setParameter(object, "setVrsTassonomiaAvviso", VistaRptVersamento.model().VRS_TASSONOMIA_AVVISO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_tassonomia_avviso", VistaRptVersamento.model().VRS_TASSONOMIA_AVVISO.getFieldType()));
				setParameter(object, "setVrsTassonomia", VistaRptVersamento.model().VRS_TASSONOMIA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_tassonomia", VistaRptVersamento.model().VRS_TASSONOMIA.getFieldType()));
				setParameter(object, "setVrsCodLotto", VistaRptVersamento.model().VRS_COD_LOTTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_cod_lotto", VistaRptVersamento.model().VRS_COD_LOTTO.getFieldType()));
				setParameter(object, "setVrsCodVersamentoLotto", VistaRptVersamento.model().VRS_COD_VERSAMENTO_LOTTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_cod_versamento_lotto", VistaRptVersamento.model().VRS_COD_VERSAMENTO_LOTTO.getFieldType()));
				setParameter(object, "setVrsCodAnnoTributario", VistaRptVersamento.model().VRS_COD_ANNO_TRIBUTARIO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_cod_anno_tributario", VistaRptVersamento.model().VRS_COD_ANNO_TRIBUTARIO.getFieldType()));
				setParameter(object, "setVrsCodBundlekey", VistaRptVersamento.model().VRS_COD_BUNDLEKEY.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_cod_bundlekey", VistaRptVersamento.model().VRS_COD_BUNDLEKEY.getFieldType()));
				setParameter(object, "setVrsDatiAllegati", VistaRptVersamento.model().VRS_DATI_ALLEGATI.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_dati_allegati", VistaRptVersamento.model().VRS_DATI_ALLEGATI.getFieldType()));
				setParameter(object, "setVrsIncasso", VistaRptVersamento.model().VRS_INCASSO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_incasso", VistaRptVersamento.model().VRS_INCASSO.getFieldType()));
				setParameter(object, "setVrsAnomalie", VistaRptVersamento.model().VRS_ANOMALIE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_anomalie", VistaRptVersamento.model().VRS_ANOMALIE.getFieldType()));
				setParameter(object, "setVrsIuvVersamento", VistaRptVersamento.model().VRS_IUV_VERSAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_iuv_versamento", VistaRptVersamento.model().VRS_IUV_VERSAMENTO.getFieldType()));
				setParameter(object, "setVrsNumeroAvviso", VistaRptVersamento.model().VRS_NUMERO_AVVISO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_numero_avviso", VistaRptVersamento.model().VRS_NUMERO_AVVISO.getFieldType()));
				setParameter(object, "setVrsAck", VistaRptVersamento.model().VRS_ACK.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_ack", VistaRptVersamento.model().VRS_ACK.getFieldType()));
				setParameter(object, "setVrsAnomalo", VistaRptVersamento.model().VRS_ANOMALO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_anomalo", VistaRptVersamento.model().VRS_ANOMALO.getFieldType()));
				setParameter(object, "setVrsDivisione", VistaRptVersamento.model().VRS_DIVISIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_divisione", VistaRptVersamento.model().VRS_DIVISIONE.getFieldType()));
				setParameter(object, "setVrsDirezione", VistaRptVersamento.model().VRS_DIREZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_direzione", VistaRptVersamento.model().VRS_DIREZIONE.getFieldType()));
				setParameter(object, "setVrsIdSessione", VistaRptVersamento.model().VRS_ID_SESSIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_id_sessione", VistaRptVersamento.model().VRS_ID_SESSIONE.getFieldType()));
				setParameter(object, "setVrsDataPagamento", VistaRptVersamento.model().VRS_DATA_PAGAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_data_pagamento", VistaRptVersamento.model().VRS_DATA_PAGAMENTO.getFieldType()));
				setParameter(object, "setVrsImportoPagato", VistaRptVersamento.model().VRS_IMPORTO_PAGATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_importo_pagato", VistaRptVersamento.model().VRS_IMPORTO_PAGATO.getFieldType()));
				setParameter(object, "setVrsImportoIncassato", VistaRptVersamento.model().VRS_IMPORTO_INCASSATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_importo_incassato", VistaRptVersamento.model().VRS_IMPORTO_INCASSATO.getFieldType()));
				setParameter(object, "setVrsStatoPagamento", VistaRptVersamento.model().VRS_STATO_PAGAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_stato_pagamento", VistaRptVersamento.model().VRS_STATO_PAGAMENTO.getFieldType()));
				setParameter(object, "setVrsIuvPagamento", VistaRptVersamento.model().VRS_IUV_PAGAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_iuv_pagamento", VistaRptVersamento.model().VRS_IUV_PAGAMENTO.getFieldType()));
				setParameter(object, "setVrsSrcDebitoreIdentificativo", VistaRptVersamento.model().VRS_SRC_DEBITORE_IDENTIFICATIVO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_src_debitore_identificativ", VistaRptVersamento.model().VRS_SRC_DEBITORE_IDENTIFICATIVO.getFieldType()));
				setParameter(object, "setVrsCodRata", VistaRptVersamento.model().VRS_COD_RATA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_cod_rata", VistaRptVersamento.model().VRS_COD_RATA.getFieldType()));
				setParameter(object, "setVrsTipo", VistaRptVersamento.model().VRS_TIPO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_tipo", VistaRptVersamento.model().VRS_TIPO.getFieldType()));
				setParameter(object, "setVrsProprieta", VistaRptVersamento.model().VRS_PROPRIETA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "vrs_proprieta", VistaRptVersamento.model().VRS_PROPRIETA.getFieldType()));
				return object;
			}
