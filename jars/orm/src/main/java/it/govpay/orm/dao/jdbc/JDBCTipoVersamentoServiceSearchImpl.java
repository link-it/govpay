...
public class JDBCTipoVersamentoServiceSearchImpl implements IJDBCServiceSearchWithId<TipoVersamento, IdTipoVersamento, JDBCServiceManager> {
	...
	public List<TipoVersamento> findAll(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotImplementedException, ServiceException,Exception {
		...
		try{
			...
			fields.add(TipoVersamento.model().BO_FORM_DEFINIZIONE);
			fields.add(TipoVersamento.model().BO_VALIDAZIONE_DEF);
			fields.add(TipoVersamento.model().BO_TRASFORMAZIONE_TIPO);
			fields.add(TipoVersamento.model().BO_TRASFORMAZIONE_DEF);
			fields.add(TipoVersamento.model().BO_COD_APPLICAZIONE);
			...
			fields.add(TipoVersamento.model().PAG_COD_APPLICAZIONE);
			fields.add(TipoVersamento.model().PAG_ABILITATO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_AVV_ABILITATO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_AVV_PDF);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_AVV_TIPO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_AVV_OGGETTO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_AVV_MESSAGGIO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_RIC_ABILITATO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_RIC_PDF);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_RIC_TIPO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_RIC_OGGETTO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_RIC_MESSAGGIO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_RIC_ESEGUITI);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_SCAD_ABILITATO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_SCAD_PREAVVISO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_SCAD_TIPO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_SCAD_OGGETTO);
			fields.add(TipoVersamento.model().AVV_MAIL_PROM_SCAD_MESSAGGIO);
			...
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_AVV_ABILITATO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_AVV_TIPO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_AVV_OGGETTO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_AVV_MESSAGGIO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_RIC_ABILITATO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_RIC_TIPO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_RIC_OGGETTO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_RIC_MESSAGGIO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_RIC_ESEGUITI);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_SCAD_ABILITATO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_SCAD_PREAVVISO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_SCAD_TIPO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_SCAD_OGGETTO);
			fields.add(TipoVersamento.model().AVV_APP_IO_PROM_SCAD_MESSAGGIO);
	...
	public TipoVersamento find(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) 
		...
		TipoVersamentoModel model = TipoVersamento.model();
		...
		List<TipoVersamento> lst = this.findAll(jdbcProperties, log, connection, sqlQueryObject, pagExpr, idMappingResolutionBehaviour);
