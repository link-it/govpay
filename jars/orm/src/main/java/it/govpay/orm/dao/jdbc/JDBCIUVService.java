...
public class JDBCIUVService extends JDBCIUVServiceSearch  implements IDBIUVService {
	...
	public JDBCIUVService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCIUVService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IUV.class.getName()+") 'iuv' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdIuv.class.getName()+") 'oldId' is null");
	}
