...
public class JDBCIbanAccreditoService extends JDBCIbanAccreditoServiceSearch  implements IDBIbanAccreditoService {
	...
	public JDBCIbanAccreditoService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCIbanAccreditoService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IbanAccredito.class.getName()+") 'ibanAccredito' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdIbanAccredito.class.getName()+") 'oldId' is null");
	}
