 ...
 * @version $Rev$, $Date$
*/
public class JDBCVistaEventiVersamentoServiceSearch implements IDBVistaEventiVersamentoServiceSearch, IDBServiceUtilities<Evento> {
	...
	public JDBCVistaEventiVersamentoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCVistaEventiVersamentoServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("vistaEventiVersamento");
	...
	@Override
	public void validate(Evento vistaEventiVersamento) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(vistaEventiVersamento, this.log, 
