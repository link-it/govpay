...
public class TracciatoModel extends AbstractModel<Tracciato> {
	...
	public TracciatoModel(){
		...
		this.COD_TIPO_VERSAMENTO = new Field("codTipoVersamento",java.lang.String.class,"Tracciato",Tracciato.class);
		this.FORMATO = new Field("formato",java.lang.String.class,"Tracciato",Tracciato.class);
		...
		this.ZIP_STAMPE = new Field("zipStampe",byte[].class,"Tracciato",Tracciato.class);
	...
	public TracciatoModel(IField father){
		...
		this.COD_TIPO_VERSAMENTO = new ComplexField(father,"codTipoVersamento",java.lang.String.class,"Tracciato",Tracciato.class);
		this.FORMATO = new ComplexField(father,"formato",java.lang.String.class,"Tracciato",Tracciato.class);
		...
		this.ZIP_STAMPE = new ComplexField(father,"zipStampe",byte[].class,"Tracciato",Tracciato.class);
