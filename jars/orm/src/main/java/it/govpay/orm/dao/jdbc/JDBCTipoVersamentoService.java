...
public class JDBCTipoVersamentoService extends JDBCTipoVersamentoServiceSearch  implements IDBTipoVersamentoService {
	...
	public JDBCTipoVersamentoService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCTipoVersamentoService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+TipoVersamento.class.getName()+") 'tipoVersamento' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdTipoVersamento.class.getName()+") 'oldId' is null");
	}
