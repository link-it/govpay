...
public class JDBCIntermediarioServiceSearch implements IDBIntermediarioServiceSearch, IDBServiceUtilities<Intermediario> {
	...
	public JDBCIntermediarioServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCIntermediarioServiceSearch.class.getName()+ " initialized");
	...
	public IdIntermediario convertToId(Intermediario obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+Intermediario.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, Intermediario obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdIntermediario.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+Intermediario.class.getName()+") 'obj' is null");
			}
