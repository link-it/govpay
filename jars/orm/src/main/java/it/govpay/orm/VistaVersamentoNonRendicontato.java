...
/** <p>Java class for VistaVersamentoNonRendicontato complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="VistaVersamentoNonRendicontato"&gt;
 * 		&lt;sequence&gt;
 ...
 * 			&lt;element name="pagIdIncasso" type="{http://www.govpay.it/orm}id-incasso" minOccurs="0" maxOccurs="1"/&gt;
...
@XmlType(name = "VistaVersamentoNonRendicontato",
  propOrder = {
  	"sngIdTributo",
  	"sngCodSingVersEnte",
...
@XmlRootElement(name = "VistaVersamentoNonRendicontato")

public class VistaVersamentoNonRendicontato extends org.openspcoop2.utils.beans.BaseBeanWithId implements Serializable , Cloneable {
  public VistaVersamentoNonRendicontato() {
    super();
  }
  ...
  public IdIncasso getPagIdIncasso() {
    return this.pagIdIncasso;
  }

  public void setPagIdIncasso(IdIncasso pagIdIncasso) {
    this.pagIdIncasso = pagIdIncasso;
  }
  ...
  private static it.govpay.orm.model.VistaVersamentoNonRendicontatoModel modelStaticInstance = null;
  private static synchronized void initModelStaticInstance(){
	  if(it.govpay.orm.VistaVersamentoNonRendicontato.modelStaticInstance==null){
  			it.govpay.orm.VistaVersamentoNonRendicontato.modelStaticInstance = new it.govpay.orm.model.VistaVersamentoNonRendicontatoModel();
	  }
  }
  public static it.govpay.orm.model.VistaVersamentoNonRendicontatoModel model(){
	  if(it.govpay.orm.VistaVersamentoNonRendicontato.modelStaticInstance==null){
	  		initModelStaticInstance();
	  }
	  return it.govpay.orm.VistaVersamentoNonRendicontato.modelStaticInstance;
  }
  ...
  @XmlElement(name="pagIdIncasso",required=false,nillable=false)
  protected IdIncasso pagIdIncasso;
