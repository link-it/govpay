...
public class JDBCRPTService extends JDBCRPTServiceSearch  implements IDBRPTService {
	...
	public JDBCRPTService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCRPTService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+RPT.class.getName()+") 'rpt' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdRpt.class.getName()+") 'oldId' is null");
	}
