 ...
 * @version $Rev$, $Date$
 */
public class DocumentoFetch extends AbstractJDBCFetch {
	...
	public IKeyGeneratorObject getKeyGeneratorObject( IModel<?> model )  throws ServiceException {
		...
		try{
			...
			if(model.equals(Documento.model())){
				return new org.openspcoop2.utils.jdbc.CustomKeyGeneratorObject("documenti","id","seq_documenti","documenti_init_seq");
			}
