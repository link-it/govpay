...
public class JDBCVersamentoService extends JDBCVersamentoServiceSearch  implements IDBVersamentoService {
	...
	public JDBCVersamentoService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCVersamentoService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+Versamento.class.getName()+") 'versamento' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdVersamento.class.getName()+") 'oldId' is null");
	}
	...
	@Override
	public void create(Versamento versamento) throws ServiceException, NotImplementedException {
		try{
			this.create(versamento, false, null);
	...
	@Override
	public void create(Versamento versamento, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.create(versamento, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void create(Versamento versamento, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.create(versamento, validate, null);
	}
	
	@Override
	public void create(Versamento versamento, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
	...
	@Override
	public void update(IdVersamento oldId, Versamento versamento) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, versamento, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(IdVersamento oldId, Versamento versamento, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, versamento, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(IdVersamento oldId, Versamento versamento, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		this.update(oldId, versamento, validate, null);
	}
		
	@Override
	public void update(IdVersamento oldId, Versamento versamento, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
	...
	@Override
	public void update(long tableId, Versamento versamento) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(tableId, versamento, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(long tableId, Versamento versamento, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(tableId, versamento, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(long tableId, Versamento versamento, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		this.update(tableId, versamento, validate, null);
	}
		
	@Override
	public void update(long tableId, Versamento versamento, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
	...
	@Override
	public void updateFields(IdVersamento id, UpdateField ... updateFields) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateFields(IdVersamento id, IExpression condition, UpdateField ... updateFields) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateFields(IdVersamento id, UpdateModel ... updateModels) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateOrCreate(IdVersamento oldId, Versamento versamento) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, versamento, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(IdVersamento oldId, Versamento versamento, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, versamento, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(IdVersamento oldId, Versamento versamento, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.updateOrCreate(oldId, versamento, validate, null);
	}

	@Override
	public void updateOrCreate(IdVersamento oldId, Versamento versamento, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
	...
	@Override
	public void updateOrCreate(long tableId, Versamento versamento) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(tableId, versamento, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(long tableId, Versamento versamento, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(tableId, versamento, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(long tableId, Versamento versamento, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.updateOrCreate(tableId, versamento, validate, null);
	}

	@Override
	public void updateOrCreate(long tableId, Versamento versamento, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
	...
	@Override
	public void delete(Versamento versamento) throws ServiceException,NotImplementedException {
	...
	@Override
	public void deleteById(IdVersamento id) throws ServiceException, NotImplementedException {
