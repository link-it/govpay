...
public class TipoVersamentoModel extends AbstractModel<TipoVersamento> {
	...
	public TipoVersamentoModel(){
		...
		this.AVV_MAIL_PROM_SCAD_PREAVVISO = new Field("avvMailPromScadPreavviso",java.math.BigInteger.class,"TipoVersamento",TipoVersamento.class);
		...
		this.AVV_APP_IO_PROM_SCAD_PREAVVISO = new Field("avvAppIoPromScadPreavviso",java.math.BigInteger.class,"TipoVersamento",TipoVersamento.class);
	...
	public TipoVersamentoModel(IField father){
		...
		this.AVV_MAIL_PROM_SCAD_PREAVVISO = new ComplexField(father,"avvMailPromScadPreavviso",java.math.BigInteger.class,"TipoVersamento",TipoVersamento.class);
		...
		this.AVV_APP_IO_PROM_SCAD_PREAVVISO = new ComplexField(father,"avvAppIoPromScadPreavviso",java.math.BigInteger.class,"TipoVersamento",TipoVersamento.class);
