 ...
 * @version $Rev$, $Date$
*/
public class JDBCVistaRiscossioniServiceSearch implements IVistaRiscossioniServiceSearch, IDBServiceUtilities<VistaRiscossioni> {
	...
	public JDBCVistaRiscossioniServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCVistaRiscossioniServiceSearch.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+VistaRiscossioni.class.getName()+") 'obj' is null");
	}
	protected ServiceException newServiceExceptionParameterIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdVistaRiscossione.class.getName()+") 'id' is null");
	}
