...
public class JDBCNotificaAppIOService extends JDBCNotificaAppIOServiceSearch  implements IDBNotificaAppIOService {
	...
	public JDBCNotificaAppIOService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCNotificaAppIOService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+NotificaAppIO.class.getName()+") 'notificaAppIO' is null");
	}
	...
	@Override
	public void create(NotificaAppIO notificaAppIO) throws ServiceException, NotImplementedException {
		try{
			this.create(notificaAppIO, false, null);
	...
	@Override
	public void create(NotificaAppIO notificaAppIO, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.create(notificaAppIO, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void create(NotificaAppIO notificaAppIO, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.create(notificaAppIO, validate, null);
	}
	
	@Override
	public void create(NotificaAppIO notificaAppIO, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
	...
	@Override
	public void update(IdNotifica oldId, NotificaAppIO notificaAppIO) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, notificaAppIO, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(IdNotifica oldId, NotificaAppIO notificaAppIO, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, notificaAppIO, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(IdNotifica oldId, NotificaAppIO notificaAppIO, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		this.update(oldId, notificaAppIO, validate, null);
	}
		
	@Override
	public void update(IdNotifica oldId, NotificaAppIO notificaAppIO, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
	...
	@Override
	public void update(long tableId, NotificaAppIO notificaAppIO) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(tableId, notificaAppIO, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(long tableId, NotificaAppIO notificaAppIO, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(tableId, notificaAppIO, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(long tableId, NotificaAppIO notificaAppIO, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		this.update(tableId, notificaAppIO, validate, null);
	}
		
	@Override
	public void update(long tableId, NotificaAppIO notificaAppIO, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
	...
	@Override
	public void updateOrCreate(IdNotifica oldId, NotificaAppIO notificaAppIO) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, notificaAppIO, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(IdNotifica oldId, NotificaAppIO notificaAppIO, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, notificaAppIO, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(IdNotifica oldId, NotificaAppIO notificaAppIO, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.updateOrCreate(oldId, notificaAppIO, validate, null);
	}

	@Override
	public void updateOrCreate(IdNotifica oldId, NotificaAppIO notificaAppIO, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
	...
	@Override
	public void updateOrCreate(long tableId, NotificaAppIO notificaAppIO) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(tableId, notificaAppIO, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(long tableId, NotificaAppIO notificaAppIO, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(tableId, notificaAppIO, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(long tableId, NotificaAppIO notificaAppIO, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.updateOrCreate(tableId, notificaAppIO, validate, null);
	}

	@Override
	public void updateOrCreate(long tableId, NotificaAppIO notificaAppIO, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
	...
	@Override
	public void delete(NotificaAppIO notificaAppIO) throws ServiceException,NotImplementedException {
