...
public class JDBCUtenzaDominioService extends JDBCUtenzaDominioServiceSearch  implements IDBUtenzaDominioService {
	...
	public JDBCUtenzaDominioService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCUtenzaDominioService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+UtenzaDominio.class.getName()+") 'utenzaDominio' is null");
	}
