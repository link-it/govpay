...
public class JDBCPagamentoService extends JDBCPagamentoServiceSearch  implements IDBPagamentoService {
	...
	public JDBCPagamentoService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCPagamentoService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+Pagamento.class.getName()+") 'pagamento' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdPagamento.class.getName()+") 'oldId' is null");
	}
