...
public class JDBCPagamentoService extends JDBCPagamentoServiceSearch  implements IDBPagamentoService {
	...
	private String modelName = Costanti.MODEL_PAGAMENTO;
	private String modelClassName = Pagamento.class.getName();
	private String idModelClassName = IdPagamento.class.getName();
