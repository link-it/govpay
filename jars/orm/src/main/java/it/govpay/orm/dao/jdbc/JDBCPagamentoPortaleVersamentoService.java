...
public class JDBCPagamentoPortaleVersamentoService extends JDBCPagamentoPortaleVersamentoServiceSearch  implements IDBPagamentoPortaleVersamentoService {
	...
	public JDBCPagamentoPortaleVersamentoService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCPagamentoPortaleVersamentoService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+PagamentoPortaleVersamento.class.getName()+") 'pagamentoPortaleVersamento' is null");
	}
