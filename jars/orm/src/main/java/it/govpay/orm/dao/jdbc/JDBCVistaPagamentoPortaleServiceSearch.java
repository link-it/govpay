...
public class JDBCVistaPagamentoPortaleServiceSearch implements IDBVistaPagamentoPortaleServiceSearch, IDBServiceUtilities<VistaPagamentoPortale> {
	...
	public JDBCVistaPagamentoPortaleServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCVistaPagamentoPortaleServiceSearch.class.getName()+ " initialized");
	...
	public IdPagamentoPortale convertToId(VistaPagamentoPortale obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+VistaPagamentoPortale.class.getName()+") 'obj' is null");
			}
	...
	public VistaPagamentoPortale get(IdPagamentoPortale id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		...
		try{
			...
			// check parameters
			if(id==null){
				throw new Exception("Parameter (type:"+IdPagamentoPortale.class.getName()+") 'id' is null");
			}
	...
	public void mappingTableIds(long tableId, VistaPagamentoPortale obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdPagamentoPortale.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+VistaPagamentoPortale.class.getName()+") 'obj' is null");
			}
