...
/**     
 * Service can be used to search for the backend objects of type {@link it.govpay.orm.VistaPagamentoPortale} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCVistaPagamentoPortaleServiceSearch implements IDBVistaPagamentoPortaleServiceSearch, IDBServiceUtilities<VistaPagamentoPortale> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<VistaPagamentoPortale, IdPagamentoPortale, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCVistaPagamentoPortaleServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCVistaPagamentoPortaleServiceSearch.class.getName()+ " initialized";
		this.log.debug(msgInit);
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("vistaPagamentoPortale");
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+VistaPagamentoPortale.class.getName()+") 'obj' is null");
	}
	protected ServiceException newServiceExceptionParameterIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdPagamentoPortale.class.getName()+") 'id' is null");
	}
	...
	private ServiceException newServiceExceptionParameterWithTypeTableIdLessEqualsZero(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdPagamentoPortale.class.getName()+") 'tableId' is lessEquals 0");
	}
	...
	@Override
	public void validate(VistaPagamentoPortale vistaPagamentoPortale) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(vistaPagamentoPortale, this.log, 
	...
	@Override
	public IdPagamentoPortale convertToId(VistaPagamentoPortale obj)
	...
	@Override
	public VistaPagamentoPortale get(IdPagamentoPortale id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public VistaPagamentoPortale get(IdPagamentoPortale id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public boolean exists(IdPagamentoPortale id) throws MultipleResultException,ServiceException,NotImplementedException {
	...
	@Override
	public List<IdPagamentoPortale> findAllIds(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<IdPagamentoPortale> findAllIds(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<VistaPagamentoPortale> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<VistaPagamentoPortale> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public VistaPagamentoPortale find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public VistaPagamentoPortale find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public InUse inUse(IdPagamentoPortale id) throws ServiceException, NotFoundException,NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdPagamentoPortale id, VistaPagamentoPortale obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, VistaPagamentoPortale obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public VistaPagamentoPortale get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public VistaPagamentoPortale get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public IdPagamentoPortale findId(long tableId, boolean throwNotFound)
	...
	@Override
	public Long findTableId(IdPagamentoPortale id, boolean throwNotFound)
			throws NotFoundException, ServiceException, NotImplementedException {
