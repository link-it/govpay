...
public class JDBCTipoVersamentoDominioServiceSearchImpl implements IJDBCServiceSearchWithId<TipoVersamentoDominio, IdTipoVersamentoDominio, JDBCServiceManager> {
	...
	public List<TipoVersamentoDominio> findAll(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotImplementedException, ServiceException,Exception {
        ...
        try{  
			...
			fields.add(TipoVersamentoDominio.model().BO_VALIDAZIONE_DEF);
			fields.add(TipoVersamentoDominio.model().BO_TRASFORMAZIONE_TIPO);
			fields.add(TipoVersamentoDominio.model().BO_TRASFORMAZIONE_DEF);
			fields.add(TipoVersamentoDominio.model().BO_COD_APPLICAZIONE);
			...
			fields.add(TipoVersamentoDominio.model().PAG_COD_APPLICAZIONE);
			fields.add(TipoVersamentoDominio.model().PAG_ABILITATO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_AVV_ABILITATO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_AVV_PDF);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_AVV_TIPO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_AVV_OGGETTO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_AVV_MESSAGGIO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_RIC_ABILITATO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_RIC_PDF);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_RIC_TIPO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_RIC_OGGETTO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_RIC_MESSAGGIO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_RIC_ESEGUITI);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_SCAD_ABILITATO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_SCAD_PREAVVISO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_SCAD_TIPO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_SCAD_OGGETTO);
			fields.add(TipoVersamentoDominio.model().AVV_MAIL_PROM_SCAD_MESSAGGIO);
			...
			fields.add(TipoVersamentoDominio.model().APP_IO_API_KEY);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_AVV_ABILITATO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_AVV_TIPO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_AVV_OGGETTO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_AVV_MESSAGGIO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_RIC_ABILITATO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_RIC_TIPO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_RIC_OGGETTO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_RIC_MESSAGGIO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_RIC_ESEGUITI);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_SCAD_ABILITATO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_SCAD_PREAVVISO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_SCAD_TIPO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_SCAD_OGGETTO);
			fields.add(TipoVersamentoDominio.model().AVV_APP_IO_PROM_SCAD_MESSAGGIO);
			...
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.BO_FORM_DEFINIZIONE, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.BO_VALIDAZIONE_DEF, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.BO_TRASFORMAZIONE_TIPO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.BO_TRASFORMAZIONE_DEF, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.BO_COD_APPLICAZIONE, pos++));
			...
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.PAG_COD_APPLICAZIONE, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.PAG_ABILITATO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_AVV_ABILITATO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_AVV_PDF, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_AVV_TIPO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_AVV_OGGETTO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_AVV_MESSAGGIO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_RIC_ABILITATO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_RIC_PDF, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_RIC_TIPO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_RIC_OGGETTO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_RIC_MESSAGGIO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_RIC_ESEGUITI, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_SCAD_ABILITATO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_SCAD_PREAVVISO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_SCAD_TIPO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_SCAD_OGGETTO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_MAIL_PROM_SCAD_MESSAGGIO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.VISUALIZZAZIONE_DEFINIZIONE, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.TRAC_CSV_TIPO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.TRAC_CSV_HEADER_RISPOSTA, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.TRAC_CSV_TEMPLATE_RICHIESTA, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.TRAC_CSV_TEMPLATE_RISPOSTA, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_AVV_ABILITATO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_AVV_TIPO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_AVV_OGGETTO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_AVV_MESSAGGIO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_RIC_ABILITATO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_RIC_TIPO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_RIC_OGGETTO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_RIC_MESSAGGIO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_RIC_ESEGUITI, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_SCAD_ABILITATO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_SCAD_PREAVVISO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_SCAD_TIPO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_SCAD_OGGETTO, pos++));
			fields.add(this.getAliasField(TipoVersamentoDominio.model().TIPO_VERSAMENTO.AVV_APP_IO_PROM_SCAD_MESSAGGIO, pos++));
...
//		String toColumnTrue = this.getFieldConverter().toColumn(field,true);
		...
		return new AliasField(customField, "tv_c" + position);
	}
	...
	public NonNegativeNumber count(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, JDBCExpression expression) throws NotImplementedException, ServiceException,Exception {
		...
		sqlQueryObject.addSelectCountField(this.getTipoVersamentoDominioFieldConverter().toTable(TipoVersamentoDominio.model())+".id","tot");
