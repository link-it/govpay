...
/** <p>Java class for id-stampa complex type.
 * 
...
@XmlRootElement(name = "id-stampa")

public class IdStampa extends org.openspcoop2.utils.beans.BaseBeanWithId implements Serializable , Cloneable {
  public IdStampa() {
    super();
  }
