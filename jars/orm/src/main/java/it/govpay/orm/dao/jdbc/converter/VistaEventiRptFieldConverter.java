 ...
 * @version $Rev$, $Date$
 */
public class VistaEventiRptFieldConverter extends AbstractSQLFieldConverter {

	private TipiDatabase databaseType;
	
	public VistaEventiRptFieldConverter(String databaseType){
		this.databaseType = TipiDatabase.toEnumConstant(databaseType);
	}
	public VistaEventiRptFieldConverter(TipiDatabase databaseType){
