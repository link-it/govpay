...
public class JDBCAllegatoServiceSearch implements IDBAllegatoServiceSearch, IDBServiceUtilities<Allegato> {
	...
	public JDBCAllegatoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCAllegatoServiceSearch.class.getName()+ " initialized");
	...
	public IdAllegato convertToId(Allegato obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+Allegato.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, Allegato obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdAllegato.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+Allegato.class.getName()+") 'obj' is null");
			}
