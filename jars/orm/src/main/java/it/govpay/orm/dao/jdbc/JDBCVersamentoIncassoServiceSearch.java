...
public class JDBCVersamentoIncassoServiceSearch implements IDBVersamentoIncassoServiceSearch, IDBServiceUtilities<VersamentoIncasso> {
	...
	public JDBCVersamentoIncassoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCVersamentoIncassoServiceSearch.class.getName()+ " initialized");
	...
	public IdVersamento convertToId(VersamentoIncasso obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+VersamentoIncasso.class.getName()+") 'obj' is null");
			}
