 ...
 * @version $Rev$, $Date$
 */
public class IdDocumentoModel extends AbstractModel<IdDocumento> {

	public IdDocumentoModel(){
	...
	public IdDocumentoModel(IField father){
	...
	@Override
	public Class<IdDocumento> getModeledClass(){
		return IdDocumento.class;
	}
