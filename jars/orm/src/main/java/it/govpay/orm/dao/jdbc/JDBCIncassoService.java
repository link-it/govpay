...
public class JDBCIncassoService extends JDBCIncassoServiceSearch  implements IDBIncassoService {
	...
	public JDBCIncassoService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCIncassoService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+Incasso.class.getName()+") 'incasso' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdIncasso.class.getName()+") 'oldId' is null");
	}
