...
public class JDBCConfigurazioneService extends JDBCConfigurazioneServiceSearch  implements IDBConfigurazioneService {
	...
	public JDBCConfigurazioneService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCConfigurazioneService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+Configurazione.class.getName()+") 'configurazione' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdConfigurazione.class.getName()+") 'oldId' is null");
	}
	...
	@Override
	public void update(IdConfigurazione oldId, Configurazione configurazione) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, configurazione, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(IdConfigurazione oldId, Configurazione configurazione, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(oldId, configurazione, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(IdConfigurazione oldId, Configurazione configurazione, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		this.update(oldId, configurazione, validate, null);
	}
		
	@Override
	public void update(IdConfigurazione oldId, Configurazione configurazione, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,configurazione,idMappingResolutionBehaviour);
	...
	@Override
	public void update(long tableId, Configurazione configurazione) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(tableId, configurazione, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(long tableId, Configurazione configurazione, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(tableId, configurazione, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(long tableId, Configurazione configurazione, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		this.update(tableId, configurazione, validate, null);
	}
		
	@Override
	public void update(long tableId, Configurazione configurazione, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,tableId,configurazione,idMappingResolutionBehaviour);
	...
	@Override
	public void updateFields(IdConfigurazione id, UpdateField ... updateFields) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateFields(IdConfigurazione id, IExpression condition, UpdateField ... updateFields) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateFields(IdConfigurazione id, UpdateModel ... updateModels) throws ServiceException, NotFoundException, NotImplementedException {
	...
	@Override
	public void updateOrCreate(IdConfigurazione oldId, Configurazione configurazione) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, configurazione, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(IdConfigurazione oldId, Configurazione configurazione, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(oldId, configurazione, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(IdConfigurazione oldId, Configurazione configurazione, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.updateOrCreate(oldId, configurazione, validate, null);
	}

	@Override
	public void updateOrCreate(IdConfigurazione oldId, Configurazione configurazione, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,oldId,configurazione,idMappingResolutionBehaviour);
	...
	@Override
	public void updateOrCreate(long tableId, Configurazione configurazione) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(tableId, configurazione, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(long tableId, Configurazione configurazione, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(tableId, configurazione, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(long tableId, Configurazione configurazione, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.updateOrCreate(tableId, configurazione, validate, null);
	}

	@Override
	public void updateOrCreate(long tableId, Configurazione configurazione, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,tableId,configurazione,idMappingResolutionBehaviour);
	...
	@Override
	public void deleteById(IdConfigurazione id) throws ServiceException, NotImplementedException {
