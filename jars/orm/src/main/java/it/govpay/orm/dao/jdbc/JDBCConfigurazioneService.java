...
public class JDBCConfigurazioneService extends JDBCConfigurazioneServiceSearch  implements IDBConfigurazioneService {
	...
	private String modelName = Costanti.MODEL_CONFIGURAZIONE;
	private String modelClassName = Configurazione.class.getName();
	private String idModelClassName = IdConfigurazione.class.getName();
