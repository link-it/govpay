...
/**     
 * Service can be used to search for and manage the backend objects of type {@link it.govpay.orm.Stampa} 
 *
...
public class JDBCStampaService extends JDBCStampaServiceSearch  implements IDBStampaService {
	...
	public JDBCStampaService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCStampaService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+Stampa.class.getName()+") 'stampa' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdStampa.class.getName()+") 'oldId' is null");
	}
	...
	@Override
	public void create(Stampa stampa) throws ServiceException, NotImplementedException {
		try{
			this.create(stampa, false, null);
	...
	@Override
	public void create(Stampa stampa, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.create(stampa, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void create(Stampa stampa, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.create(stampa, validate, null);
	}
	
	@Override
	public void create(Stampa stampa, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.create(this.jdbcProperties,this.log,connection,sqlQueryObject,stampa,idMappingResolutionBehaviour);			
	...
	@Override
	public void update(long tableId, Stampa stampa) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(tableId, stampa, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(long tableId, Stampa stampa, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException {
		try{
			this.update(tableId, stampa, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void update(long tableId, Stampa stampa, boolean validate) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		this.update(tableId, stampa, validate, null);
	}
		
	@Override
	public void update(long tableId, Stampa stampa, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.update(this.jdbcProperties,this.log,connection,sqlQueryObject,tableId,stampa,idMappingResolutionBehaviour);
	...
	@Override
	public void updateOrCreate(long tableId, Stampa stampa) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(tableId, stampa, false, null);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(long tableId, Stampa stampa, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
		try{
			this.updateOrCreate(tableId, stampa, false, idMappingResolutionBehaviour);
		}catch(ValidationException vE){
			// not possible
			throw new ServiceException(vE.getMessage(), vE);
		}
	...
	@Override
	public void updateOrCreate(long tableId, Stampa stampa, boolean validate) throws ServiceException, NotImplementedException, ValidationException {
		this.updateOrCreate(tableId, stampa, validate, null);
	}

	@Override
	public void updateOrCreate(long tableId, Stampa stampa, boolean validate, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException, ValidationException {
		...
		try{
			...
			this.serviceCRUD.updateOrCreate(this.jdbcProperties,this.log,connection,sqlQueryObject,tableId,stampa,idMappingResolutionBehaviour);
	...
	@Override
	public void delete(Stampa stampa) throws ServiceException,NotImplementedException {
		...
		try{
			...
			this.serviceCRUD.delete(this.jdbcProperties,this.log,connection,sqlQueryObject,stampa);	
