...
public class JDBCStampaService extends JDBCStampaServiceSearch  implements IDBStampaService {
	...
	private String modelName = Costanti.MODEL_STAMPA;
	private String modelClassName = Stampa.class.getName();
	private String idModelClassName = IdStampa.class.getName();
