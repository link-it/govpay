...
public class JDBCTracciatoNotificaPagamentiService extends JDBCTracciatoNotificaPagamentiServiceSearch  implements IDBTracciatoNotificaPagamentiService {
	...
	public JDBCTracciatoNotificaPagamentiService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCTracciatoNotificaPagamentiService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+TracciatoNotificaPagamenti.class.getName()+") 'tracciatoNotificaPagamenti' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdTracciatoNotificaPagamenti.class.getName()+") 'oldId' is null");
	}
