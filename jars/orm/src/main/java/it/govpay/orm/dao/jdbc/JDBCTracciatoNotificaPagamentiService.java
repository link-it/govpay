...
public class JDBCTracciatoNotificaPagamentiService extends JDBCTracciatoNotificaPagamentiServiceSearch  implements IDBTracciatoNotificaPagamentiService {
	...
	private String modelName = Costanti.MODEL_TRACCIATO_NOTIFICA_PAGAMENTI;
	private String modelClassName = TracciatoNotificaPagamenti.class.getName();
	private String idModelClassName = IdTracciatoNotificaPagamenti.class.getName();
