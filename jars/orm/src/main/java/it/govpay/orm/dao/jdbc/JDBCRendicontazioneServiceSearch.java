...
public class JDBCRendicontazioneServiceSearch implements IDBRendicontazioneServiceSearch, IDBServiceUtilities<Rendicontazione> {
	...
	public JDBCRendicontazioneServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCRendicontazioneServiceSearch.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+Rendicontazione.class.getName()+") 'obj' is null");
	}
