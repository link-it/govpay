...
public class JDBCPagamentoPortaleService extends JDBCPagamentoPortaleServiceSearch  implements IDBPagamentoPortaleService {
	...
	public JDBCPagamentoPortaleService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCPagamentoPortaleService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+PagamentoPortale.class.getName()+") 'pagamentoPortale' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdPagamentoPortale.class.getName()+") 'oldId' is null");
	}
