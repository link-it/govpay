		...
		try{
			...
			if(model.equals(VersamentoIncasso.model())){
				...
				setParameter(object, "setCodVersamentoEnte", VersamentoIncasso.model().COD_VERSAMENTO_ENTE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_versamento_ente", VersamentoIncasso.model().COD_VERSAMENTO_ENTE.getFieldType()));
				setParameter(object, "setNome", VersamentoIncasso.model().NOME.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "nome", VersamentoIncasso.model().NOME.getFieldType()));
				setParameter(object, "setImportoTotale", VersamentoIncasso.model().IMPORTO_TOTALE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "importo_totale", VersamentoIncasso.model().IMPORTO_TOTALE.getFieldType()));
				setParameter(object, "setStatoVersamento", VersamentoIncasso.model().STATO_VERSAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "stato_versamento", VersamentoIncasso.model().STATO_VERSAMENTO.getFieldType()));
				setParameter(object, "setDescrizioneStato", VersamentoIncasso.model().DESCRIZIONE_STATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "descrizione_stato", VersamentoIncasso.model().DESCRIZIONE_STATO.getFieldType()));
				setParameter(object, "setAggiornabile", VersamentoIncasso.model().AGGIORNABILE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "aggiornabile", VersamentoIncasso.model().AGGIORNABILE.getFieldType()));
				setParameter(object, "setDataCreazione", VersamentoIncasso.model().DATA_CREAZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_creazione", VersamentoIncasso.model().DATA_CREAZIONE.getFieldType()));
				setParameter(object, "setDataValidita", VersamentoIncasso.model().DATA_VALIDITA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_validita", VersamentoIncasso.model().DATA_VALIDITA.getFieldType()));
				setParameter(object, "setDataScadenza", VersamentoIncasso.model().DATA_SCADENZA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_scadenza", VersamentoIncasso.model().DATA_SCADENZA.getFieldType()));
				setParameter(object, "setDataOraUltimoAggiornamento", VersamentoIncasso.model().DATA_ORA_ULTIMO_AGGIORNAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_ora_ultimo_aggiornamento", VersamentoIncasso.model().DATA_ORA_ULTIMO_AGGIORNAMENTO.getFieldType()));
				setParameter(object, "setCausaleVersamento", VersamentoIncasso.model().CAUSALE_VERSAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "causale_versamento", VersamentoIncasso.model().CAUSALE_VERSAMENTO.getFieldType()));
				setParameter(object, "setDebitoreTipo", VersamentoIncasso.model().DEBITORE_TIPO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_tipo", VersamentoIncasso.model().DEBITORE_TIPO.getFieldType()));
				setParameter(object, "setDebitoreIdentificativo", VersamentoIncasso.model().DEBITORE_IDENTIFICATIVO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_identificativo", VersamentoIncasso.model().DEBITORE_IDENTIFICATIVO.getFieldType()));
				setParameter(object, "setDebitoreAnagrafica", VersamentoIncasso.model().DEBITORE_ANAGRAFICA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_anagrafica", VersamentoIncasso.model().DEBITORE_ANAGRAFICA.getFieldType()));
				setParameter(object, "setDebitoreIndirizzo", VersamentoIncasso.model().DEBITORE_INDIRIZZO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_indirizzo", VersamentoIncasso.model().DEBITORE_INDIRIZZO.getFieldType()));
				setParameter(object, "setDebitoreCivico", VersamentoIncasso.model().DEBITORE_CIVICO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_civico", VersamentoIncasso.model().DEBITORE_CIVICO.getFieldType()));
				setParameter(object, "setDebitoreCap", VersamentoIncasso.model().DEBITORE_CAP.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_cap", VersamentoIncasso.model().DEBITORE_CAP.getFieldType()));
				setParameter(object, "setDebitoreLocalita", VersamentoIncasso.model().DEBITORE_LOCALITA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_localita", VersamentoIncasso.model().DEBITORE_LOCALITA.getFieldType()));
				setParameter(object, "setDebitoreProvincia", VersamentoIncasso.model().DEBITORE_PROVINCIA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_provincia", VersamentoIncasso.model().DEBITORE_PROVINCIA.getFieldType()));
				setParameter(object, "setDebitoreNazione", VersamentoIncasso.model().DEBITORE_NAZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_nazione", VersamentoIncasso.model().DEBITORE_NAZIONE.getFieldType()));
				setParameter(object, "setDebitoreEmail", VersamentoIncasso.model().DEBITORE_EMAIL.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_email", VersamentoIncasso.model().DEBITORE_EMAIL.getFieldType()));
				setParameter(object, "setDebitoreTelefono", VersamentoIncasso.model().DEBITORE_TELEFONO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_telefono", VersamentoIncasso.model().DEBITORE_TELEFONO.getFieldType()));
				setParameter(object, "setDebitoreCellulare", VersamentoIncasso.model().DEBITORE_CELLULARE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_cellulare", VersamentoIncasso.model().DEBITORE_CELLULARE.getFieldType()));
				setParameter(object, "setDebitoreFax", VersamentoIncasso.model().DEBITORE_FAX.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_fax", VersamentoIncasso.model().DEBITORE_FAX.getFieldType()));
				setParameter(object, "setTassonomiaAvviso", VersamentoIncasso.model().TASSONOMIA_AVVISO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "tassonomia_avviso", VersamentoIncasso.model().TASSONOMIA_AVVISO.getFieldType()));
				setParameter(object, "setTassonomia", VersamentoIncasso.model().TASSONOMIA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "tassonomia", VersamentoIncasso.model().TASSONOMIA.getFieldType()));
				setParameter(object, "setCodLotto", VersamentoIncasso.model().COD_LOTTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_lotto", VersamentoIncasso.model().COD_LOTTO.getFieldType()));
				setParameter(object, "setCodVersamentoLotto", VersamentoIncasso.model().COD_VERSAMENTO_LOTTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_versamento_lotto", VersamentoIncasso.model().COD_VERSAMENTO_LOTTO.getFieldType()));
				setParameter(object, "setCodAnnoTributario", VersamentoIncasso.model().COD_ANNO_TRIBUTARIO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_anno_tributario", VersamentoIncasso.model().COD_ANNO_TRIBUTARIO.getFieldType()));
				setParameter(object, "setCodBundlekey", VersamentoIncasso.model().COD_BUNDLEKEY.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_bundlekey", VersamentoIncasso.model().COD_BUNDLEKEY.getFieldType()));
				setParameter(object, "setDatiAllegati", VersamentoIncasso.model().DATI_ALLEGATI.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "dati_allegati", VersamentoIncasso.model().DATI_ALLEGATI.getFieldType()));
				setParameter(object, "setIncasso", VersamentoIncasso.model().INCASSO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "incasso", VersamentoIncasso.model().INCASSO.getFieldType()));
				setParameter(object, "setAnomalie", VersamentoIncasso.model().ANOMALIE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "anomalie", VersamentoIncasso.model().ANOMALIE.getFieldType()));
				setParameter(object, "setIuvVersamento", VersamentoIncasso.model().IUV_VERSAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "iuv_versamento", VersamentoIncasso.model().IUV_VERSAMENTO.getFieldType()));
				setParameter(object, "setNumeroAvviso", VersamentoIncasso.model().NUMERO_AVVISO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "numero_avviso", VersamentoIncasso.model().NUMERO_AVVISO.getFieldType()));
				setParameter(object, "setAck", VersamentoIncasso.model().ACK.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "ack", VersamentoIncasso.model().ACK.getFieldType()));
				setParameter(object, "setAnomalo", VersamentoIncasso.model().ANOMALO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "anomalo", VersamentoIncasso.model().ANOMALO.getFieldType()));
				setParameter(object, "setDataPagamento", VersamentoIncasso.model().DATA_PAGAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_pagamento", VersamentoIncasso.model().DATA_PAGAMENTO.getFieldType()));
				setParameter(object, "setImportoPagato", VersamentoIncasso.model().IMPORTO_PAGATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "importo_pagato", VersamentoIncasso.model().IMPORTO_PAGATO.getFieldType()));
				setParameter(object, "setImportoIncassato", VersamentoIncasso.model().IMPORTO_INCASSATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "importo_incassato", VersamentoIncasso.model().IMPORTO_INCASSATO.getFieldType()));
				setParameter(object, "setStatoPagamento", VersamentoIncasso.model().STATO_PAGAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "stato_pagamento", VersamentoIncasso.model().STATO_PAGAMENTO.getFieldType()));
				setParameter(object, "setIuvPagamento", VersamentoIncasso.model().IUV_PAGAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "iuv_pagamento", VersamentoIncasso.model().IUV_PAGAMENTO.getFieldType()));
				setParameter(object, "setDivisione", VersamentoIncasso.model().DIVISIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "divisione", VersamentoIncasso.model().DIVISIONE.getFieldType()));
				setParameter(object, "setDirezione", VersamentoIncasso.model().DIREZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "direzione", VersamentoIncasso.model().DIREZIONE.getFieldType()));
				setParameter(object, "setSmartOrderDate", VersamentoIncasso.model().SMART_ORDER_DATE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "smart_order_date", VersamentoIncasso.model().SMART_ORDER_DATE.getFieldType()));
				setParameter(object, "setSmartOrderRank", VersamentoIncasso.model().SMART_ORDER_RANK.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "smart_order_rank", VersamentoIncasso.model().SMART_ORDER_RANK.getFieldType(), JDBCDefaultForXSDType.FORCE_ZERO_AS_NULL));
				setParameter(object, "setIdSessione", VersamentoIncasso.model().ID_SESSIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "id_sessione", VersamentoIncasso.model().ID_SESSIONE.getFieldType()));
				setParameter(object, "setSrcIuv", VersamentoIncasso.model().SRC_IUV.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "src_iuv", VersamentoIncasso.model().SRC_IUV.getFieldType()));
				setParameter(object, "setSrcDebitoreIdentificativo", VersamentoIncasso.model().SRC_DEBITORE_IDENTIFICATIVO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "src_debitore_identificativo", VersamentoIncasso.model().SRC_DEBITORE_IDENTIFICATIVO.getFieldType()));
				setParameter(object, "setCodRata", VersamentoIncasso.model().COD_RATA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_rata", VersamentoIncasso.model().COD_RATA.getFieldType()));
				setParameter(object, "setCodDocumento", VersamentoIncasso.model().COD_DOCUMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_documento", VersamentoIncasso.model().COD_DOCUMENTO.getFieldType()));
				setParameter(object, "setTipo", VersamentoIncasso.model().TIPO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "tipo", VersamentoIncasso.model().TIPO.getFieldType()));
				setParameter(object, "setDocDescrizione", VersamentoIncasso.model().DOC_DESCRIZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "doc_descrizione", VersamentoIncasso.model().DOC_DESCRIZIONE.getFieldType()));
				setParameter(object, "setProprieta", VersamentoIncasso.model().PROPRIETA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "proprieta", VersamentoIncasso.model().PROPRIETA.getFieldType()));
				return object;
			}
