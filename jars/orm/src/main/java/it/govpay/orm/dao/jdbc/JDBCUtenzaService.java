...
public class JDBCUtenzaService extends JDBCUtenzaServiceSearch  implements IDBUtenzaService {
	...
	public JDBCUtenzaService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCUtenzaService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+Utenza.class.getName()+") 'utenza' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdUtenza.class.getName()+") 'oldId' is null");
	}
