...
public class JDBCUtenzaService extends JDBCUtenzaServiceSearch  implements IDBUtenzaService {
	...
	private String modelName = Costanti.MODEL_UTENZA;
	private String modelClassName = Utenza.class.getName();
	private String idModelClassName = IdUtenza.class.getName();
