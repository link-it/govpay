...
import it.govpay.orm.dao.IDBVistaEventiPagamentoServiceSearch;
 ...
 * @version $Rev$, $Date$
*/
public class JDBCVistaEventiPagamentoServiceSearch implements IDBVistaEventiPagamentoServiceSearch, IDBServiceUtilities<Evento> {
	...
	public JDBCVistaEventiPagamentoServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCVistaEventiPagamentoServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("vistaEventiPagamento");
	...
	@Override
	public void validate(Evento vistaEventiPagamento) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(vistaEventiPagamento, this.log, 
