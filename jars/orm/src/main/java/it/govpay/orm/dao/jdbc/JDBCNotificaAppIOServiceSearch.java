...
import it.govpay.orm.dao.IDBNotificaAppIOServiceSearch;
import it.govpay.orm.utils.ProjectInfo;

/**     
 * Service can be used to search for the backend objects of type {@link it.govpay.orm.NotificaAppIO} 
 *
 ...
 * @version $Rev$, $Date$
*/
public class JDBCNotificaAppIOServiceSearch implements IDBNotificaAppIOServiceSearch, IDBServiceUtilities<NotificaAppIO> {


	protected JDBCServiceManagerProperties jdbcProperties = null;
	protected JDBCServiceManager jdbcServiceManager = null;
	protected Logger log = null;
	protected IJDBCServiceSearchWithId<NotificaAppIO, IdNotifica, JDBCServiceManager> serviceSearch = null;
	protected JDBC_SQLObjectFactory jdbcSqlObjectFactory = null;
	public JDBCNotificaAppIOServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+NotificaAppIO.class.getName()+") 'obj' is null");
	}
	...
	@Override
	public void validate(NotificaAppIO notificaAppIO) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(notificaAppIO, this.log, 
	...
	@Override
	public IdNotifica convertToId(NotificaAppIO obj)
	...
	@Override
	public NotificaAppIO get(IdNotifica id) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public NotificaAppIO get(IdNotifica id, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
		Connection connection = null;
		try{
	...
	@Override
	public List<NotificaAppIO> findAll(IPaginatedExpression expression) throws ServiceException, NotImplementedException {
	...
	@Override
	public List<NotificaAppIO> findAll(IPaginatedExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotImplementedException {
	...
	@Override
	public NotificaAppIO find(IExpression expression) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public NotificaAppIO find(IExpression expression, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException, MultipleResultException, NotImplementedException {
	...
	@Override
	public void mappingTableIds(IdNotifica id, NotificaAppIO obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public void mappingTableIds(long tableId, NotificaAppIO obj) throws ServiceException,NotFoundException,NotImplementedException{
		Connection connection = null;
		try{
	...
	@Override
	public NotificaAppIO get(long tableId) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
	...
	@Override
	public NotificaAppIO get(long tableId,org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws ServiceException, NotFoundException,MultipleResultException, NotImplementedException {
