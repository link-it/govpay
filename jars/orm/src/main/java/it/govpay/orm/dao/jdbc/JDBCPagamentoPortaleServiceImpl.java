...
public class JDBCPagamentoPortaleServiceImpl extends JDBCPagamentoPortaleServiceSearchImpl
	...
	public void create(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, PagamentoPortale pagamentoPortale, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotImplementedException,ServiceException,Exception {
		...
		sqlQueryObjectInsert.addInsertField(this.getPagamentoPortaleFieldConverter().toColumn(PagamentoPortale.model().MULTI_BENEFICIARIO,false),"?");
		...
		sqlQueryObjectInsert.addInsertField(this.getPagamentoPortaleFieldConverter().toColumn(PagamentoPortale.model().SRC_VERSANTE_IDENTIFICATIVO,false),"?");
		sqlQueryObjectInsert.addInsertField(this.getPagamentoPortaleFieldConverter().toColumn(PagamentoPortale.model().SEVERITA,false),"?");
		...
		long id = jdbcUtilities.insertAndReturnGeneratedKey(sqlQueryObjectInsert, keyGenerator, jdbcProperties.isShowSql(),
			...
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(pagamentoPortale.getSrcVersanteIdentificativo(),PagamentoPortale.model().SRC_VERSANTE_IDENTIFICATIVO.getFieldType()),
			new org.openspcoop2.generic_project.dao.jdbc.utils.JDBCObject(pagamentoPortale.getSeverita(),PagamentoPortale.model().SEVERITA.getFieldType()),
	...
	public void update(JDBCServiceManagerProperties jdbcProperties, Logger log, Connection connection, ISQLQueryObject sqlQueryObject, long tableId, PagamentoPortale pagamentoPortale, org.openspcoop2.generic_project.beans.IDMappingBehaviour idMappingResolutionBehaviour) throws NotFoundException, NotImplementedException, ServiceException, Exception {
		...
		sqlQueryObjectUpdate.addUpdateField(this.getPagamentoPortaleFieldConverter().toColumn(PagamentoPortale.model().MULTI_BENEFICIARIO,false), "?");
		lstObjects_pagamentoPortale.add(new JDBCObject(pagamentoPortale.getMultiBeneficiario(), PagamentoPortale.model().MULTI_BENEFICIARIO.getFieldType()));
		sqlQueryObjectUpdate.addUpdateField(this.getPagamentoPortaleFieldConverter().toColumn(PagamentoPortale.model().ACK,false), "?");
		lstObjects_pagamentoPortale.add(new JDBCObject(pagamentoPortale.getAck(), PagamentoPortale.model().ACK.getFieldType()));
		...
		sqlQueryObjectUpdate.addUpdateField(this.getPagamentoPortaleFieldConverter().toColumn(PagamentoPortale.model().SRC_VERSANTE_IDENTIFICATIVO,false), "?");
		lstObjects_pagamentoPortale.add(new JDBCObject(pagamentoPortale.getSrcVersanteIdentificativo(), PagamentoPortale.model().SRC_VERSANTE_IDENTIFICATIVO.getFieldType()));
		sqlQueryObjectUpdate.addUpdateField(this.getPagamentoPortaleFieldConverter().toColumn(PagamentoPortale.model().SEVERITA,false), "?");
		lstObjects_pagamentoPortale.add(new JDBCObject(pagamentoPortale.getSeverita(), PagamentoPortale.model().SEVERITA.getFieldType()));
