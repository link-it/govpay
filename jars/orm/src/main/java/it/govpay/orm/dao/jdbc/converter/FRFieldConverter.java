...
public class FRFieldConverter extends AbstractSQLFieldConverter {
	...
	public String toColumn(IField field,boolean returnAlias,boolean appendTablePrefix) throws ExpressionException {
		...
		if(field.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_UO.COD_UO)){
			if(appendTablePrefix){
		...
		if(field.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_UO.ID_DOMINIO.COD_DOMINIO)){
			if(appendTablePrefix){
				return this.toAliasTable(field)+".cod_dominio";
			}else{
				return "cod_dominio";
		...
		if(field.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_TIPO_VERSAMENTO.COD_TIPO_VERSAMENTO)){
			if(appendTablePrefix){
		...
		if(field.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_TIPO_VERSAMENTO.TIPO)){
			if(appendTablePrefix){
		...
		if(field.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.DIVISIONE)){
			if(appendTablePrefix){
	...
	public String toTable(IField field,boolean returnAlias) throws ExpressionException {
		...
		if(field.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_UO.COD_UO)){
			return this.toTable(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_UO, returnAlias);
		}
		if(field.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_UO.ID_DOMINIO.COD_DOMINIO)){
			return this.toTable(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_UO.ID_DOMINIO, returnAlias);
		}
		if(field.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_TIPO_VERSAMENTO.COD_TIPO_VERSAMENTO)){
			return this.toTable(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_TIPO_VERSAMENTO, returnAlias);
		}
		if(field.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_TIPO_VERSAMENTO.TIPO)){
			return this.toTable(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_TIPO_VERSAMENTO, returnAlias);
		}
	...
	public String toTable(IModel<?> model,boolean returnAlias) throws ExpressionException {
		...
		if(model.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_UO)){
			return "uo";
		}
		if(model.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_UO.ID_DOMINIO)){
			return "domini";
		}
		if(model.equals(FR.model().ID_PAGAMENTO.ID_VERSAMENTO.ID_TIPO_VERSAMENTO)){
