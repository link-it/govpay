...
import it.govpay.orm.dao.IDBVistaEventiRptServiceSearch;
 ...
 * @version $Rev$, $Date$
*/
public class JDBCVistaEventiRptServiceSearch implements IDBVistaEventiRptServiceSearch, IDBServiceUtilities<Evento> {
	...
	public JDBCVistaEventiRptServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCVistaEventiRptServiceSearch.class.getName()+ " initialized");
		this.serviceSearch = JDBCProperties.getInstance(ProjectInfo.getInstance()).getServiceSearch("vistaEventiRpt");
	...
	@Override
	public void validate(Evento vistaEventiRpt) throws ServiceException,
			ValidationException, NotImplementedException {
		org.openspcoop2.generic_project.utils.XSDValidator.validate(vistaEventiRpt, this.log, 
