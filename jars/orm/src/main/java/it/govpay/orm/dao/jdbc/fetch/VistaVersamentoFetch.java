		...
		try{
			...
			if(model.equals(VistaVersamento.model())){
				...
				setParameter(object, "setCodVersamentoEnte", VistaVersamento.model().COD_VERSAMENTO_ENTE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_versamento_ente", VistaVersamento.model().COD_VERSAMENTO_ENTE.getFieldType()));
				setParameter(object, "setNome", VistaVersamento.model().NOME.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "nome", VistaVersamento.model().NOME.getFieldType()));
				setParameter(object, "setImportoTotale", VistaVersamento.model().IMPORTO_TOTALE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "importo_totale", VistaVersamento.model().IMPORTO_TOTALE.getFieldType()));
				setParameter(object, "setStatoVersamento", VistaVersamento.model().STATO_VERSAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "stato_versamento", VistaVersamento.model().STATO_VERSAMENTO.getFieldType()));
				setParameter(object, "setDescrizioneStato", VistaVersamento.model().DESCRIZIONE_STATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "descrizione_stato", VistaVersamento.model().DESCRIZIONE_STATO.getFieldType()));
				setParameter(object, "setAggiornabile", VistaVersamento.model().AGGIORNABILE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "aggiornabile", VistaVersamento.model().AGGIORNABILE.getFieldType()));
				setParameter(object, "setDataCreazione", VistaVersamento.model().DATA_CREAZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_creazione", VistaVersamento.model().DATA_CREAZIONE.getFieldType()));
				setParameter(object, "setDataValidita", VistaVersamento.model().DATA_VALIDITA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_validita", VistaVersamento.model().DATA_VALIDITA.getFieldType()));
				setParameter(object, "setDataScadenza", VistaVersamento.model().DATA_SCADENZA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_scadenza", VistaVersamento.model().DATA_SCADENZA.getFieldType()));
				setParameter(object, "setDataOraUltimoAggiornamento", VistaVersamento.model().DATA_ORA_ULTIMO_AGGIORNAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_ora_ultimo_aggiornamento", VistaVersamento.model().DATA_ORA_ULTIMO_AGGIORNAMENTO.getFieldType()));
				setParameter(object, "setCausaleVersamento", VistaVersamento.model().CAUSALE_VERSAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "causale_versamento", VistaVersamento.model().CAUSALE_VERSAMENTO.getFieldType()));
				setParameter(object, "setDebitoreTipo", VistaVersamento.model().DEBITORE_TIPO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_tipo", VistaVersamento.model().DEBITORE_TIPO.getFieldType()));
				setParameter(object, "setDebitoreIdentificativo", VistaVersamento.model().DEBITORE_IDENTIFICATIVO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_identificativo", VistaVersamento.model().DEBITORE_IDENTIFICATIVO.getFieldType()));
				setParameter(object, "setDebitoreAnagrafica", VistaVersamento.model().DEBITORE_ANAGRAFICA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_anagrafica", VistaVersamento.model().DEBITORE_ANAGRAFICA.getFieldType()));
				setParameter(object, "setDebitoreIndirizzo", VistaVersamento.model().DEBITORE_INDIRIZZO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_indirizzo", VistaVersamento.model().DEBITORE_INDIRIZZO.getFieldType()));
				setParameter(object, "setDebitoreCivico", VistaVersamento.model().DEBITORE_CIVICO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_civico", VistaVersamento.model().DEBITORE_CIVICO.getFieldType()));
				setParameter(object, "setDebitoreCap", VistaVersamento.model().DEBITORE_CAP.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_cap", VistaVersamento.model().DEBITORE_CAP.getFieldType()));
				setParameter(object, "setDebitoreLocalita", VistaVersamento.model().DEBITORE_LOCALITA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_localita", VistaVersamento.model().DEBITORE_LOCALITA.getFieldType()));
				setParameter(object, "setDebitoreProvincia", VistaVersamento.model().DEBITORE_PROVINCIA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_provincia", VistaVersamento.model().DEBITORE_PROVINCIA.getFieldType()));
				setParameter(object, "setDebitoreNazione", VistaVersamento.model().DEBITORE_NAZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_nazione", VistaVersamento.model().DEBITORE_NAZIONE.getFieldType()));
				setParameter(object, "setDebitoreEmail", VistaVersamento.model().DEBITORE_EMAIL.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_email", VistaVersamento.model().DEBITORE_EMAIL.getFieldType()));
				setParameter(object, "setDebitoreTelefono", VistaVersamento.model().DEBITORE_TELEFONO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_telefono", VistaVersamento.model().DEBITORE_TELEFONO.getFieldType()));
				setParameter(object, "setDebitoreCellulare", VistaVersamento.model().DEBITORE_CELLULARE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_cellulare", VistaVersamento.model().DEBITORE_CELLULARE.getFieldType()));
				setParameter(object, "setDebitoreFax", VistaVersamento.model().DEBITORE_FAX.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "debitore_fax", VistaVersamento.model().DEBITORE_FAX.getFieldType()));
				setParameter(object, "setTassonomiaAvviso", VistaVersamento.model().TASSONOMIA_AVVISO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "tassonomia_avviso", VistaVersamento.model().TASSONOMIA_AVVISO.getFieldType()));
				setParameter(object, "setTassonomia", VistaVersamento.model().TASSONOMIA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "tassonomia", VistaVersamento.model().TASSONOMIA.getFieldType()));
				setParameter(object, "setCodLotto", VistaVersamento.model().COD_LOTTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_lotto", VistaVersamento.model().COD_LOTTO.getFieldType()));
				setParameter(object, "setCodVersamentoLotto", VistaVersamento.model().COD_VERSAMENTO_LOTTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_versamento_lotto", VistaVersamento.model().COD_VERSAMENTO_LOTTO.getFieldType()));
				setParameter(object, "setCodAnnoTributario", VistaVersamento.model().COD_ANNO_TRIBUTARIO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_anno_tributario", VistaVersamento.model().COD_ANNO_TRIBUTARIO.getFieldType()));
				setParameter(object, "setCodBundlekey", VistaVersamento.model().COD_BUNDLEKEY.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_bundlekey", VistaVersamento.model().COD_BUNDLEKEY.getFieldType()));
				setParameter(object, "setDatiAllegati", VistaVersamento.model().DATI_ALLEGATI.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "dati_allegati", VistaVersamento.model().DATI_ALLEGATI.getFieldType()));
				setParameter(object, "setIncasso", VistaVersamento.model().INCASSO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "incasso", VistaVersamento.model().INCASSO.getFieldType()));
				setParameter(object, "setAnomalie", VistaVersamento.model().ANOMALIE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "anomalie", VistaVersamento.model().ANOMALIE.getFieldType()));
				setParameter(object, "setIuvVersamento", VistaVersamento.model().IUV_VERSAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "iuv_versamento", VistaVersamento.model().IUV_VERSAMENTO.getFieldType()));
				setParameter(object, "setNumeroAvviso", VistaVersamento.model().NUMERO_AVVISO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "numero_avviso", VistaVersamento.model().NUMERO_AVVISO.getFieldType()));
				setParameter(object, "setAck", VistaVersamento.model().ACK.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "ack", VistaVersamento.model().ACK.getFieldType()));
				setParameter(object, "setAnomalo", VistaVersamento.model().ANOMALO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "anomalo", VistaVersamento.model().ANOMALO.getFieldType()));
				setParameter(object, "setDivisione", VistaVersamento.model().DIVISIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "divisione", VistaVersamento.model().DIVISIONE.getFieldType()));
				setParameter(object, "setDirezione", VistaVersamento.model().DIREZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "direzione", VistaVersamento.model().DIREZIONE.getFieldType()));
				setParameter(object, "setIdSessione", VistaVersamento.model().ID_SESSIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "id_sessione", VistaVersamento.model().ID_SESSIONE.getFieldType()));
				setParameter(object, "setDataPagamento", VistaVersamento.model().DATA_PAGAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_pagamento", VistaVersamento.model().DATA_PAGAMENTO.getFieldType()));
				setParameter(object, "setImportoPagato", VistaVersamento.model().IMPORTO_PAGATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "importo_pagato", VistaVersamento.model().IMPORTO_PAGATO.getFieldType()));
				setParameter(object, "setImportoIncassato", VistaVersamento.model().IMPORTO_INCASSATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "importo_incassato", VistaVersamento.model().IMPORTO_INCASSATO.getFieldType()));
				setParameter(object, "setStatoPagamento", VistaVersamento.model().STATO_PAGAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "stato_pagamento", VistaVersamento.model().STATO_PAGAMENTO.getFieldType()));
				setParameter(object, "setIuvPagamento", VistaVersamento.model().IUV_PAGAMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "iuv_pagamento", VistaVersamento.model().IUV_PAGAMENTO.getFieldType()));
				setParameter(object, "setSrcIuv", VistaVersamento.model().SRC_IUV.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "src_iuv", VistaVersamento.model().SRC_IUV.getFieldType()));
				setParameter(object, "setSrcDebitoreIdentificativo", VistaVersamento.model().SRC_DEBITORE_IDENTIFICATIVO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "src_debitore_identificativo", VistaVersamento.model().SRC_DEBITORE_IDENTIFICATIVO.getFieldType()));
				setParameter(object, "setCodRata", VistaVersamento.model().COD_RATA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_rata", VistaVersamento.model().COD_RATA.getFieldType()));
				setParameter(object, "setTipo", VistaVersamento.model().TIPO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "tipo", VistaVersamento.model().TIPO.getFieldType()));
				setParameter(object, "setDataNotificaAvviso", VistaVersamento.model().DATA_NOTIFICA_AVVISO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "data_notifica_avviso", VistaVersamento.model().DATA_NOTIFICA_AVVISO.getFieldType()));
				setParameter(object, "setAvvisoNotificato", VistaVersamento.model().AVVISO_NOTIFICATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "avviso_notificato", VistaVersamento.model().AVVISO_NOTIFICATO.getFieldType()));
				setParameter(object, "setAvvMailDataPromScadenza", VistaVersamento.model().AVV_MAIL_DATA_PROM_SCADENZA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "avv_mail_data_prom_scadenza", VistaVersamento.model().AVV_MAIL_DATA_PROM_SCADENZA.getFieldType()));
				setParameter(object, "setAvvMailPromScadNotificato", VistaVersamento.model().AVV_MAIL_PROM_SCAD_NOTIFICATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "avv_mail_prom_scad_notificato", VistaVersamento.model().AVV_MAIL_PROM_SCAD_NOTIFICATO.getFieldType()));
				setParameter(object, "setAvvAppIoDataPromScadenza", VistaVersamento.model().AVV_APP_IO_DATA_PROM_SCADENZA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "avv_app_io_data_prom_scadenza", VistaVersamento.model().AVV_APP_IO_DATA_PROM_SCADENZA.getFieldType()));
				setParameter(object, "setAvvAppIoPromScadNotificato", VistaVersamento.model().AVV_APP_IO_PROM_SCAD_NOTIFICATO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "avv_app_io_prom_scad_notificat", VistaVersamento.model().AVV_APP_IO_PROM_SCAD_NOTIFICATO.getFieldType()));
				setParameter(object, "setCodDocumento", VistaVersamento.model().COD_DOCUMENTO.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "cod_documento", VistaVersamento.model().COD_DOCUMENTO.getFieldType()));
				setParameter(object, "setDocDescrizione", VistaVersamento.model().DOC_DESCRIZIONE.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "doc_descrizione", VistaVersamento.model().DOC_DESCRIZIONE.getFieldType()));
				setParameter(object, "setProprieta", VistaVersamento.model().PROPRIETA.getFieldType(),
					GenericJDBCParameterUtilities.readParameter(rs, "proprieta", VistaVersamento.model().PROPRIETA.getFieldType()));
				return object;
			}
