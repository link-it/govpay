...
public class JDBCTipoVersamentoDominioServiceSearch implements IDBTipoVersamentoDominioServiceSearch, IDBServiceUtilities<TipoVersamentoDominio> {
	...
	public JDBCTipoVersamentoDominioServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		this.log.debug(JDBCTipoVersamentoDominioServiceSearch.class.getName()+ " initialized");
	...
	public IdTipoVersamentoDominio convertToId(TipoVersamentoDominio obj)
		...
		try{
			...
			// check parameters
			if(obj==null){
				throw new Exception("Parameter (type:"+TipoVersamentoDominio.class.getName()+") 'obj' is null");
			}
	...
	public void mappingTableIds(long tableId, TipoVersamentoDominio obj) throws ServiceException,NotFoundException,NotImplementedException{
		...
		try{
			...
			// check parameters
			if(tableId<=0){
				throw new Exception("Parameter (type:"+IdTipoVersamentoDominio.class.getName()+") 'tableId' is lessEquals 0");
			}
			if(obj==null){
				throw new Exception("Parameter (type:"+TipoVersamentoDominio.class.getName()+") 'obj' is null");
			}
