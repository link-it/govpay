...
public class JDBCRendicontazioneService extends JDBCRendicontazioneServiceSearch  implements IDBRendicontazioneService {
	...
	public JDBCRendicontazioneService(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCRendicontazioneService.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+Rendicontazione.class.getName()+") 'rendicontazione' is null");
	}
	...
	private ServiceException newServiceExceptionParameterOldIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdRendicontazione.class.getName()+") 'oldId' is null");
	}
