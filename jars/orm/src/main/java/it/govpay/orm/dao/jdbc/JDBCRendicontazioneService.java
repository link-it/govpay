...
public class JDBCRendicontazioneService extends JDBCRendicontazioneServiceSearch  implements IDBRendicontazioneService {
	...
	private String modelName = Costanti.MODEL_RENDICONTAZIONE;
	private String modelClassName = Rendicontazione.class.getName();
	private String idModelClassName = IdRendicontazione.class.getName();
