...
public class JDBCTracciatoNotificaPagamentiServiceSearch implements IDBTracciatoNotificaPagamentiServiceSearch, IDBServiceUtilities<TracciatoNotificaPagamenti> {
	...
	public JDBCTracciatoNotificaPagamentiServiceSearch(JDBCServiceManager jdbcServiceManager) throws ServiceException {
		...
		String msgInit = JDBCTracciatoNotificaPagamentiServiceSearch.class.getName()+ " initialized";
	...
	private ServiceException newServiceExceptionParameterObjIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+TracciatoNotificaPagamenti.class.getName()+") 'obj' is null");
	}
	protected ServiceException newServiceExceptionParameterIdIsNull(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdTracciatoNotificaPagamenti.class.getName()+") 'id' is null");
	}
	...
	private ServiceException newServiceExceptionParameterWithTypeTableIdLessEqualsZero(){
		return new ServiceException(PARAMETER_TYPE_PREFIX+IdTracciatoNotificaPagamenti.class.getName()+") 'tableId' is lessEquals 0");
	}
