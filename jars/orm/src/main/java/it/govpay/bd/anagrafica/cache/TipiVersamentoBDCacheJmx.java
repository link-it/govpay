...
public class TipiVersamentoBDCacheJmx extends AbstractCacheJmx {
	
	@Override
	public AbstractCacheWrapper getCacheWrapper() {
		return AnagraficaManager.getTipiVersamentoBDCacheWrapper();
	}

	@Override
	public String getJmxDescription() {
		return "Anagrafica Tipi Versamento";
	}
}
