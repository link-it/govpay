...
public class IntermediariBDCacheWrapper extends AbstractCacheWrapper {

	public IntermediariBDCacheWrapper(boolean initializeCache, Logger log) throws UtilsException {
		super(CacheType.JCS, "intermediari", initializeCache, log);
	}

	@Override
	public Object getDriver(Object configWrapper) throws UtilsException {
		return new IntermediariBD((BDConfigWrapper) configWrapper);
	}
