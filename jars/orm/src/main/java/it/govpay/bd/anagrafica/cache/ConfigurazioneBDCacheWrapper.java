...
public class ConfigurazioneBDCacheWrapper extends AbstractCacheWrapper {

	public ConfigurazioneBDCacheWrapper(boolean initializeCache, Logger log) throws UtilsException {
		super(CacheType.JCS, "configurazione", initializeCache, log);
	}

	@Override
	public Object getDriver(Object configWrapper) throws UtilsException {
		return new ConfigurazioneBD((BDConfigWrapper) configWrapper);
	}
