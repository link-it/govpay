...
//	private String tipo;
	...
	public VersamentoFilter(IExpressionConstructor expressionConstructor, boolean simpleSearch) {
		...
		this.listaFieldSimpleSearch.add(Versamento.model().IUV_VERSAMENTO);
	}
		...
		try {
			...
			if(this.dataInizio != null && this.dataFine != null) {
				...
				if(this.dataInizio != null) {
					...
					newExpression.greaterEquals(Versamento.model().DATA_CREAZIONE, this.dataInizio);
					addAnd = true;
				} 
				...
				if(this.dataFine != null) {
					...
					newExpression.lessEquals(Versamento.model().DATA_CREAZIONE, this.dataFine);
					addAnd = true;
				}
			}
