...
public class TipiVersamentoDominiBDCacheJmx extends AbstractCacheJmx {
	
	@Override
	public AbstractCacheWrapper getCacheWrapper() {
		return AnagraficaManager.getTipiVersamentoDominiBDCacheWrapper();
	}

	@Override
	public String getJmxDescription() {
		return "Anagrafica Tipi Versamento Dominio";
	}
}
