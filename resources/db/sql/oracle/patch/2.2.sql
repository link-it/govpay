...
ALTER TABLE tributi DROP cod_tributo;
ALTER TABLE tributi DROP descrizione;
...
--GP-316
ALTER TABLE fr ADD data_acquisizione TIMESTAMP NOT NULL default CURRENT_TIMESTAMP;
ALTER TABLE portali ADD trusted NUMBER;
UPDATE portali set trusted = 0;
ALTER TABLE portali MODIFY (trusted NOT NULL);

--GP-281
ALTER TABLE applicazioni ADD versione VARCHAR(10) NOT NULL;
ALTER TABLE applicazioni MODIFY versione DEFAULT '2.1';
ALTER TABLE portali ADD versione VARCHAR(10) NOT NULL;
