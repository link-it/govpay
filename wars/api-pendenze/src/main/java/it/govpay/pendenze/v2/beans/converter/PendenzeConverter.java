...
//import it.govpay.pendenze.v2.api.impl.PagamentiApiServiceImpl;
...
import it.govpay.pendenze.v2.beans.Bollo;
import it.govpay.pendenze.v2.beans.Bollo.TipoBolloEnum;
import it.govpay.pendenze.v2.beans.Entrata;
//import it.govpay.pendenze.v2.beans.PagamentoIndex;
import it.govpay.pendenze.v2.beans.Pendenza;
import it.govpay.pendenze.v2.beans.PendenzaBase;
import it.govpay.pendenze.v2.beans.PendenzaIndex;
import it.govpay.pendenze.v2.beans.Pendenze;
import it.govpay.pendenze.v2.beans.RiferimentoEntrata;
...
//		rsModel.setPagamenti(listaPagamentoIndex);
	...
	public static VocePendenza toVocePendenza(it.govpay.bd.model.SingoloVersamento singoloVersamento, int indice) throws ServiceException {
		...
		if(singoloVersamento.getHashDocumento() != null && singoloVersamento.getTipoBollo() != null && singoloVersamento.getProvinciaResidenza() != null) {
			...
			rsModel.setTipoBollo(it.govpay.pendenze.v2.beans.TipoRiferimentoVocePendenza.TipoBolloEnum.BOLLO);
