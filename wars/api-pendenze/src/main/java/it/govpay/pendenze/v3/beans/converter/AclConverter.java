...
import it.govpay.pendenze.v3.beans.TipoAutorizzazione;
import it.govpay.pendenze.v3.beans.TipoServizio;

public class AclConverter {

	public static it.govpay.pendenze.v3.beans.Acl toRsModel(it.govpay.bd.model.Acl acl) {
		it.govpay.pendenze.v3.beans.Acl rsModel = new it.govpay.pendenze.v3.beans.Acl();
