...
import it.govpay.pendenze.v3.beans.StatoVocePendenza;
import it.govpay.pendenze.v3.beans.TassonomiaAvviso;
import it.govpay.pendenze.v3.beans.TipoContabilita;
import it.govpay.pendenze.v3.beans.VocePendenza;
...
//		rsModel.setPagamenti(listaPagamentoIndex);
	...
	public static VocePendenza toVocePendenza(it.govpay.bd.model.SingoloVersamento singoloVersamento, int indice) throws ServiceException {
		...
		if(singoloVersamento.getHashDocumento() != null && singoloVersamento.getTipoBollo() != null && singoloVersamento.getProvinciaResidenza() != null) {
			...
			rsModel.setTipoBollo(it.govpay.pendenze.v3.beans.TipoRiferimentoVocePendenza.TipoBolloEnum.BOLLO);
