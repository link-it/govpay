...
import it.govpay.backoffice.v1.beans.ConnettorePagopaGPD;
import it.govpay.model.Connettore;
import it.govpay.model.Connettore.EnumAuthType;
import it.govpay.model.Intermediario;

public class ConnettorePagopaGPDConverter {

	private ConnettorePagopaGPDConverter() {}

	public static Connettore getConnettore(it.govpay.backoffice.v1.beans.ConnettorePagopaGPD connector, String idIntermediario) {
		Connettore connettore = new Connettore();

		connettore.setIdConnettore(idIntermediario + Intermediario.CONNETTORE_GPD_SUFFIX);
	...
	public static ConnettorePagopaGPD toRsModel(it.govpay.model.Connettore connettore) {
		ConnettorePagopaGPD rsModel = new ConnettorePagopaGPD();
