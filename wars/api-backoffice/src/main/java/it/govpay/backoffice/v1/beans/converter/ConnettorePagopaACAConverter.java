...
import it.govpay.backoffice.v1.beans.ConnettorePagopaACA;
import it.govpay.model.Connettore;
import it.govpay.model.Connettore.EnumAuthType;
import it.govpay.model.Intermediario;

public class ConnettorePagopaACAConverter {

	private ConnettorePagopaACAConverter() {}

	public static Connettore getConnettore(it.govpay.backoffice.v1.beans.ConnettorePagopaACA connector, String idIntermediario) {
		Connettore connettore = new Connettore();

		connettore.setIdConnettore(idIntermediario + Intermediario.CONNETTORE_ACA_SUFFIX);
	...
	public static ConnettorePagopaACA toRsModel(it.govpay.model.Connettore connettore) {
		ConnettorePagopaACA rsModel = new ConnettorePagopaACA();
