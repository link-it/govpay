...
import it.govpay.backoffice.v1.beans.ConnettorePagopaBackofficeEC;
import it.govpay.model.Connettore;
import it.govpay.model.Connettore.EnumAuthType;
import it.govpay.model.Intermediario;

public class ConnettorePagopaBackofficeECConverter {

	private ConnettorePagopaBackofficeECConverter() {}

	public static Connettore getConnettore(it.govpay.backoffice.v1.beans.ConnettorePagopaBackofficeEC connector, String idIntermediario) {
		Connettore connettore = new Connettore();

		connettore.setIdConnettore(idIntermediario + Intermediario.CONNETTORE_BOEC_SUFFIX);
	...
	public static ConnettorePagopaBackofficeEC toRsModel(it.govpay.model.Connettore connettore) {
		ConnettorePagopaBackofficeEC rsModel = new ConnettorePagopaBackofficeEC();
