...
public class TipiPendenza extends BaseRsServiceV1{
    ...
    public Response getTipiPendenza(@Context UriInfo uriInfo, @Context HttpHeaders httpHeaders, @PathParam("idTipoPendenza") String idTipoPendenza){
    ...
    public Response addTipiPendenza(@Context UriInfo uriInfo, @Context HttpHeaders httpHeaders, @PathParam("idTipoPendenza") String idTipoPendenza, java.io.InputStream is){
        this.controller.setContext(this.getContext());
