...
public class TracciatiNotificaPagamentiController extends BaseController {
    ...
    public Response getTracciatoNotificaPagamenti(Authentication user, UriInfo uriInfo, HttpHeaders httpHeaders , String id) {
		...
		try{
			...
			leggiTracciatoDTO.setIdentificativo(id);
			...
			StreamingOutput zipStream = tracciatiDAO.leggiBlobTracciato(id, idDomini, it.govpay.orm.TracciatoNotificaPagamenti.model().RAW_CONTENUTO);
