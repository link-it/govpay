...
public class ConnettoreSend extends JSONSerializable implements IValidable{
  ...
  /**
   * Dati di integrazione al servizio SEND
   **/
  public ConnettoreSend url(String url) {
    this.url = url;
    return this;
  }
  ...
  /**
   **/
  public ConnettoreSend auth(TipoAutenticazione auth) {
    this.auth = auth;
    return this;
  }
  ...
  /**
   **/
  public ConnettoreSend subscriptionKey(String subscriptionKey) {
   ...
   **/
  public ConnettoreSend abilitaGDE(Boolean abilitaGDE) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConnettoreSend connettoreSend = (ConnettoreSend) o;
    return Objects.equals(url, connettoreSend.url) &&
        Objects.equals(auth, connettoreSend.auth) &&
        Objects.equals(subscriptionKey, connettoreSend.subscriptionKey) &&
        Objects.equals(abilitaGDE, connettoreSend.abilitaGDE);
  }
  ...
  public static ConnettoreSend parse(String json) throws IOException {
    return parse(json, ConnettoreSend.class);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnettoreSend {\n");
