...
public class TipoPendenzaAvvisaturaPromemoriaAvvisoBase extends JSONSerializable implements IValidable {
  ...
  public static TipoPendenzaAvvisaturaPromemoriaAvvisoBase parse(String json) throws IOException {
    return parse(json, TipoPendenzaAvvisaturaPromemoriaAvvisoBase.class);
  }
