...
public class PendenzeConverter {
	...
	public static VocePendenza toRsModelVocePendenza(SingoloVersamento singoloVersamento) throws ServiceException, IOException, UnsupportedEncodingException {
		BDConfigWrapper configWrapper = new BDConfigWrapper(ContextThreadLocal.get().getTransactionId(), true);
		return toRsModelVocePendenza(singoloVersamento, singoloVersamento.getVersamento(configWrapper));
	}

	public static VocePendenza toRsModelVocePendenza(SingoloVersamento singoloVersamento, Versamento versamento) throws ServiceException, IOException, UnsupportedEncodingException {
		BDConfigWrapper configWrapper = new BDConfigWrapper(ContextThreadLocal.get().getTransactionId(), true);
