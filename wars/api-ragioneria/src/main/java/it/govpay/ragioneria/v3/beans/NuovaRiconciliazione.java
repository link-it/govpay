...
public class NuovaRiconciliazione extends JSONSerializable  implements IValidable {
   ...
   **/
  public NuovaRiconciliazione idFlussoRendicontazione(String idFlussoRendicontazione) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(importo, nuovaRiconciliazione.importo) &&
    	...
    	Objects.equals(this.idFlussoRendicontazione, nuovaRiconciliazione.idFlussoRendicontazione);
  }

  @Override
  public int hashCode() {
    return Objects.hash(importo, dataValuta, dataContabile, contoAccredito, sct, causale, iuv, idFlussoRendicontazione);
  }
