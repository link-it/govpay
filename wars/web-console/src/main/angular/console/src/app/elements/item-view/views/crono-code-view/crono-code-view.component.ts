...
@Component({
  selector: 'link-crono-code-view',
  templateUrl: './crono-code-view.component.html',
  styleUrls: ['./crono-code-view.component.scss']
})
export class CronoCodeViewComponent implements OnInit {

  @Input() dataRef:any;

  @Input('info') info: CronoCode = new CronoCode();
