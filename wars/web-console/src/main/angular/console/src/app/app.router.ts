...
const _routes: Routes = [
  ...
  { path: UtilService.ROUTE(UtilService.URL_GIORNALE_EVENTI)+UtilService.URL_DETTAGLIO, component: DetailViewComponent, canActivate: [ AuthGuardService ], data: { type: UtilService.GIORNALE_EVENTI, title: '', search: false, back: true, actions: false, info: null, reuse: false } },
