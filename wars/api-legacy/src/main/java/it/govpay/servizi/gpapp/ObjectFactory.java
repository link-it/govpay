 ...
 * generated in the it.govpay.servizi.gpapp package. 
...
public class ObjectFactory {
    ...
    private final static QName _GpAnnullaVersamentoResponse_QNAME = new QName("http://www.govpay.it/servizi/gpApp/", "gpAnnullaVersamentoResponse");
    private final static QName _GpNotificaPagamentoResponse_QNAME = new QName("http://www.govpay.it/servizi/gpApp/", "gpNotificaPagamentoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.govpay.servizi.gpapp
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.govpay.it/servizi/gpApp/", name = "gpAnnullaVersamentoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.govpay.it/servizi/gpApp/", name = "gpNotificaPagamentoResponse")
