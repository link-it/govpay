 ...
 * generated in the it.govpay.servizi.gprnd package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.govpay.servizi.gprnd
     * 
     */
    ...
    /**
     * Create an instance of {@link GpChiediListaFlussiRendicontazioneResponse.FlussoRendicontazione }
     * 
     */
    public GpChiediListaFlussiRendicontazioneResponse.FlussoRendicontazione createGpChiediListaFlussiRendicontazioneResponseFlussoRendicontazione() {
        return new GpChiediListaFlussiRendicontazioneResponse.FlussoRendicontazione();
    }
