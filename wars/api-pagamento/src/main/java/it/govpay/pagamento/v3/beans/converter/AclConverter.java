...
import it.govpay.pagamento.v3.beans.TipoAutorizzazione;
import it.govpay.pagamento.v3.beans.TipoServizio;

public class AclConverter {

	public static it.govpay.pagamento.v3.beans.Acl toRsModel(it.govpay.bd.model.Acl acl) {
		it.govpay.pagamento.v3.beans.Acl rsModel = new it.govpay.pagamento.v3.beans.Acl();
