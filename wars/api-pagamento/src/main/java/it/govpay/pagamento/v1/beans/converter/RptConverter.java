			...
			if(xmlRpt != null) {
				...
				case RPTV1_RTV2:
					...
					if(convertiMessaggioPagoPAV2InPagoPAV1) {
						...
						rsModel.setRpt(ConverterUtils.getRptJson(paGetPaymentRes));
					}
					break;
				case SANP_321_V2:
				case RPTV2_RTV1:
					...
					if(convertiMessaggioPagoPAV2InPagoPAV1) {
						...
						rsModel.setRpt(ConverterUtils.getRptJson(paGetPaymentV2Response));
					}
					break;
				}
			}
			...
			if(rpt.getXmlRt() != null) {
				...
				case RPTV2_RTV1:
					...
					if(convertiMessaggioPagoPAV2InPagoPAV1) {
						...
						rsModel.setRt(ConverterUtils.getRtJson(paSendRTReq));
					}
					break;
				case SANP_321_V2:
				case RPTV1_RTV2:
				case RPTSANP230_RTV2:
					...
					if(convertiMessaggioPagoPAV2InPagoPAV1) {
						...
						rsModel.setRt(ConverterUtils.getRtJson(paSendRTV2Request));
					}
					break;
				}
			}
