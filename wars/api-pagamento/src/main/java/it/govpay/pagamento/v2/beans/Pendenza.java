...
public class Pendenza extends JSONSerializable {
  ...
  /**
   * Codice identificativo del tipo di pendenz
   **/
  ...
  /**
   **/
  public Pendenza pagamenti(List<PagamentoIndex> pagamenti) {
