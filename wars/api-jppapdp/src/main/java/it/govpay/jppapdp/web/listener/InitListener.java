 ...
 *
 */
package it.govpay.jppapdp.web.listener;
...
public class InitListener extends BaseInitListener {
	...
	public String getDominioAnagraficaManager() {
		return Costanti.NOME_DOMINIO_CACHE_API_JPPAPDP;
	}
	
	@Override
	public String getTipoServizioGovpay() {
		return GpContext.TIPO_SERVIZIO_GOVPAY_WS;
	}
	
	@Override
	public String getWarName() {
		return Costanti.WAR_NAME_API_JPPAPDP;
	}
}
